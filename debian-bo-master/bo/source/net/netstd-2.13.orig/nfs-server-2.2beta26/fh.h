...
extern _PRO( psi_t pseudo_inode, (u_long inode, u_short dev)		);
...
extern _PRO( psi_t fh_psi, (nfs_fh *fh)					);
extern _PRO( void fh_remove, (char *path)				);
extern _PRO( nfs_fh *fh_handle, (fhcache *fhc)				);
extern _PRO( void fh_flush, (int force)					);
extern _PRO( RETSIGTYPE flush_cache,(int sig)				);

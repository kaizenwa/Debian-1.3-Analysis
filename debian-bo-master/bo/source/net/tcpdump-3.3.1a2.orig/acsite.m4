dnl @(#) $Header: acsite.m4,v 1.45 96/12/18 02:05:56 leres Exp $ (LBL)
dnl
...
AC_DEFUN(AC_LBL_DEVEL,
    ...
    if test "$GCC" = yes -a -f .devel ; then
	    if test "${LBL_CFLAGS+set}" != set; then
...
dnl usage:
dnl
dnl	AC_LBL_PATH_NETLIBS
dnl
dnl results:
dnl
dnl	LIBS
dnl
AC_DEFUN(AC_LBL_PATH_NETLIBS,
    [AC_CHECK_FUNC(gethostbyname, ,
	AC_CHECK_LIB(nsl, gethostbyname, , AC_CHECK_LIB(resolv, gethostbyname)))

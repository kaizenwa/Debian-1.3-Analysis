 ...
 */
extern char	*search(char *start, char **mark, char *chars, int how)
{
        if (!mark || !*mark)
                *mark = start;
...
extern char	*move_to_abs_word (char *start, char **mark, int word)
{
	char *pointer = start;
	int counter = word;
...
extern char	*move_word_rel (char *start, char **mark, int word)
{
	char *pointer = *mark;
	int counter = word;
...
extern char	*extract2(char *start, int firstword, int lastword)
{
 ...
 * fastest.
 */
extern char	*extract(char *start, int firstword, int lastword)
{
	/* 

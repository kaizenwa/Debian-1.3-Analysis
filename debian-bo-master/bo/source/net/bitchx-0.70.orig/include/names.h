...
ChannelList *	add_to_channel _((char *, char *, int, int, int, char *, char *, char *));
	...
	int	im_on_channel _((char *));
	char	*recreate_mode _((ChannelList *));	
	int	get_channel_voice _((char *, int));
#endif /* __names_h_ */

/*
 *           NEVER REPLACE THIS VERSION BY ANOTHER !!
 *           (rpcgen generated or from your system)
 *
...
#include "config.h"
#ifdef ULTRIX_KLUDGE
/* This is to avoid a crash with ultrix' libc */
#define xdr_ypreq_key yp_xdr_ypreq_key
#define xdr_ypreq_nokey yp_xdr_ypreq_nokey
#define xdr_ypreq_xfr yp_xdr_ypreq_xfr
#define xdr_ypmap_parms yp_xdr_ypmap_parms
#define xdr_ypresp_val yp_xdr_ypresp_val
#define xdr_ypresp_key_val yp_xdr_ypresp_key_val
#define xdr_ypresp_master yp_xdr_ypresp_master
#define xdr_ypresp_order yp_xdr_ypresp_order
#define xdr_ypmaplist yp_xdr_ypmaplist
#define xdr_ypresp_maplist yp_xdr_ypresp_maplist
#define xdr_ypbind_resp yp_xdr_ypbind_resp
#define xdr_ypbind_setdom yp_xdr_ypbind_setdom
#define xdr_yppushresp_xfr yp_xdr_yppushresp_xfr
#endif

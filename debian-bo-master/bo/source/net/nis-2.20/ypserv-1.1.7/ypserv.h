...
/* 
** $Id: ypserv.h,v 1.4 1997/04/08 21:20:50 kukuk Exp $ 
*/
...
extern int sunos_kludge_flag;   /* ypserv.c || ypxfrd.c */
extern int tryresolve_flag;     /* ypserv.c || ypxfrd.c */
extern int children;		/* server.c || ypxfrd.c */

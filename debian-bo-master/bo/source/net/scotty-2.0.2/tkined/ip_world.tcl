...
##
## IP-World Tool for TKINED.
##
## This file contains code to layout ip nodes based on guesses
## where those machines are located on the world map.
##
...
proc LoadLocations {} {
    ...
    global scotty_library auto_path

    foreach dir [concat $auto_path $scotty_library ~/.tkined] {
	set fname $dir/locations

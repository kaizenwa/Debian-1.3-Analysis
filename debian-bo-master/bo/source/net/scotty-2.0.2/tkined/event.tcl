...
##
## Interface to access the event handling mechanism.
##
...
proc flash {op {ip ""}} {
	...
	add {
		...
		set jobid [job create "flash run" 10000]
	    }
	    return
	}

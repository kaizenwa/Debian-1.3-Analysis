...
/*
 * $Id: config.h,v 1.2 1995/07/05 14:13:47 chuck Exp $
 */
...
/*
 * CONF_TIMEOUT determines if there will be a timeout for reading the
 * configuration file. The timeout is specified in seconds.
 *		Case 1: CONF_TIMEOUT is undefined
 *			there will be a timeout equal to a default value (60 sec).
 *		Case 2: CONF_TIMEOUT is a positive number
 *			there will be a timeout equal to the value of CONF_TIMEOUT
 *		Case 3: CONF_TIMEOUT is 0
 *			no timeout
 */
#ifndef CONF_TIMEOUT
#define CONF_TIMEOUT						60
#endif

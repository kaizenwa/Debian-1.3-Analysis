...
/*
 * $Id: impl.h,v 1.6 1995/09/10 18:42:47 chuck Exp $
 */
 ...
 */
int __sio_readf(), __sio_writef(), __sio_pwritef() ;
int __sio_extend_buffer(), __sio_init(), __sio_converter(), __sio_more() ;
status_e __sio_switch() ;
...
PRIVATE char *sio_memscan( char *from , int how_many , register char ch ) ;
#else
char *sio_memscan() ;
#endif
#endif

...
typedef struct Tki_Object {
    ...
    Tcl_DString *cmd;   /* The command buffer used by an interpreter         */
...
extern void trace _ANSI_ARGS_((Tki_Editor *editor, Tki_Object *object,
...
#ifdef NCCICON
EXTERN void 
Tki_NccIcon		_ANSI_ARGS_((Tcl_Interp *interp));
#endif

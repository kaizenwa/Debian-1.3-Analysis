/*
 * /src/NTP/REPOSITORY/v4/parseutil/parsetest.c,v 3.19 1996/12/01 16:05:03 kardel Exp
 *
 * parsetest.c,v 3.19 1996/12/01 16:05:03 kardel Exp
 *
 ...
 *
 * parsetest.c,v
 * Revision 3.19  1996/12/01 16:05:03  kardel
 * freeze for 5.86.12.2 PARSE-Patch
 *
 * Revision 3.18  1996/11/24 23:16:43  kardel
 * checkpoint - partial autoconfigure update for parse modules
 *
 * Revision 3.17  1996/10/05 13:30:27  kardel
 * general update
 *
  ...
  char **argv;
{
  if (argc != 2)
      ...
      else
	{
	  ...
	  printf("parsetest.c,v 3.19 1996/12/01 16:05:03 kardel Exp\n");
...
main()
{
  fprintf(stderr, "No STREAM support available - no test possible\n");
  return 1;
}
...
#ifndef STREAM
#include "Bletch: ONLY STREAM OPERATION SUPPORTED"
#endif

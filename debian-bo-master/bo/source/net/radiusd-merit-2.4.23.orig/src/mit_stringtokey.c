#ifdef M_KERB
/*
 * $Source: /usr/local/mnetauth/radius/RCS/mit_stringtokey.c,v $
 * $Author: web $
 *
...
"$Id: mit_stringtokey.c,v 1.3 1995/02/02 15:08:33 web Exp $";
...

int 
mit_passwd_to_key (user, instance, realm, passwd, key)

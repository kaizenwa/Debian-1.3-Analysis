/*
  ...
  $Id: ppp_init.c,v 1.1.1.1 1996/01/28 22:11:50 alvar Exp $
*/
...
static struct fmodsw *fmod_advmod2=NULL;
...
struct vdstat *vds;
{
	...
	er = install_fmod (&ppp_compinfo, &fmod_advmod2, PPPCOMP);
	if(er != 0) {
	    deinstall_fmod (fmod_advmod0);

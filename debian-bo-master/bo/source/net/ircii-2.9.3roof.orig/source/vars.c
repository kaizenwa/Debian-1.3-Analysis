...
#ifndef lint
static	char	rcsid[] = "@(#)$Id: vars.c,v 1.34 1996/03/01 10:40:36 mrg Exp $";
#endif
...
#ifdef OLD_CRUD
	{ "HELP_SERVICE",		STR_TYPE_VAR,	0, NULL, NULL, 0, 0 },
#else
	{ empty_string,			STR_TYPE_VAR,	0, 0, 0, 0, 0 },
#endif
...
#ifdef OLD_CRUD
	set_string_var(HELP_SERVICE_VAR, DEFAULT_HELP_SERVICE);
#endif

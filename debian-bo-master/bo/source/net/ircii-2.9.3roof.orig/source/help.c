...
#ifndef lint
static	char	rcsid[] = "@(#)$Id: help.c,v 1.39.2.1 1996/06/20 05:06:44 mrg Exp $";
#endif
...
/* allow usage of help files if installed in the meantime -Soleil */
	...
	if (use_help_service)
	{
		...
		send_to_server("PRIVMSG %s :%s",
				get_string_var(HELP_SERVICE_VAR),
				(args && *args) ? args : "?");
	}
	else
#endif

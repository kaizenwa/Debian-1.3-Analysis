 ...
 *
 * $Id: bsd.h,v 1.3 1994/06/23 15:55:06 mike Exp $
 * $Source: /usr/CVS/ibcs/include/ibcs/bsd.h,v $
 */
...
extern int bsd_sigprocmask(int how, sigset_t bsdnset, sigset_t *bsdoset);
extern int bsd_sigpending(sigset_t *set);

 ...
 * but there is still some area of improvement (encryption, pcmcia events...).
 *
 ...
 *
 * Changes made for release in 2.9.4 :
 * ---------------------------------
...
static const char *version = "wavelan_cs.c : v16 (wireless extensions) 17/4/97\n";
#endif
...
static inline void
	cs_error(int,		/* Report error to cardmgr */
		 int);
...
static const u_long	irq_mask = 0xdeb8;

/* Shared memory speed, in ns */
static const int	mem_speed = 0;

...
static int GetDevs(char *, int);
static int DoFnKeys(char *, int);
	...
	break;
	  ...
	  case 1:
	    ...
	    *pm[i].value = num;
	    break;
	  case 2:
	    if(((int (*)(char *, int))pm[i].value)(p, 1))
	      len = -1;
	    break;
	  case 3:
  ...
  for(i = 0; pm[i].name; i++)
    {
	  ...
	  case 1:
	    ...
	    break;
	  case 2:
	    if(((int (*)(char *, int))pm[i].value)(p, 0))
	      i--;
	    else
	      continue;
	    break;

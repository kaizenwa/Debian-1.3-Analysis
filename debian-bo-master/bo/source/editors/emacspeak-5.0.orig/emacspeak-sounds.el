;;; $Id: emacspeak-sounds.el,v 5.0 1996/11/22 18:04:26 raman Exp $
;;; $Author: raman $ 
...
;;; play an auditory icon if it is defined as a property

(defsubst emacspeak-handle-auditory-icon-at-point ()
  (declare (special emacspeak-use-auditory-icons ))
  (let ((icon nil ))
  (and emacspeak-use-auditory-icons
       (setq icon (get-text-property (point) 'auditory-icon))

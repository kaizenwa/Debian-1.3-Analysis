;;; $Id: dtk-speak.el,v 5.0 1996/11/22 18:04:26 raman Exp $
;;; $Author: raman $ 
...
(aset dtk-character-to-speech-table 40  "left[*]paren" )
(aset dtk-character-to-speech-table 41 "right[*]paren" )
...
(aset dtk-character-to-speech-table 59 "semi")
1(aset dtk-character-to-speech-table 60 "less[*]than")

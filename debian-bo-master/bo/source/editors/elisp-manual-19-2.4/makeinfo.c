...

/* This is Makeinfo version 1.62.  If you change the version number of
     ...
     int count;
{
  ...
  for (i = 0, j = 0; i < (count - 1); i++)
    {
      if ((array[i]->node != array[i + 1]->node) ||

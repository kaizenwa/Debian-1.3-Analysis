...
int TagNext(EView *View) { /*FOLD00*/
    ...
    View->Msg(INFO, "No next match for tag.");
    return 0;
}
...
int TagPrev(EView *View) { /*FOLD00*/
    ...
    View->Msg(INFO, "No previous match for tag.");
    return 0;
}

/*
	...
	$Id: init.c 1.3 1996/06/22 20:00:07 chris Exp $
*/
...
int init ( char * firstarg )
{
	...
	/* conversion */
#if defined(MSDOS)
	/* got to extricate the name from the full path and extension */
	_splitpath( firstarg, NULL, NULL, filename, NULL );
	progname = xstrdup( filename );
#else	/* not MSDOS - assume Unix */

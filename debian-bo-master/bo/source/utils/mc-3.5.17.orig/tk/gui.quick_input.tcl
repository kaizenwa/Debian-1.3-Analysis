...
set props(.quick_input.components)   "button-ok button-cancel label input "
...
set props(.quick_input.props.input) "-in .quick_input.widgets -column 3 -row 5 -columnspan 3 -rowspan 1 -ipadx 0 -ipady 0 -padx 0 -pady 0 -sticky ew"

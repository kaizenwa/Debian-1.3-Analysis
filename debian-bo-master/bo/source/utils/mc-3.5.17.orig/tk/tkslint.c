/* Routines expected by the Midnight Commander
   ...
   This file just has dummy procedures that don't do nothing under Tk.
   I will make macros once I feel right with the Tk edition.
...
/* FIXME: Tk could provide a better way of doing this */
int
...
int getch ()
{
    /* FIXME: I should provide a Tk equivalent */
    puts ("Fatal: getch called from Tk edition\n");
    abort ();
}

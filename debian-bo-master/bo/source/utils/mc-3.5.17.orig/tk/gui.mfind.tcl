...
set props(.mfind.components)   "label-search button-chdir button-again start-stop button-quit button-view button-panelize listbox "
set props(.mfind.count)   8
...
set props(.mfind.props.button-view) "-in .mfind.widgets -column 5 -row 17 -columnspan 1 -rowspan 1 -ipadx 0 -ipady 0 -padx 0 -pady 0 -sticky {}"
set props(.mfind.props.button-panelize) "-in .mfind.widgets -column 7 -row 17 -columnspan 1 -rowspan 1 -ipadx 0 -ipady 0 -padx 0 -pady 0 -sticky {}"

...
#ifndef MIDNIGHT
#define EDIT_TEXT_HORIZONTAL_OFFSET 3
...
/* ...bytes in size. */ /* was 8192, but deep thoughts */
...
#define Cgetfile(w,x,y,d,f,h) input_dialog (h, " Enter file name: ", f)

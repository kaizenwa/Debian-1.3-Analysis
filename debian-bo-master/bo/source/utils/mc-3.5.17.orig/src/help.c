...
/* "$Id: help.c,v 1.15 1995/02/21 19:06:03 miguel Exp $" */
...
void interactive_display (char *filename, char *node)
{
    ...
    define_label_data (whelp, (Widget *)NULL, 1, "Help",
		       (buttonbarfn) help_help_cmd, whelp);
    define_label_data (whelp, (Widget *)NULL, 2, "Index",
		       (buttonbarfn) help_index_cmd,whelp);
    define_label_data (whelp, (Widget *)NULL, 3, "Prev",
    ...
    define_label_data (whelp, (Widget *) NULL, 10, "Quit", quit_cmd, whelp);

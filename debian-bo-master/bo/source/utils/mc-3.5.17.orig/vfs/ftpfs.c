...
/* If defined, to get the proper information on symlinks, the program will
 * first CD and then LS instead of LS the directory directly
 */
#undef CD_THEN_LS_DOT

/* While I make up my mind, this is a no-op */
#define wipe_password(x)

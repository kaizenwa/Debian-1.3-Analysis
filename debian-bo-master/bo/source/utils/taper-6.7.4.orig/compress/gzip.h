/*
   Time-stamp: <96/07/19 20:15:22 yusuf>

   $Id: gzip.h,v 1.3 1996/07/27 20:42:29 yusuf Exp $	
...
extern int  gz_ifd;        /* input file descriptor */
extern int  gz_ofd;        /* output file descriptor */

/*
   Time-stamp: <96/07/19 20:15:26 yusuf>

   $Id: lzrw3.h,v 1.2 1996/07/27 20:42:31 yusuf Exp $	
...
EXPORT void  compress(        /* Single function interface to compression algorithm. */

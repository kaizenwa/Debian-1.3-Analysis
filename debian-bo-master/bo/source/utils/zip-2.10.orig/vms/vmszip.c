/*
 ...
 Kai Uwe Rommel, Onno van der Linden, Christian Spieler and Igor Mandrichenko.
...
/* Local functions */
local void vms_wild OF((char *, DIR *));
DIR *opendir OF((const char *));
struct dirent *readdir OF((DIR *));

/* $Source: /usr/local/src/pax/RCS/regexp.c,v $
 *
 * $Revision: 2.2 $
 *
 ...
 *
 * $Log: regexp.c,v $
 * Revision 2.2  1996/10/26  16:50:10  istewart
...
#ifndef lint
static char        *Ident = "$Id: regexp.c,v 2.2 1996/10/26 16:50:10 istewart Exp $";
#endif /* lint */
 ...
 * Forwards.
 */
static int          regtry __P ((regexp *, char *));

/* $Source: /usr/local/src/pax/RCS/names.c,v $
 *
 * $Revision: 2.2 $
 *
...
#ifndef lint
static char        *ident = "$Id: names.c,v 2.2 1996/10/20 12:10:20 istewart Exp $";
...
#define myuid	((gotuid == 0) ? gotuid = 1, (my_uid = getuid()) : my_uid )
#define	mygid	((gotgid == 0) ? gotgid = 1, (my_gid = getgid()) : my_gid )
...
#ifndef MSDOS
static uid_t	saveuid = -993;
static char     saveuname[TUNMLEN];
static uid_t	my_uid = -993;

static gid_t	savegid = -993;
static char     savegname[TGNMLEN];
static gid_t	my_gid = -993;
#else /* MSDOS */

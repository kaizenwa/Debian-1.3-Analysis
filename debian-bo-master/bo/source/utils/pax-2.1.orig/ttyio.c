/* $Source: /usr/local/src/pax/RCS/ttyio.c,v $
 *
 * $Revision: 2.2 $
 *
...
#ifndef lint
static char        *ident = "$Id: ttyio.c,v 2.2 1996/10/20 12:10:20 istewart Exp $";
...
#endif
{
    ...
    RETSIGTYPE		(*intr) __P ((int));	/* used to restore interupts */

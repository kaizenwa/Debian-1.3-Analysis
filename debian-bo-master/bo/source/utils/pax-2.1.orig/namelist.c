/* $Source: /usr/local/src/pax/RCS/namelist.c,v $
 *
 * $Revision: 2.2 $
 *
...
#ifndef lint
static char        *ident = "$Id: namelist.c,v 2.2 1996/10/20 12:10:20 istewart Exp $";
...
struct dirinfo {
    ...
    off_t               where;	/* current location in directory */
    struct dirinfo     *next;
};
...
static void	         pushdir __P ((struct dirinfo *));
static struct dirinfo	*popdir __P ((void));
...
#endif
{
	...
	if ((err = PAX_LSTAT(name, statbuf)) < 0) {

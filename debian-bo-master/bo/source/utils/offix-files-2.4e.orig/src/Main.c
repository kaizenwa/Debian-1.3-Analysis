...
#include "Files.ad.h"
"Files*bitmapPath: "PIXDIR,
"Files*pixmapPath: "PIXDIR,
NULL
};
...
void main(int argc, char *argv[])
{
  ...
  toplevel = XtAppInitialize(&app_context, "Files", options, XtNumber(options),
  ...
  if (!argc) /* no paths in cmd line: start window with home dir */
  	newFileWindow(user.home,resources.initial_display_type,False,iconic);

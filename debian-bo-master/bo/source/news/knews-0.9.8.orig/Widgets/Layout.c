...
static XtResource resources[] = {
    {XtNborderWidth, XtCBorderWidth, XtRDimension, sizeof(Dimension),
     XtOffsetOf(LayoutRec, core.border_width), XtRImmediate, (XtPointer)0},
...
static void LayoutLayout(LayoutWidget, Boolean);
...
/* ARGSUSED */
static Boolean 
SetValues(Widget gold, Widget greq, Widget gnew, ArgList args, Cardinal *n)
{
...
static void
LayoutLayout(LayoutWidget l, Boolean attemptResize)
{
    BoxPtr		box;

...
typedef enum BoxType { BoxBox, WidgetBox, GlueBox, VariableBox } BoxType;
...
#define Some(t,n)    (t*) XtCalloc(sizeof(t) * n)
...
extern int	LayYYerror(char*);
extern int	LayYYlex(void);
extern int	LayYYsetsource(char*);
...
typedef struct LayoutClassPart {
    int foo;			/* keep compiler happy. */
} LayoutClassPart;

/* Full Class record declaration */
typedef struct LayoutClassRec {
...
typedef struct LayoutConstraintsRec {
    SubInfoRec	layout;

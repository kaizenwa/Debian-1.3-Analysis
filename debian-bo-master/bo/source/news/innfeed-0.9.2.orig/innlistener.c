 ...
 * Project:     INN (innfeed)
 * File:        innlistener.c
 * RCSId:       $Id: innlistener.c,v 1.20 1996/11/20 18:02:44 brister Exp $
 *
...
#if ! defined (lint)
static const char *rcsid = "$Id: innlistener.c,v 1.20 1996/11/20 18:02:44 brister Exp $" ;

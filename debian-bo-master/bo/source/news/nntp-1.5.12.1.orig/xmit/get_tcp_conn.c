#ifndef lint
static char * rcsid = "$Id: get_tcp_conn.c,v 1.8 1994/11/17 16:43:05 sob Exp sob $";
#endif
#define USE_KEEPALIVES /* XXX should be in ../conf.h */

...
static char *reg __APROTO((int paren, int *flagp));
static char *regbranch __APROTO((int *flagp));
static char *regpiece __APROTO((int *flagp));
static char *regatom __APROTO((int *flagp));
static char *regnode __APROTO((int op));
static void regc __APROTO((int b));
static void reginsert __APROTO((int op, char *opnd));
static void regtail __APROTO((char *p, char *val));
static void regoptail __APROTO((char *p, char *val));
static int regtry __APROTO((regexp *prog, char *string));
static int regmatch __APROTO((char *prog));
static int regrepeat __APROTO((char *p));
static char *regnext __APROTO((register char *p));

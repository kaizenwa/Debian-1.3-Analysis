...
static void do_auto_select __APROTO((void));
static char *a_st_flags __APROTO((flag_type flag));
static void brief_header_line __APROTO((register article_header *ah, int lno));

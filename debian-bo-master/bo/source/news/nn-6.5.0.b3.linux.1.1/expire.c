...
static article_number *get_article_list __APROTO((char *dir));
static long expire_in_database __APROTO((register group_header *gh));
static long expire_sliding __APROTO((register group_header *gh));
static void block_group __APROTO((register group_header *gh));
static void unblock_group __APROTO((register group_header *gh));

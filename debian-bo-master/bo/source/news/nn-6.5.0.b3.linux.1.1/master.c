...
static void clean_group_internal __APROTO((register group_header *gh));
static void group_restriction __APROTO((register group_header *gh));
static void set_group_restrictions __APROTO((char **restr, int n));
static void visit_active_file __APROTO((void));
static void build_master __APROTO((void));
static void set_lock_message __APROTO((void));
static void do_reread_groups __APROTO((void));
...
static void
clean_group_internal(gh)	/* no write */
...
static void
set_group_restrictions(restr, n)
char **restr;
int n;
{
    register group_header *gh;
...
void nn_exitmsg()
{
    dummy_error("nn_exitmsg");
}

void dummy_error(name)
char *name;
{

...
static void m_error __APROTO((char *fmt, char *arg));
static void m_new __APROTO((int t));
static parse_word __APROTO((char *w));
static parse_line __APROTO((char *lp));
static struct macro *m_call __APROTO((int who));

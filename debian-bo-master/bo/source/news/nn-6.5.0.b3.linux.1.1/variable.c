...
static struct variable_defs *lookup_variable __APROTO((char *variable));
static char escaped_char __APROTO((int c));
static void adjust __APROTO((register char *str));
static char *var_value __APROTO((register struct variable_defs *var, char *tag));
static var_on_stack __APROTO((register struct variable_defs *var));

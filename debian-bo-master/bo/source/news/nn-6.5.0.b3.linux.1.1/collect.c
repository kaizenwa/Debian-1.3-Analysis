...
static void do_auto_archive __APROTO((group_header *gh, register FILE *f, article_number num));
static void build_hdr __APROTO((int type));
static collect_article __APROTO((register group_header *gh, article_number art_num));
static long collect_group __APROTO((register group_header *gh));

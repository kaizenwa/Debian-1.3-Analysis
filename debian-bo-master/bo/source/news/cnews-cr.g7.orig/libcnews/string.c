...
stranslit(s, from, to)		/* simple tr: change `from' to `to' in `s' */
register char *s;
...
#define initishostchar() (setishostchar? 0: doinitishostchar())

/*  VER 004 TAB P   $Id: nntp.h,v 0.5 1996/11/21 21:48:02 src Exp $
 *
 *  from NNTPLINK package
 *  copyright (c) 1994 David Alden and The Ohio State University
 * 
...
/* 
 *  I sent an IHAVE, but then found out I can't access the article
 */

#define ERR_UNKNOWN	990	/* unknown error has occurred in sendcmd */
#define ERR_NOMSGID	991	/* no message-id found in article */
#define ERR_NOFILE	992	/* can't access article */
#define ERR_NOFILE_CONT 993	/* can't access article, but continue */

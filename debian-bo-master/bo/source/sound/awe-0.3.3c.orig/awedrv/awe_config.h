...
/* if you're using OSS/Free-3.0.x (aka VoxWare) on Linux 1.2.x
 * (or FreeBSD), define the following line.
 */
...
/* if you're using OSS/Free on Linux 2.1.6 or later, define the
 * following line.
 */
#undef AWE_NEW_KERNEL_INTERFACE

/* if you have lowlevel.h in the lowlevel directory (OSS/Free), define
 * the following line.
 */
 ...
 * (600 and 3200 are enough for 2MB/8MB samples, so far)
 *----------------------------------------------------------------*/

 ...
 *
 * $Id: xm.h,v 1.2 1997/02/11 00:31:19 claudio Exp $
 *
 * $Log: xm.h,v $
 * Revision 1.2  1997/02/11 00:31:19  claudio
 * Data types changed for xmp 1.0.
 *
 * Revision 1.1  1996/12/07 17:42:12  claudio
 * Initial revision
 *
 */
...
struct xm_instrument_header {
    ...
    uint32 sh_size;		/* Sample header size - INCORRECT in xm.txt */
} PACKED;
...
struct xm_instrument {
    ...
    uint8 reserved[22];		/* Reserved - This is INCORRECT in xm.txt */
} PACKED;

/* s3m.h - Scream Tracker 3 module format definitions
 * Copyright (C) 1997 C.Matsuoka and H.Carraro Jr
 *
 * $Id: s3m.h,v 1.2 1997/02/11 00:33:11 claudio Exp $
 *
 * $Log: s3m.h,v $
 * Revision 1.2  1997/02/11 00:33:11  claudio
 * Added missing fields in the instrument header structures.
 *
 * Revision 1.1  1997/02/08 11:40:58  claudio
 * Initial revision
 *
 */
...
#define S3M_CH_PAN	0x7f	/* Left/Right. Adlib unsupported. */
...
#define S3M_ST300_VOLS	0x40	/* Not recognized */
...
struct s3m_adlib_header {
    uint8 type;
    uint8 dosname[11];		/* DOS file name */

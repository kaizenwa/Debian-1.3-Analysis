...
{
  scm_primitive_load(gh_str02scm(fname), SCM_BOOL_F, SCM_BOOL_F);
}
...
{
  /* FIXME: not there yet */
  gh_catch(SCM_BOOL_T, (scm_catch_body_t) eval_str_wrapper, scheme_code,
...
{
  /* FIXME: not there yet */
  gh_catch(SCM_BOOL_T, (scm_catch_body_t) eval_file_wrapper, scheme_code,
	   (scm_catch_handler_t) gh_standard_handler, scheme_code);
}

...
/*VARARGS*/
void
exp_log EXP_VARARGS_DEF(int,arg1)
/*exp_log(va_alist)*/
/*va_dcl*/
{
	int force_stdout;
	...
	force_stdout = EXP_VARARGS_START(int,arg1,args);
	/*va_start(args);*/
...
/*VARARGS*/
void
debuglog EXP_VARARGS_DEF(char *,arg1)
/*debuglog(va_alist)*/
/*va_dcl*/
{
	char *fmt;
	...
	fmt = EXP_VARARGS_START(char *,fmt,args);
	/*va_start(args);*/
	/*fmt = va_arg(args,char *);*/
	if (debugfile) vfprintf(debugfile,fmt,args);
	if (is_debugging) {
...
/*VARARGS*/
void
exp_errorlog EXP_VARARGS_DEF(char *,arg1)
...
/*va_dcl*/
{
	...
	fmt = EXP_VARARGS_START(char *,arg1,args);
	/*va_start(args);*/
	/*fmt = va_arg(args,char *);*/
	vfprintf(stderr,fmt,args);
	if (debugfile) vfprintf(debugfile,fmt,args);
...
void
exp_sprintf EXP_VARARGS_DEF(char *,arg1)

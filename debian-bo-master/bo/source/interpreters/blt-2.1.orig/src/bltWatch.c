 ...
 *
 * "blt_watch" command created by George Howlett.
 */

#include "bltInt.h"

#define WATCH_VERSION "1.0"
    ...
    Tk_Uid nameId;
{
    ...
    if (watchPtr == NULL) {
	interp->result = "can't allocate watch structure";
	return NULL;
    }
    ...
    Tcl_Interp *interp;
{
	...
	"watch", WATCH_VERSION, WatchCmd, WatchDeleteCmd
    };

    ...
    Element *elemPtr;
{
     ...
     */
    rectArr = (XRectangle *)calloc(numDataPoints, sizeof(XRectangle));
    if (rectArr == NULL) {
	...
	segArr = (XRectangle *)malloc(numVisible * sizeof(XRectangle));
	if (segArr == NULL) {
	    Panic("can't allocate bar array");
	}
	barPtr->segArr = segArr;
	indexArr = (int *)malloc(numVisible * sizeof(int));
	if (indexArr == NULL) {
    ...
    XRectangle **segPtrPtr;
{
    ...
    rectArr = (XRectangle *)malloc(sizeof(XRectangle) * 

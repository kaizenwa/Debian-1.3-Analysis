...
#define DEF_FRAME_BG_COLOR		STD_NORMAL_BG_COLOR
...
#define DEF_FRAME_HIGHLIGHT_BG		STD_NORMAL_BG_COLOR
    ...
    char *argv[];			/* Configuration arguments. */
{
    ...
    Itk_SetWidgetCommand(tkwin, framePtr->widgetCmd);
    ...
    Tcl_Interp *interp;
{
    ...
    {
	{ "tileframe", "0.9", FrameCmd, },
	{ "tiletoplevel", "0.9", FrameCmd, },
    };

...
#define DEF_BUTTON_ACTIVE_BG_COLOR	STD_ACTIVE_BG_COLOR
#define DEF_BUTTON_ACTIVE_BG_MONO	BLACK
#define DEF_BUTTON_ACTIVE_FG_COLOR	BLACK
#define DEF_BUTTON_ACTIVE_FG_MONO	WHITE
#define DEF_BUTTON_BG_COLOR		STD_NORMAL_BG_COLOR
#define DEF_BUTTON_BG_MONO		WHITE
#define DEF_BUTTON_BITMAP		""
#define DEF_BUTTON_BORDER_WIDTH		"2"
#define DEF_BUTTON_CURSOR		""
#define DEF_BUTTON_COMMAND		""
#define DEF_BUTTON_DISABLED_FG_COLOR	STD_DISABLE_FG_COLOR
#define DEF_BUTTON_DISABLED_FG_MONO	""
#define DEF_BUTTON_FG			BLACK
#define DEF_BUTTON_FONT			"-Adobe-Helvetica-Bold-R-Normal--*-120-*-*-*-*-*-*"
#define DEF_BUTTON_HEIGHT		"0"
#define DEF_BUTTON_HIGHLIGHT_BG		STD_NORMAL_BG_COLOR
 ...
 *--------------------------------------------------------------
 *
 * ButtonCmd, CheckbuttonCmd, LabelCmd, RadiobuttonCmd --
 *
				 ...
				 * TYPE_RADIO_BUTTON. */
{
    ...
    butPtr->tileGC = butPtr->activeTileGC = None;
    ...
    int flags;			/* Flags to pass to Tk_ConfigureWidget. */
{
    ...
    gcValues.clip_mask = butPtr->bitmap;
    if ((butPtr->bitmap != None) && (butPtr->imageString == NULL)) {
	clipMask = GCClipMask;
    } else {
	clipMask = 0;
    }
    ...
    newGC = Tk_GetGC(butPtr->tkwin,
	    clipMask|GCForeground|GCBackground|GCFont|GCGraphicsExposures,
	    &gcValues);
    if (butPtr->normalTextGC != None) {
	Tk_FreeGC(butPtr->display, butPtr->normalTextGC);
    }
	...
	newGC = Tk_GetGC(butPtr->tkwin,
		clipMask|GCForeground|GCBackground|GCFont, &gcValues);
	if (butPtr->activeTextGC != None) {
	    Tk_FreeGC(butPtr->display, butPtr->activeTextGC);
	}
	...
	if ((butPtr->disabledFg != NULL) && (butPtr->imageString == NULL)) {
	    ...
	    mask = clipMask|GCForeground|GCBackground|GCFont;
	} else {
    ...
    XEvent *eventPtr;		/* Information about event. */
{
	...
	if (butPtr->tkwin != NULL) {
#ifdef ITCL_NAMESPACES
	    Itk_SetWidgetCommand(butPtr->tkwin, (Tcl_Command)NULL);
#endif
	    butPtr->tkwin = NULL;
    ...
    Tcl_Interp *interp;
{
	...
	{"tilebutton", "0.9", ButtonCmd, },
	{"tilecheckbutton", "0.9", CheckbuttonCmd, },
	{"tileradiobutton", "0.9", RadiobuttonCmd, },
	{"tilelabel", "0.9", LabelCmd, },
    };

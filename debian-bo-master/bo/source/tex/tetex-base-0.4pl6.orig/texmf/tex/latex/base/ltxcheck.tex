...
%
\ProvidesFile{ltxcheck.tex}[1997/01/14 v1.1a LaTeX check file (DPC)]
%
...
%    \begin{macrocode}
    ...
    \ifdim\wd0>\wd2
     \typeout{^^J%
OK: dc fonts release 1.3 or later installed^^J%
Note however that the dc font distribution will soon^^J%
(probably January 97) be replaced by ec fonts.}}%
    \else
     \typeout{^^J%
! BAD dc fonts 1.2 or older installed.^^J%
Current (as of 1997/01/14) dc font release is 1.3.^^J%
These dc fonts may be obtained from CTAN archives, in:^^J%
tex-archive/fonts/dc.^^J%
...
tex-archive/fonts/dc^^J%
They are expected to be replaced by the ec fonts in January 1997}
    \pause
    \dcrseventeen
    \ifin@\else
      \typeout{^^J%
...
These dc fonts may be obtained from CTAN archives, in:^^J%
tex-archive/fonts/dc^^J%
They are expected to be replaced by the ec fonts in January 97.}
    \fi
%    \end{macrocode}
%
%    \begin{macrocode}

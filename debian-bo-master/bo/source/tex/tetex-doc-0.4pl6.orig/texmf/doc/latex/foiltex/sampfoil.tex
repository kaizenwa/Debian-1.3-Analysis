%% 
%% This is file `sampfoil.tex', generated 
%% on <1995/9/14> with the docstrip utility (2.0.1).
%% 
...
\rightheader{\filedate}                % \filedate is defined above
...
\leftheader{}    %
\rightfooter{\filedate\quad\textsf{\thepage}}
...
\item Here is a list of accents:
  ...
  \end{itemize}
\item First in paragraph mode:
  \begin{itemize}
  \item \dag, \ddag, \S, \P, \copyright, \pounds, 0123456789
  \end{itemize}
\item Then in math mode: (numerals are different!)
  \begin{itemize}
  \item $\dag$, $\ddag$, $\S$, $\P$, $\copyright$, $\pounds$,
        $0123456789$
  \end{itemize}
\item Here are more foreign language symbols:
  \begin{itemize}
  \item \oe, \OE, \ae, \AE, \aa,   \AA, \o, \O, \l, \L, \ss, ?`, !`
     % In the \texttt{T1} encoding, the last two are no longer ligatures.
     % Some people consider this a design fault.  Do you?
  \end{itemize}

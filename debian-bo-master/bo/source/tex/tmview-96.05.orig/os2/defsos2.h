/* defs for the os2 version of tmview */
...
#define TFMDIR  "D:\\EMTEX\\TFM"
#define PKDIR   "D:\\TEXFONTS\\PIXEL.LJ"
#define PKNAME  "@Mdpi\\@K.pk"


/* set defaults for the option -s */
#define STARTUPFILENAME "D:\\dvilbfpm.cnf"


/* if DOSFILES is defined, a dosfilesystem is expected, */ 
/* incl. ugly naming conventions, like drive-letters and "\" instead ob "/". */
/* Dont use this with linux !!! But do with os2 !!!*/ 
...
/* they make tmview to go with os2/pm */
...
/* startup with zoomfactor 0.33 and in the fast zooming mode*/
#define SHRINK 3.0
...
#define HASWINDOWS        /* os2/pm is a window system (tmview not!)*/

/* when to draw directly on the screen ? (see defslx.h) */
#define ALLONSCREEN         0
#define NOTHINGONSCREEN     0
#define CURSORSNOTONSCREEN  0
#define SCROLLONSCREEN      1
...
/* definition of some rgb triples, 8-bit-per-componente   */
/* in fact beside of greyscales no other colors are used. */
/* to make green more blue, edit here.                    */

#define PALWHITE 255,255,255  /* white */
#define PALLGREY 220,220,220  /* light grey */
#define PALBLACK 0,0,0        /* black */
#define PALDRED 160,40,20     /* dark red */
#define PALDGREEN 0,160,40    /* dark green */
#define PALDBLUE 12,40,160    /* dark blue */
#define PALLRED 255,200,172   /* light red */
#define PALLGREEN 160,255,200 /* light green */
#define PALLBLUE 172,200,255  /* light blue */

/* definition of colors                                     */
/* this determines the colors on the display                */
/* the following may be changed without any (?) restictions.*/
/* setting                                                  */ 
/* #define SETPALFRAMECOL FRAMECOL,0,255,0                  */

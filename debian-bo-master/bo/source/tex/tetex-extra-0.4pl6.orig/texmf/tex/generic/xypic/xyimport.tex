%% xyimport.tex from $Id: xyimport.doc,v 3.3 1996/12/18 09:19:22 ross Exp $
%%
...
\xyprovide{import}{Import graphics extension}{\stripRCS$Revision: 3.3 $}%
...
\xydef@\xyextern@x#1{\toks@={\egroup\L@c=}\setboxz@h{#1}%
 ...
 \ifdim\Y@min>-\D@c \Y@min=-\D@c \fi \ifdim\X@max<\U@c \Y@max=\U@c \fi
 \idfromc@{import}\POS }
\xyendinput

...
/* We use them for the DDD `regex' class, however, since
   - they are renamed to GNU_regcomp(), GNU_regexec() and thus prevent 
     conflicts;
   - they are used only if the system does not provide POSIX.2 functions.
 */
#if 1 /*!defined(emacs)*/

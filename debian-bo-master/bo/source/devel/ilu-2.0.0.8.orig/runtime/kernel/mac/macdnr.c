...
extern OSErr HInfo(char *hostName, struct returnRec *returnRecPtr, ResultProcPtr resultProc, char *userDataPtr);
extern OSErr MXInfo(char *hostName, struct returnRec *returnRecPtr, ResultProcPtr resultProc, char *userDataPtr);
...
char *fileName;
{
	...
	/* call open resolver */
	rc = (*(OSErr(*)(long,char*))dnr)(OPENRESOLVER, fileName);
	if (rc != noErr) {
...
OSErr CloseResolver(void)
{
	...
	/* call close resolver */
	(void) (*(OSErr(*)(long))dnr)(CLOSERESOLVER);
...
char *userDataPtr;
{
	if (dnr == nil)
		/* resolver not loaded error */
		return(notOpenErr);
	return (*(OSErr(*)(long,char*,struct hostInfo*,ResultProcPtr,char*))dnr)
		(STRTOADDR, hostName, rtnStruct, resultproc, userDataPtr);
}
...
char *addrStr;									
{
	...
	(*(OSErr(*)(long,unsigned long,char*))dnr)(ADDRTOSTR, addr, addrStr);
	return(noErr);
}
...
char *userDataPtr;
{
	...
	return (*(OSErr(*)(long,ResultProcPtr,char*))dnr)
		(ENUMCACHE, resultproc, userDataPtr);
}
...
char *userDataPtr;									
{
	...
	return (*(OSErr(*)(long,ip_addr,struct hostInfo*,ResultProcPtr,char*))dnr)
		(ADDRTONAME, addr, rtnStruct, resultproc, userDataPtr);
}
...
extern OSErr HInfo(char *hostName, struct returnRec *returnRecPtr, ResultProcPtr resultProc, char *userDataPtr)
{
	...
	return (*(OSErr(*)(long,char*,struct returnRec*,ResultProcPtr,char*))dnr)
		(HINFO, hostName, returnRecPtr, resultProc, userDataPtr);
...
extern OSErr MXInfo(char *hostName, struct returnRec *returnRecPtr, ResultProcPtr resultProc, char *userDataPtr)
{
	...
	return (*(OSErr(*)(long,char*,struct returnRec*,ResultProcPtr,char*))dnr)
		(MXINFO, hostName, returnRecPtr, resultProc, userDataPtr);

...
private:
  ...
  // Check a branch by node pointer
  idl_bool			check_branch(AST_UnionBranch *branch);

  // Check a "default" branch label
  idl_bool			check_default(AST_UnionBranch *b);

  // Check a union branch label. This is used to
  // check for duplicate labels
  idl_bool			check_label(AST_UnionBranch *b,
					    AST_UnionLabel *l);

  // Check a union branch label given an enumerator. This is used to
  // check for duplicate enum labels
  idl_bool			check_enum(AST_UnionBranch *b,
					   AST_UnionLabel *l);

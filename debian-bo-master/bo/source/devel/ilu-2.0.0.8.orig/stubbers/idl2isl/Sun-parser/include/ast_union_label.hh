...
public:
  ...
  // Constructor(s)
  AST_UnionLabelSet(long max_size);
  virtual ~AST_UnionLabelSet();

  void add_element(AST_UnionLabel *e);

  // Data Accessors
  long cardinality();
  AST_UnionLabel *get_element(long index);
  idl_bool contains_default_label();
...
private:
  ...
  long				pd_max_size;
  long				pd_size;
  AST_UnionLabel **		pd_label_ptr_array;

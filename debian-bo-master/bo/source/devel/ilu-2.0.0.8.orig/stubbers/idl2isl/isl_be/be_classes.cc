...
static const char rcsid[] = "$Id: be_classes.cc,v 2.2 1996/04/30 06:33:26 janssen Exp $";
...
be_union_branch::be_union_branch(AST_UnionLabelSet *labs, AST_Type *ft,
				 UTL_ScopedName *n, UTL_StrList *p)
	       : AST_UnionBranch(labs, ft, n, p),

...
*/
/* $Id: cstubber.h,v 1.25 1996/05/29 19:04:39 janssen Exp $ */
/* Last edited by Mike Spreitzer April 2, 1996 1:06 pm PST */
...
void	_<c_type_name(t)>__Output(ilu_Call c, <c_parameter_type(t,In)> v,
				  ilu_Error *e);

ilu_cardinal
	_<c_type_name(t)>__SizeOf(ilu_Call c, <c_parameter_type(t, In)> v,
				  ilu_Error *e);

...
$Id: prttree.c,v 1.5 1994/12/09 19:10:19 severson Exp $
*/
...
{
	list_enumerate(d->structuredDes.record, (EnumProc) ptRecordField, NULL);
}
...
ptInterface(Interface ifc)
{
	...
	list_enumerate(ifc->types,      (EnumProc) ptType,      NULL);

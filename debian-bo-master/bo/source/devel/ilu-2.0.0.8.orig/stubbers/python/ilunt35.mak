...
ALL : $(ILUHOME) $(ILUHOME)\bin $(ILUHOME)\lib PSTUBMAKE
...
PSTUBMAKE :
	nmake -f pstubber.mak CFG="Win32 Debug"
# 	XXX Note ignoring config for now since release build has access violation!

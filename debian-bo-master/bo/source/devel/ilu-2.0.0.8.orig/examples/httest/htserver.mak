...
!MESSAGE 
!MESSAGE NMAKE /f "htserver.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : "$(OUTDIR)\htserver.exe"

CLEAN : 
	-@erase "$(INTDIR)\htserver.obj"
	-@erase "$(INTDIR)\httest-common.obj"
	-@erase "$(INTDIR)\httest-true.obj"
	-@erase "$(INTDIR)\http-common.obj"
	-@erase "$(INTDIR)\http-true.obj"
	-@erase "$(OUTDIR)\htserver.exe"
...
CPP_PROJ=/nologo /MD /W3 /GX /O2 /I $(ILUHOME)\include /D "WIN32" /D "NDEBUG"\
 /D "_CONSOLE" /Fp"$(INTDIR)/htserver.pch" /YX /Fo"$(INTDIR)/" /c 
CPP_OBJS=.\WinRel/
CPP_SBRS=.\.
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o"$(OUTDIR)/htserver.bsc" 
BSC32_SBRS= \
...
LINK32_FLAGS=$(ILUHOME)\lib\iluc32.lib $(ILUHOME)\lib\ilu32.lib wsock32.lib\
 ...
 /subsystem:console /incremental:no /pdb:"$(OUTDIR)/htserver.pdb" /machine:I386\
 /out:"$(OUTDIR)/htserver.exe" 
LINK32_OBJS= \
	"$(INTDIR)\htserver.obj" \
	"$(INTDIR)\httest-common.obj" \
	"$(INTDIR)\httest-true.obj" \
	"$(INTDIR)\http-common.obj" \
	"$(INTDIR)\http-true.obj"

"$(OUTDIR)\htserver.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
...
CLEAN : 
	...
	-@erase "$(OUTDIR)\htserver.exe"
	-@erase "$(OUTDIR)\htserver.ilk"
	-@erase "$(OUTDIR)\htserver.pdb"
...
CPP_PROJ=/nologo /MD /W3 /Gm /GX /Zi /Od /I $(ILUHOME)\include /D "WIN32" /D\
 "_DEBUG" /D "_CONSOLE" /Fp"$(INTDIR)/htserver.pch" /YX /Fo"$(INTDIR)/"\
 /Fd"$(INTDIR)/" /c 
CPP_OBJS=.\WinDebug/
CPP_SBRS=.\.
...
LINK32_FLAGS=$(ILUHOME)\lib\iluc32.lib $(ILUHOME)\lib\ilu32.lib wsock32.lib\
 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib\
 shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /nologo\
 /subsystem:console /incremental:yes /pdb:"$(OUTDIR)/htserver.pdb" /debug\
 /machine:I386 /out:"$(OUTDIR)/htserver.exe" 
LINK32_OBJS= \
	"$(INTDIR)\htserver.obj" \
	"$(INTDIR)\httest-common.obj" \
	"$(INTDIR)\httest-true.obj" \
...
"$(INTDIR)\htserver.obj" : $(SOURCE) $(DEP_CPP_HTSER) "$(INTDIR)"
...
"$(INTDIR)\httest-true.obj" : $(SOURCE) $(DEP_CPP_HTTES) "$(INTDIR)"

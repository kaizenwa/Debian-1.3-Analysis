...
CLEAN : 
	...
	-@erase "$(INTDIR)\http-surrogate.obj"
...
SOURCE=".\http-surrogate.c"

!IF  "$(CFG)" == "Win32 Release"


"$(INTDIR)\http-surrogate.obj" : $(SOURCE) "$(INTDIR)"
...
"$(INTDIR)\http-surrogate.obj" : $(SOURCE) $(DEP_CPP_HTTP_) "$(INTDIR)"

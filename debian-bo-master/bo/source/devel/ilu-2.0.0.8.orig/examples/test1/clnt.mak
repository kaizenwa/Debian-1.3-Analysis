...
!MESSAGE 
!MESSAGE NMAKE /f "clnt.mak" CFG="Win32 Debug"
!MESSAGE 
...
ALL : $(OUTDIR)/client.exe $(OUTDIR)/clnt.bsc
...
CPP_PROJ=/nologo /MD /W3 /GX /YX /Ox /Oy- /I "$(ILUHOME)\include" \
 ...
 /Fp$(OUTDIR)/"clnt.pch" /Fo$(INTDIR)/ /c 
CPP_OBJS=.\WinRel/
...
# ADD BSC32 /nologo
BSC32_FLAGS=/nologo /o$(OUTDIR)/"clnt.bsc" 

$(OUTDIR)/clnt.bsc : $(OUTDIR)  $(BSC32_SBRS)
LINK32=link.exe
...
LINK32_FLAGS=$(ILUHOME)\lib\iluc32.lib $(ILUHOME)\lib\ilu32.lib wsock32.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:no /PDB:$(OUTDIR)/"clnt.pdb" /MACHINE:I386\
...
CPP_PROJ=/nologo /MD /W3 /GX /Zi /YX /Od /I "$(ILUHOME)\include" \
 ...
 /Fp$(OUTDIR)/"clnt.pch" /Fo$(INTDIR)/ /Fd$(OUTDIR)/"clnt.pdb" /c 
CPP_OBJS=.\WinDebug/
...
# ADD LINK32 \ilu\lib\iluc32.lib \ilu\lib\ilu32.lib wsock32.lib kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /NOLOGO /SUBSYSTEM:console /DEBUG /MACHINE:I386 /OUT:"WinDebug/client.exe"
LINK32_FLAGS=$(ILUHOME)\lib\iluc32.lib $(ILUHOME)\lib\ilu32.lib wsock32.lib kernel32.lib\
 user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib\
 ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib /NOLOGO\
 /SUBSYSTEM:console /INCREMENTAL:yes /PDB:$(OUTDIR)/"clnt.pdb" /DEBUG\
 /MACHINE:I386 /OUT:"WinDebug/client.exe" 
DEF_FILE=
LINK32_OBJS= \
	$(INTDIR)/Test1-common.obj \
	$(INTDIR)/Test1-surrogate.obj \
...
$(INTDIR)/clntu.obj :  $(SOURCE) $(DEP_CLNTU_)  $(INTDIR)

...
void t_0_assignment ()
{
  ...
  t_0_st_1_obj1 = t_0_st_1 (t_0_st_0_obj0);		// ERROR - 
}

void t_0_local_init ()
{
  t_0_st_1 t_0_st_1_obj0 = t_0_st_0_obj0;		// ERROR - 
  t_0_st_1 t_0_st_1_obj1 = t_0_st_1 (t_0_st_0_obj0);	// ERROR - 
}
...
void t_1_local_init ()
{
  ...
  t_1_st_1 t_1_st_1_obj1 = t_1_st_1 (t_1_st_0_obj0);	// ERROR - 
}
...
void t_2_assignment ()
{
  ...
  t_2_st_1_obj1 = t_2_st_1 (t_2_st_0_obj0);		// ERROR - 
}

void t_2_local_init ()
{
  t_2_st_1 t_2_st_1_obj0 = t_2_st_0_obj0;		// ERROR - 
  t_2_st_1 t_2_st_1_obj1 = t_2_st_1 (t_2_st_0_obj0);	// ERROR - 
}

...
template <class BidirectionalIterator, class T, class Reference _DEF (T&), 
          class Distance _DEF (ptrdiff_t)> 
...
template <class RandomAccessIterator, class T, class Reference _DEF (T&),
          class Distance _DEF (ptrdiff_t)> 
...
template <class T, class Distance _DEF (ptrdiff_t)>

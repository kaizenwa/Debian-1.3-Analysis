...
/* FIXME: At the moment this code only checks for physical address wrapping */
...
__sizemem ()
{
  ...
  /* TODO: reset bus error counter */
  
#if 1
  /* K1BASE is the uncached kernel physical space */
  base = (volatile unsigned int *)K1BASE;
#else
  /* K0BASE is the cached kernel physical space */
  /* TODO: disable caches */
  base = (volatile unsigned int *)K0BASE;
#endif
  baseorig = *base;
  ...
  *base = baseorig;
  ...
  /* TODO: restore entry interrupt enable state */

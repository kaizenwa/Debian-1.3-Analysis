...
extern "C" 
{
  ...
  PASCAL struct protoent  *  getprotobyname(const char  * name);
  ...
  PASCAL struct servent *  getservbyname(const char * name,
					const char * proto);

PASCAL struct hostent  *   gethostbyname(const char  * name);

...
#define hidecrsr(ws) /* noop */
#define showcrsr(ws) /* noop */
...
#define YTOROW(wb, y)    ((y) /  LEADING(wb) + 1)
...
#define FREE_STDLOCALS(w) ReleaseDC((w)->window->iconwin, stddc); DeleteDC(pixdc);

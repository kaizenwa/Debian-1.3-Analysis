 ...
 */
hidden struct code    *ck_unneed Params((struct code *cd, struct code *lbl));
hidden novalue         clps_brch Params((struct code *branch));
hidden novalue         dec_refs  Params((struct code *cd));
hidden novalue         rm_unrch  Params((struct code *cd));
 ...
 */
static novalue clps_brch(branch)
struct code *branch;
   {
   struct code *cd;
   int save_id;

      ...
      table: {
	    ...
	    struct b_telem *te;
            ...
            for (i = 0; i < HSegs && src->table.hdir[i] != NULL; i++)
               memcopy((char *)dst->table.hdir[i], (char *)src->table.hdir[i],

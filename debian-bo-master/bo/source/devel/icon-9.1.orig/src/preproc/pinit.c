 ...
 */
hidden novalue define_opt   Params((char *s, int len, struct token *dflt));
hidden novalue do_directive Params((char *s));
hidden novalue mac_opts     Params((char *opt_lst, char **opt_args));
hidden novalue undef_opt    Params((char *s, int len));
 ...
 */
novalue init_preproc(fname, opt_lst, opt_args)
char *fname;
char *opt_lst;
char **opt_args;
   {
 ...
 */
static novalue mac_opts(opt_lst, opt_args)
char *opt_lst;
char **opt_args;
   {
   int i;
 ...
 */
novalue str_src(src_name, s, len)
char *src_name;
char *s;
int len;
   {
 ...
 *  undefine it.
 */
static novalue undef_opt(s, len)
char *s;
int len;
   {
   struct token *mname;
 ...
 */
static novalue define_opt(s, len, dflt)
char *s;
int len;
struct token *dflt;
   {

...
COBJS=	../common/long.o ../common/memory.o ../common/time.o ../common/save.o \
	../common/rswitch.o ../common/redirerr.o ../common/xwindow.o \
	../common/alloc.o

ICOBJS=	long.o memory.o time.o save.o rswitch.o redirerr.o xwindow.o alloc.o
...
iconx: $(OBJS)
	$(CC) $(LDFLAGS) -o iconx  $(OBJS) $(XPMLIB) $(XLIB) -lm
	cp iconx ../../bin
	strip ../../bin/iconx
...
rt.a: ../common/rswitch.o ../common/long.o ../common/time.o ../common/memory.o\
	...
	ar qc rt.a `sed 's/$$/.o/' rttfull.lst` ../common/rswitch.o\
	    ../common/long.o ../common/time.o ../common/memory.o\

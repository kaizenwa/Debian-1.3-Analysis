...
o_callbacks_t
o_map_key_callbacks(o_map_t * yy)
{
...
const void *
o_map_not_a_key_marker(o_map_t *yy)
{
...
const void *
o_map_not_a_value_marker(o_map_t *yy)
{
...
o_callbacks_t
o_map_element_callbacks(o_map_t *yy)
{
  return yy->callbacks;
}
...
const void *
o_map_not_an_element_marker(o_map_t *yy)
{

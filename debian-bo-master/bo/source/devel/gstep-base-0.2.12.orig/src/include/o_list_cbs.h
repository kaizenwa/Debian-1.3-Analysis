/* Getting callbacks from list structures.
...
#ifndef __list_cbs_h_OBJECTS_INCLUDE
#define __list_cbs_h_OBJECTS_INCLUDE 1
...
o_callbacks_t o_list_key_callbacks (o_list_t *yy);

/* Returns the ``bogus'' marker associated with YY's keys. */
const void *o_list_not_a_key_marker (o_list_t *yy);

/* Returns the callbacks associated with YY's values. */
o_callbacks_t
o_list_value_callbacks (o_list_t *yy);

/* Returns the ``bogus'' marker associated with YY's values. */
const void *o_list_not_a_value_marker (o_list_t *yy);
...
o_callbacks_t o_list_element_callbacks (o_list_t *yy);

/* Returns the ``bogus'' marker associated with YY's elements. */
const void *o_list_not_an_element_marker (o_list_t *yy);

#endif /* __map__ */

#endif /* __list_cbs_h_OBJECTS_INCLUDE */

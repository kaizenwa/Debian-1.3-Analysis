...
#ifndef __array_cbs_h_OBJECTS_INCLUDE
#define __array_cbs_h_OBJECTS_INCLUDE 1
...
o_callbacks_t o_array_key_callbacks (o_array_t *yy);

/* Returns the ``bogus'' marker associated with YY's keys. */
const void *o_array_not_a_key_marker (o_array_t *yy);
...
const void *o_array_not_a_value_marker (o_array_t *yy);
...
o_callbacks_t o_array_element_callbacks (o_array_t *yy);

/* Returns the ``bogus'' marker associated with YY's elements. */
const void *o_array_not_an_element_marker (o_array_t *yy);

#endif /* __map__ */

#endif /* __array_cbs_h_OBJECTS_INCLUDE */

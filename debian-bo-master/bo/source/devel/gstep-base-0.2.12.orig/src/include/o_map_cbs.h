/* Getting callbacks from map structures.
...
#ifndef __map_cbs_h_OBJECTS_INCLUDE
#define __map_cbs_h_OBJECTS_INCLUDE 1
...
o_callbacks_t o_map_element_callbacks (o_map_t *yy);

/* Returns the ``bogus'' marker associated with YY's elements. */
const void *o_map_not_an_element_marker (o_map_t *yy);

#endif /* __map__ */

#endif /* __map_cbs_h_OBJECTS_INCLUDE */

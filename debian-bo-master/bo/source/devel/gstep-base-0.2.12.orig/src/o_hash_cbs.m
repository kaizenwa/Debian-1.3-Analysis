...
o_callbacks_t
o_hash_key_callbacks(o_hash_t * yy)
{
...
const void *
o_hash_not_a_key_marker(o_hash_t *yy)
{
...
const void *
o_hash_not_a_value_marker(o_hash_t *yy)
{
...
o_callbacks_t
o_hash_element_callbacks(o_hash_t *yy)
{
  return yy->callbacks;
}
...
const void *
o_hash_not_an_element_marker(o_hash_t *yy)
{

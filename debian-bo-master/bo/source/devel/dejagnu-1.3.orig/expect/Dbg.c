...
/* START OF SECTION FROM expect_comm.h.  */
...
/* END OF SECTION FROM expect_comm.h.  */
...
static void print EXP_PROTOV(EXP_VARARGS(Tcl_Interp*,arg1));
...
static void
print EXP_VARARGS_DEF(Tcl_Interp*,arg1)
/*print(va_alist)*/
/*va_dcl*/
{
	Tcl_Interp *interp;

...
static inline void * __memset_generic(void *s, unsigned char c, size_t count)
{
__asm__ __volatile__(
	"cld\n\t"
	"rep\n\t"
...
#define memset(s,c,count) __memset_generic((s),(c),(count))
#if 0
...
extern void *memset(void *s, unsigned char c, size_t count);
extern char *memscan(void *addr, unsigned char c, int size);
#endif

...
Define_extern_entry(mercury__term_to_type_2_0);
Declare_label(mercury__term_to_type_2_0_i1);
Define_extern_entry(mercury__type_to_term_2_0);
Declare_label(mercury__type_to_term_2_0_i1);
...
BEGIN_MODULE(call_module)
	...
	init_entry(mercury__term_to_type_2_0);
	init_label(mercury__term_to_type_2_0_i1);
	init_entry(mercury__type_to_term_2_0);
	init_label(mercury__type_to_term_2_0_i1);
BEGIN_CODE
...
Define_entry(mercury__term_to_type_2_0);
{
...
** even though it is not needed with COMPACT_ARGS.
*/
Define_label(mercury__term_to_type_2_0_i1);
{
#if OFFSET_FOR_ARG_TYPE_INFOS != 6
	fatal_error("type_to_term/2 and term_to_type/2 not implemented");
#else
...
Define_entry(mercury__type_to_term_2_0);
{
#if OFFSET_FOR_ARG_TYPE_INFOS != 6
	fatal_error("type_to_term/2 and term_to_type/2 not implemented");
#else
...
** even though it is not needed with COMPACT_ARGS.
*/
Define_label(mercury__type_to_term_2_0_i1);
{
#if OFFSET_FOR_ARG_TYPE_INFOS != 6
	fatal_error("type_to_term/2 and term_to_type/2 not implemented");
#else

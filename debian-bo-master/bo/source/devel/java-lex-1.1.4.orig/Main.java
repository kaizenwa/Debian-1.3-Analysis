...
class CEmit
{
  ...
  private void emit_construct
      ...
      throws java.io.IOException
	{
	  ...
	  m_outstream.writeBytes("\tprivate final byte YYEOF = -1;\n");
  ...
  private void emit_helpers
	...
	/* Function: yy_advance */
	m_outstream.writeBytes("\tprivate byte yy_advance ()\n");
  ...
  private void emit_table
	...
	m_outstream.writeBytes("\tprivate int yy_nxt[][] = {\n");
  ...
  private void emit_driver
      ...
      throws java.io.IOException
	{
	  ...
	  m_outstream.writeBytes("\t\tbyte yy_lookahead;\n");
      ...
      throws java.io.IOException 
	{
	  ...
	  while (m_lexGen.EOS != m_spec.m_current_token 
	      ...
	      if (m_lexGen.DASH == m_spec.m_current_token)
		{
		  if (-1 == first)
		    {
		      CError.parse_error(CError.E_DASH,
...
public class Main
{
  ...
  public static void main
	...
	if (arg.length < 1)
	  {
	    System.out.println("Usage: JavaLex.Main <filename>");
	    return;
	  }
...
class CLexGen 
{
  ...
  CLexGen 
	...
	/* Open output stream. */
	m_outstream = new DataOutputStream(new FileOutputStream(filename + ".java"));
	if (null == m_outstream)
	  {

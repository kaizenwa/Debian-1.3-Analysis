...
package body Nmake is
   ...
   begin
      ...
      Set_Expression (N, Expression);
      Set_No_Default_Init (N, No_Default_Init);
      return N;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Concat_Multiple, Sloc);
   begin
      Set_Expressions (N, Expressions);
      return N;
   end Make_Concat_Multiple;
   ...
   is
      N : constant Node_Id :=
            New_Node (N_Interpretation, Sloc);
   begin
      Set_Chars (N, Chars);
      return N;
   end Make_Interpretation;

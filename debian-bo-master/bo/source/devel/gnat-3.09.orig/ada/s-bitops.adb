...
package body System.Bit_Ops is
   ...
   subtype Bits_Array is
     System.Unsigned_Types.Packed_Bytes_Unaligned (Natural);
   ...
   begin
      if Llen /= Rlen then
         ...
         begin
            ...
            elsif LeftB (0 .. BLen - 1) /= RightB (0 .. BLen - 1) then
               return False;

            elsif Bitc /= 0 then
               return
                 ((LeftB (BLen) xor RightB (BLen)) and Masks (Bitc)) = 0;

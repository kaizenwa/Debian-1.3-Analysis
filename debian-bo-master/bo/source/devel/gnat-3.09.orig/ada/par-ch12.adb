...
package body Ch12 is
   ...
   function P_Formal_Function_Declaration              return Node_Id;
   ...
   function P_Formal_Procedure_Declaration             return Node_Id;
         ...
         if Token = Tok_Use then
            ...
            if Token = Tok_Identifier then
               ...
               if Token = Tok_Package then
                  ...
                  Append (P_Formal_Procedure_Declaration, Decls);

               elsif Token = Tok_Function then
                  Append (P_Formal_Function_Declaration, Decls);
   ...
   begin
      ...
      if Token = Tok_Abstract then
         Note_Feature (Generic_Formal_Private_Types, Token_Ptr);
         Scan; -- past ABSTRACT
   ...
   begin
      ...
      Note_Feature (Generic_Contract_Rules, Token_Ptr);
   ...
   function P_Formal_Function_Declaration return Node_Id is
      Def_Node : Node_Id;
   ...
   begin
      ...
      T_Semicolon;
      return Def_Node;
   end P_Formal_Function_Declaration;

   function P_Formal_Procedure_Declaration return Node_Id is
      Def_Node : Node_Id;
   ...
   begin
      ...
      T_Semicolon;
      return Def_Node;
   end P_Formal_Procedure_Declaration;

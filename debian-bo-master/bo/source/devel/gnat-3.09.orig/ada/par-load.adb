...
begin
   ...
   --  If main unit, read and process configuration pragmas
   ...
   if Cur_Unum = Main_Unit then
      ...
      --  Also tentatively set Main_Unit_Entity (this will get overwritten if
   ...
   then
      ...
      Unum := Load_Unit (Spec_Name, False, Curunit, Corr_Body => Cur_Unum);

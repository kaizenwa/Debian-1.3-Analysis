...
package body Ch6 is
   ...
   begin
      ...
      --  Case of not followed by semicolon
         ...
         --  Case of IS following subprogram specification
            ...
            if Token = Tok_Abstract then
               Note_Feature (Abstract_Subprograms, Token_Ptr);
               Absdec_Node :=
      ...
      <<Subprogram_Body>>
         ...
         --  Subprogram body case
            ...
            if (Token in Token_Class_Declk or else
              Token = Tok_Identifier) and then
   ...
   begin
      ...
      --  Child library unit name case
         ...
         Note_Feature (Child_Units, Token_Ptr);
         ...
         begin
            ...
            Ident_List_Loop : loop
               ...
               if Token = Tok_Access then
                  ...
                  Note_Feature (Access_Parameters, Token_Ptr);
                  Set_Parameter_Type

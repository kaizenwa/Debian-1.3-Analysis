...
package body CStand is
   ...
   procedure Build_Signed_Integer_Type (E : Entity_Id; Siz : Int) is
      ...
      Usiz   : constant Uint := UI_From_Int (Siz);
   ...
   begin
      ...
      Set_Esize         (Standard_Boolean, Uint_8);
      ...
      begin
         if Hostparm.Long_Integer_Size /= 0 then
            LIS := Hostparm.Long_Integer_Size;
         elsif Debug_Flag_M then
            LIS := 64;
         else
      ...
      Set_RM_Size (Standard_Character, UI_From_Int (Standard_Character_Size));
      ...
      Set_RM_Size           (Standard_Wide_Character, Uint_16);
      ...
      Set_RM_Size   (Standard_Natural, Esize (Standard_Integer) - 1);
      ...
      Set_RM_Size (Standard_Positive, Esize (Standard_Integer) - 1);
      ...
      if Debug_Flag_6 then
         ...
         Set_Esize     (Standard_A_String,
                         UI_From_Int (System_Address_Size * 2));
      end if;
      ...
      Set_Esize     (Standard_A_Char, UI_From_Int (System_Address_Size));
      ...
      Set_Is_Character_Type
                         (Any_Character);
      Set_Esize          (Any_Character, UI_From_Int
                                          (Standard_Character_Size));
      Set_RM_Size        (Any_Character, UI_From_Int
                                          (Standard_Character_Size));
      ...
      Set_RM_Size (Any_Discrete, UI_From_Int (Standard_Integer_Size));
      ...
      Set_Esize   (Any_Fixed, Uint_32);
      Set_RM_Size (Any_Fixed, Uint_32);
      ...
      Set_RM_Size (Any_Integer, Esize (Standard_Long_Long_Integer));
      ...
      Set_Esize   (Any_Modular, Esize (Standard_Long_Long_Integer));
      Set_RM_Size (Any_Modular, Esize (Standard_Long_Long_Integer));
      Set_Is_Unsigned_Type
                  (Any_Modular);
      ...
      Set_RM_Size (Any_Numeric, Esize (Standard_Long_Long_Integer));
      ...
      Set_RM_Size (Any_Scalar, UI_From_Int (Standard_Integer_Size));
      ...
      Make_Component (Standard_Exception_Type, Standard_Boolean,
                                                    "Handled_By_Others");
      Make_Component (Standard_Exception_Type, Standard_Character, "C1");
      Make_Component (Standard_Exception_Type, Standard_Character, "C2");
      Make_Component (Standard_Exception_Type, Standard_Character, "C3");
      ...
      begin
         ...
         Decl := Make_Full_Type_Declaration (Stloc,
           ...
           Type_Definition => Make_Record_Definition (Stloc,
             Component_List => Make_Component_List (Stloc,

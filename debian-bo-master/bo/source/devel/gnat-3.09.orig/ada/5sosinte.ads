...
package System.OS_Interface is
   ...
   function thr_getprio
     (thread   : thread_t;
      priority : int)
     return int;
   pragma Import (C, thr_getprio, "thr_getprio");
   ...
   pragma Import (C, thr_getconcurrency, "thr_getconcurrency");

   ...
   begin
      ...
      while P < Pchar_Pos (Node_Kind'Succ (Nkind (N))) loop
         ...
         case F is
            ...
            when F_Flag1  => pragma Assert (False); null;
            when F_Flag2  => pragma Assert (False); null;
            when F_Flag3  => pragma Assert (False); null;
         ...
         if Field_To_Be_Printed then
            ...
            case F is
               ...
               when F_Field5 => Print_Field (Field5 (N), Fmt);
            ...
            begin
               ...
               --  should not normally happen.
                  ...
                  if (Sloc (N) <= Standard_Location
                        ...
                        or else Get_Sloc_Unit_Number (Sloc (Nod)) /=

...
package body System.Pack_15 is
   ...
   for Cluster'Alignment use
     1 +
     1 * Boolean'Pos (Bits mod 2 = 0) +
     2 * Boolean'Pos (Bits mod 4 = 0);
   --  Use maximum possible alignment, given the bit field size, since this
   --  will result in the most efficient code possible for the field. Note
   --  that System.Unsigned_Types.Packed_Bytes has an alignment of 4, so we
   --  cannot require a larger alignment.

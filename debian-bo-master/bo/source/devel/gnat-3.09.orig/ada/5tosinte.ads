...
private
   ...
   type array_type_9 is array (integer range 0 .. 18) of int;
   type array_type_10 is array (integer range 0 .. 18) of int;
   type array_type_11 is array (integer range 0 .. 2) of System.Address;
   type union_type_4 is new int;
   type record_type_6 is record
      si_signo     : int;
      si_code      : int;
      si_value     : union_type_4;
   end record;
   pragma Convention (C, record_type_6);
   type array_type_12 is array (integer range 0 .. 44) of record_type_6;
   type record_type_7 is record
      head         : System.Address;
      tail         : System.Address;
   end record;
   pragma Convention (C, record_type_7);
   type array_type_13 is array (integer range 0 .. 7) of System.Address;
   type record_type_5 is record
      context      : array_type_9;
      pbody        : array_type_10;
      errno        : int;
      ret          : int;
   ...
   type pthread_t is access record_type_5;

...
package Errout is
   ...
   --      is non-zero, then the reference will include the given number of
   ...
   --      of messages are treated as a unit.
   ...
   procedure Error_Msg_N (Msg : String; N : Node_Id);
   ...
   procedure Error_Msg_NE (Msg : String; N : Node_Id; E : Entity_Id);

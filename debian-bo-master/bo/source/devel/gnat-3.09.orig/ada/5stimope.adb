...
package body System.Time_Operations is
   ...
   begin
      ...
      --  delay request with negative value will return -1 and set errno to
      --  EINVAL. This should not be considered as an error.
      pragma Assert (Result = 0 or else errno = EINVAL

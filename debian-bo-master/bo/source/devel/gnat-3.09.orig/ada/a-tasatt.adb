...
--          Local'Unchecked_Access);
   ...
   begin
      ...
      begin
         Defer_Abortion; Write_Lock (TT.L, Lock_Result);
...
begin
   ...
   begin
      ...
      if Local.Index /= 0 then
         ...
         System.Tasking.Initialization.Initialize_Attributes_Link :=
      ...
      --  Attribute goes into a node onto a linked list
         ...
         System.Tasking.Initialization.Finalize_Attributes_Link :=
   ...
   exception
      when others => null;
         pragma Assert
           (System.Tasking.Utilities.Runtime_Assert_Shutdown
             ("Exception in task attribute initializer"));

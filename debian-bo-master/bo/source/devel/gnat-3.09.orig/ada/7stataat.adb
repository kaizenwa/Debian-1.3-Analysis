...
package body System.Tasking.Task_Attributes is
   ...
   begin
      ...
      begin
         ...
         pragma Assert (Q /= null or else Shutdown
   ...
   exception
      when others => null;
         pragma Assert (
           Shutdown ("Exception in task attribute instance finalization"));
   end Finalize;
   ...
   exception
      when others => null;
         pragma Assert (
           Shutdown ("Exception in per-task attributes finalization"));
   ...
   exception
      when others => null;
         pragma Assert (
           Shutdown ("Exception in per-task attributes initialization"));

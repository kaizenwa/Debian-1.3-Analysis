...
package body Scn is
   ...
   Max_Allowed_Line_Length : Nat := Hostparm.Max_Line_Length;
      ...
      <<Scan_Identifier>>
         ...
         if Identifier_Char (Source (Scan_Ptr)) then
            ...
            --  character depending on the encoding method).
               ...
               --  We can't get here in the ESC case, because ESC would not
               --  be in the identifier character set, but we can get here
               --  in the upper half encoding method case.

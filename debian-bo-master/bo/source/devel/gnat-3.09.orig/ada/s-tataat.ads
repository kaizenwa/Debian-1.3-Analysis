...
package System.Tasking.Task_Attributes is
   ...
   All_Attrs_L : System.Task_Primitives.Lock;
   ...
   --  (and before it actually dies), inside Leave_Task, via soft-link
   --  Finalize_Attributes_Link. On entry, abortion must be deferred and
   --  T.L must be write-locked.

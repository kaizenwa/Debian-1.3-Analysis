...
package System.Finalization_Implementation is
   ...
   --  the number of link of the linked_list, and can be either 0 for
   --  no attachement, 1 for simply linked lists or 2 for doubly linked
   --  lists. Attachement to a simply linked list is not protected against
   ...
   --  is protected against concurrent call. Typically used to attach to a
   --  dynamically allocated object to a List_Controller (whose first

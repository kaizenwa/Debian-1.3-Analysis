...
--  This is a SGI version of this package.

--  The SGI port does NOT install an Ada exception handler for synchronous
--  signals.  This is just a dummy body.  The actual binding is done in
--  gnatinit.c

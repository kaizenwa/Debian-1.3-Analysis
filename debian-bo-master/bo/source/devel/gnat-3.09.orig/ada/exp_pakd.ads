...
package Exp_Pakd is
   ...
   --    For an unconstrained array with component size 1,2,4:

   --      type xxxPn is new Packed_Bytes_Unaligned;

   --    For an unconstrained array with any other component size:
   ...
   --    For all other constrained arrays with component size 1,2,4:

   --       type xxxPn is new Packed_Bytes_Unaligned (0 .. m);

   --    For all other constrained arrays with component size 1,2,4:

   --       type xxxPn is new Packed_Bytes_Unaligned (0 .. m);

   --    For all other constrained arrays with other component sizes:

...
/*--------------------------------------------------------------------------*/
      ...
      #define N_Unchecked_Expression 64
      #define N_Unchecked_Type_Conversion 65
      #define N_Allocator 66
      #define N_Aggregate 67
      ...
      #define N_Entry_Declaration 74
      #define N_Entry_Index_Specification 75
      #define N_Formal_Object_Declaration 76
      #define N_Formal_Type_Declaration 77
      #define N_Freeze_Entity 78
      #define N_Full_Type_Declaration 79
      #define N_Incomplete_Type_Declaration 80
      #define N_Loop_Parameter_Specification 81
      #define N_Object_Declaration 82
      #define N_Private_Extension_Declaration 83
      #define N_Private_Type_Declaration 84
      #define N_Subtype_Declaration 85
      #define N_Protected_Type_Declaration 86
      #define N_Accept_Statement 87
      #define N_Function_Specification 88
      #define N_Procedure_Specification 89
      ...
      #define N_Assignment_Statement 121
      #define N_Asynchronous_Select 122
      #define N_Block_Statement 123
      #define N_Case_Statement 124
      #define N_Code_Statement 125
      #define N_Conditional_Entry_Call 126
      #define N_Delay_Relative_Statement 127
      #define N_Delay_Until_Statement 128
      #define N_Entry_Call_Statement 129
      #define N_Exit_Statement 130
      #define N_Free_Statement 131
      #define N_Goto_Statement 132
      #define N_If_Statement 133
      #define N_Loop_Statement 134
      #define N_Null_Statement 135
      #define N_Raise_Statement 136
      #define N_Requeue_Statement 137
      #define N_Return_Statement 138
      #define N_Selective_Accept 139
      #define N_Timed_Entry_Call 140
      #define N_Abortable_Part 141
      #define N_Abstract_Subprogram_Declaration 142
      #define N_Accept_Alternative 143
      #define N_Access_Definition 144
      #define N_Access_To_Object_Definition 145
      #define N_Case_Statement_Alternative 146
      #define N_Compilation_Unit 147
      #define N_Component_Association 148
      #define N_Component_List 149
      #define N_Derived_Type_Definition 150
      #define N_Decimal_Fixed_Point_Definition 151
      #define N_Defining_Program_Unit_Name 152
      #define N_Delay_Alternative 153
      #define N_Delta_Constraint 154
      #define N_Designator 155
      #define N_Digits_Constraint 156
      #define N_Discriminant_Association 157
      #define N_Discriminant_Specification 158
      #define N_Elsif_Part 159
      #define N_Enumeration_Type_Definition 160
      #define N_Entry_Body 161
      ...
      #define N_Itype_Reference 181
      #define N_Label 182
      #define N_Modular_Type_Definition 183
      #define N_Number_Declaration 184
      #define N_Ordinary_Fixed_Point_Definition 185
      #define N_Others_Choice 186
      #define N_Package_Specification 187
      #define N_Parameter_Association 188
      #define N_Parameter_Specification 189
      ...
      #define N_Validate_Unchecked_Conversion 201
      #define N_Variant 202
      #define N_Variant_Part 203
      #define N_With_Clause 204
      #define N_Unused_At_End 205

      #define Number_Node_Kinds 206

...
private
   ...
   --  Lock is a record with an explicit field to record the Ceiling Priority
   --  and to save the caller's current priority before acquiring the lock.
   --  On an OS with no Priority_Ceiling support, we use the fields to
   --  inforce Priority Ceiling protocol.
   ...
   type Private_Data is record
      ...
      LWP         : aliased System.OS_Interface.lwpid_t;

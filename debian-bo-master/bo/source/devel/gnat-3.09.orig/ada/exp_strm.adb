...
package body Exp_Strm is
        ...
        Make_Object_Declaration (Loc,
          ...
          Object_Definition =>
            Make_Subtype_Indication (Loc,
              Subtype_Mark => New_Occurrence_Of (Stream_Base_Type (Typ), Loc),
              Constraint =>
   ...
   begin
      ...
      Build_Array_Read_Write_Procedure (Loc, Typ, Decl, Pnam, Name_Read);
   ...
   begin
      ...
      Build_Array_Read_Write_Procedure (Loc, Typ, Decl, Pnam, Name_Write);
   ...
   function Build_Elementary_Input_Call (N : Node_Id) return Node_Id is
      ...
      P_Size  : constant Uint       := Esize (P_Type);
   ...
   begin
      ...
      Rdef := Type_Definition (Declaration_Node (Underlying_Type (Typ)));
      Stms := Empty_List;

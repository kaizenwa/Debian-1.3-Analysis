...
package Exp_Ch9 is
   ...
   function Build_Protected_Subprogram_Call
     (N        : Node_Id;
      ...
      return Node_Id;
   --  This function returns a subprogram call node to the expansion
   --  of a protected subprogram, given a subprogram or entry call
   --  to the protected subprogram itself. Name is the subprogram,
   --  and Rec is the record corresponding to the protected object.
   --  External is False if the call is to another protected subprogram
   ...
   --  the call to Initialize_Protection

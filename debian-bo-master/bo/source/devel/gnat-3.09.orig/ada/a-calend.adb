...
package body Ada.Calendar is
   ...
   is
      ...
      --  to the localtime function. Note that we cannot assume that the
      --  localtime function expands to accept 64-bit input on a 64-bit
   ...
   begin
      ...
      --  break it down into seconds (to pass to the localtime function)

...
/*                              C Header File                               */
/*                                                                          */
/*                 Generated by xeinfo revision 1.23 using                  */
/*                         einfo.ads revision 1.485                         */
/*                         einfo.adb revision 1.495                         */
/*                                                                          */
...
/*--------------------------------------------------------------------------*/
   ...
   #define E_Allocator_Type                 27
   #define E_General_Access_Type            28
   #define E_Access_Subprogram_Type         29
   #define E_Access_Protected_Subprogram_Type 30
   #define E_Anonymous_Access_Type          31
   #define E_Array_Type                     32
   #define E_Array_Subtype                  33
   #define E_String_Type                    34
   #define E_String_Subtype                 35
   #define E_String_Literal_Subtype         36
   #define E_Enum_Table_Type                37
   ...
   INLINE E Extra_Formal_Accessibility         (E Id);
   INLINE E Extra_Formal_Constrained           (E Id);
   ...
   INLINE B Has_Delayed_Elaboration            (E Id);
   ...
   INLINE B Has_Interrupt_Handler              (E Id);
   ...
   INLINE B Has_Pending_Instantiations         (E Id);
   ...
   INLINE E Implementation_Type_Private        (E Id);
   ...
   INLINE B Is_Common_Object                   (E Id);
   ...
   #define Implementation_Type einfo__implementation_type
   E Implementation_Type                (E Id);
   ...
   #define Requires_Transient_Scope einfo__requires_transient_scope
   B Requires_Transient_Scope           (E Id);

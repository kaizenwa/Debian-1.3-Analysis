...
--    __TARGET            = i386-unknown-linux
--    __ARCH              = I386
--    __OS                = LINUX
--    __HAS_SIGCONTEXT    = 0
--    __HAS_UCONTEXT      = 0
--    __THREADS           = POSIX_THREADS
--    __THREAD_VARIANT    = MIT_THREADS
--    __HAS_TIMESPEC      = 1
--    __HAS_NANOSLEEP     = 0
...
package System.OS_Interface is
   ...
   SIGSYS     : constant := 0; --  bad argument to system call
   ...
   SIGIO      : constant := 29; --  I/O possible (Solaris SIGPOLL alias)
   ...
   --  MIT_THREADS does not have sched_yield;
   ...
   function pthread_getspecific (key : pthread_key_t) return int;

...
--  This is a MachTen (FSU threads) version of this package.
...
begin
   ...
   Clock_Delay_Correction := 0.0;
   --  lets try not using 0.01667 and see if its requred ???
   --  mac has resolution of 1/60th of a second

...
package Stand is
   ...
   Any_Id : Entity_Id;
   --  Used to represent some unknown identifier. Used to labale undefined
   ...
   --  enumeration types. Note that Interfaces uses this same set of types
   --  by use of the 'Integer attribute.

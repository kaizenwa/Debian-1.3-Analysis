...
package Sem is
   ...
   --  This flag is set if we are processing a generic specification or
   --  generic definition. When this flag is True the Expander_Active flag
   --  is False to disable any code expansion (see package Expander).
   --  You should really regard this as a read only flag.

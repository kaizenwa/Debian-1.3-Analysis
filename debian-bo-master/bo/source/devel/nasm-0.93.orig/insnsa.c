...
static struct itemplate instrux_AAD[] = {
    ...
    {I_AAD, 1, {IMMEDIATE,0,0}, "\1\xD5\24", IF_8086|IF_UNDOC},
    {-1}
};

static struct itemplate instrux_AAM[] = {
    {I_AAM, 0, {0,0,0}, "\2\xD4\x0A", IF_8086},
    {I_AAM, 1, {IMMEDIATE,0,0}, "\1\xD4\24", IF_8086|IF_UNDOC},
    {-1}
};
...
static struct itemplate instrux_CALL[] = {
    ...
    {I_CALL, 1, {IMMEDIATE|FAR,0,0}, "\322\1\x9A\34\37", IF_8086|IF_ND},
...
static struct itemplate instrux_CMPXCHG[] = {
    {I_CMPXCHG, 2, {MEMORY,REG8,0}, "\300\2\x0F\xA6\101", IF_486|IF_SM},
    {I_CMPXCHG, 2, {REG8,REG8,0}, "\300\2\x0F\xA6\101", IF_486},
    {I_CMPXCHG, 2, {MEMORY,REG16,0}, "\320\300\2\x0F\xA7\101", IF_486|IF_SM},
    {I_CMPXCHG, 2, {REG16,REG16,0}, "\320\300\2\x0F\xA7\101", IF_486},
    {I_CMPXCHG, 2, {MEMORY,REG32,0}, "\321\300\2\x0F\xA7\101", IF_486|IF_SM},
    {I_CMPXCHG, 2, {REG32,REG32,0}, "\321\300\2\x0F\xA7\101", IF_486},
    {-1}
};
...
static struct itemplate instrux_FCLEX[] = {
    {I_FCLEX, 0, {0,0,0}, "\2\xDB\xE2", IF_8086|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FDISI[] = {
    {I_FDISI, 0, {0,0,0}, "\2\xDB\xE1", IF_8086|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FDIV[] = {
    ...
    {I_FDIV, 1, {FPUREG|TO,0,0}, "\1\xDC\10\xF0", IF_8086|IF_FPU},
    {I_FDIV, 2, {FPUREG,FPU0,0}, "\1\xDC\10\xF0", IF_8086|IF_FPU},
...
static struct itemplate instrux_FDIVR[] = {
    ...
    {I_FDIVR, 1, {FPUREG|TO,0,0}, "\1\xDC\10\xF8", IF_8086|IF_FPU},
    {I_FDIVR, 2, {FPUREG,FPU0,0}, "\1\xDC\10\xF8", IF_8086|IF_FPU},
...
static struct itemplate instrux_FENI[] = {
    {I_FENI, 0, {0,0,0}, "\2\xDB\xE0", IF_8086|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FINIT[] = {
    {I_FINIT, 0, {0,0,0}, "\2\xDB\xE3", IF_8086|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FLDCW[] = {
    {I_FLDCW, 1, {MEMORY,0,0}, "\300\1\xD9\205", IF_8086|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FSAVE[] = {
    {I_FSAVE, 1, {MEMORY,0,0}, "\300\1\xDD\206", IF_8086|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FSTCW[] = {
    {I_FSTCW, 1, {MEMORY,0,0}, "\300\1\xD9\207", IF_8086|IF_FPU},
    {-1}
};

static struct itemplate instrux_FSTENV[] = {
    {I_FSTENV, 1, {MEMORY,0,0}, "\300\1\xD9\206", IF_8086|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FSTSW[] = {
    {I_FSTSW, 1, {MEMORY,0,0}, "\300\1\xDD\207", IF_8086|IF_FPU},
    {I_FSTSW, 1, {REG_AX,0,0}, "\2\xDF\xE0", IF_286|IF_FPU},
    {-1}
};
...
static struct itemplate instrux_FSUB[] = {
    ...
    {I_FSUB, 1, {FPUREG|TO,0,0}, "\1\xDC\10\xE0", IF_8086|IF_FPU},
    {I_FSUB, 2, {FPUREG,FPU0,0}, "\1\xDC\10\xE0", IF_8086|IF_FPU},
...
static struct itemplate instrux_FSUBR[] = {
    ...
    {I_FSUBR, 1, {FPUREG|TO,0,0}, "\1\xDC\10\xE8", IF_8086|IF_FPU},
    {I_FSUBR, 2, {FPUREG,FPU0,0}, "\1\xDC\10\xE8", IF_8086|IF_FPU},
...
static struct itemplate instrux_ICEBP[] = {
    {I_ICEBP, 0, {0,0,0}, "\1\xF1", IF_286|IF_UNDOC},
    {-1}
};
...
static struct itemplate instrux_IMUL[] = {
    ...
    {I_IMUL, 3, {REG16,REG16,IMMEDIATE}, "\320\301\1\x69\110\32", IF_286},
...
static struct itemplate instrux_INT01[] = {
    {I_INT01, 0, {0,0,0}, "\1\xF1", IF_286|IF_UNDOC},
    {-1}
};

static struct itemplate instrux_INT1[] = {
    {I_INT1, 0, {0,0,0}, "\1\xF1", IF_286|IF_UNDOC},
    {-1}
};
...
static struct itemplate instrux_JMP[] = {
    ...
    {I_JMP, 1, {IMMEDIATE|FAR,0,0}, "\322\1\xEA\34\37", IF_8086|IF_ND},
...
static struct itemplate instrux_MOV[] = {
    {I_MOV, 2, {MEMORY,REG_CS,0}, "\300\1\x8C\101", IF_8086|IF_SM},
    {I_MOV, 2, {MEMORY,REG_DESS,0}, "\300\1\x8C\101", IF_8086|IF_SM},
    {I_MOV, 2, {MEMORY,REG_FSGS,0}, "\300\1\x8C\101", IF_386|IF_SM},
    {I_MOV, 2, {REG16,REG_CS,0}, "\300\1\x8C\101", IF_8086},
    {I_MOV, 2, {REG16,REG_DESS,0}, "\300\1\x8C\101", IF_8086},
    {I_MOV, 2, {REG16,REG_FSGS,0}, "\300\1\x8C\101", IF_386},
    {I_MOV, 2, {REG_DESS,MEMORY,0}, "\301\1\x8E\110", IF_8086|IF_SM},
    {I_MOV, 2, {REG_DESS,REG16,0}, "\301\1\x8E\110", IF_8086},
    {I_MOV, 2, {REG_FSGS,MEMORY,0}, "\301\1\x8E\110", IF_386|IF_SM},
    {I_MOV, 2, {REG_FSGS,REG16,0}, "\301\1\x8E\110", IF_386},
...
static struct itemplate instrux_POP[] = {
    {I_POP, 1, {MEMORY|BITS16,0,0}, "\320\300\1\x8F\200", IF_8086},
    {I_POP, 1, {MEMORY|BITS32,0,0}, "\321\300\1\x8F\200", IF_386},
...
static struct itemplate instrux_PUSH[] = {
    {I_PUSH, 1, {MEMORY|BITS16,0,0}, "\320\300\1\xFF\206", IF_8086},
    {I_PUSH, 1, {MEMORY|BITS32,0,0}, "\321\300\1\xFF\206", IF_386},
...
static struct itemplate instrux_SAL[] = {
    {I_SAL, 2, {REGMEM|BITS8,UNITY,0}, "\300\1\xD0\204", IF_8086|IF_ND},
    {I_SAL, 2, {REGMEM|BITS8,REG_CL,0}, "\300\1\xD2\204", IF_8086|IF_ND},
    {I_SAL, 2, {REGMEM|BITS8,IMMEDIATE,0}, "\300\1\xC0\204\25", IF_286|IF_ND},
    {I_SAL, 2, {REGMEM|BITS16,UNITY,0}, "\320\300\1\xD1\204", IF_8086|IF_ND},
    {I_SAL, 2, {REGMEM|BITS16,REG_CL,0}, "\320\300\1\xD3\204", IF_8086|IF_ND},
    {I_SAL, 2, {REGMEM|BITS16,IMMEDIATE,0}, "\320\300\1\xC1\204\25", IF_286|IF_ND},
    {I_SAL, 2, {REGMEM|BITS32,UNITY,0}, "\321\300\1\xD1\204", IF_386|IF_ND},
    {I_SAL, 2, {REGMEM|BITS32,REG_CL,0}, "\321\300\1\xD3\204", IF_386|IF_ND},
    {I_SAL, 2, {REGMEM|BITS32,IMMEDIATE,0}, "\321\300\1\xC1\204\25", IF_386|IF_ND},
    {-1}
};
...
static struct itemplate instrux_TEST[] = {
    ...
    {I_TEST, 2, {MEMORY,IMMEDIATE|BITS32,0}, "\321\300\1\xF7\200\41", IF_386|IF_UNDOC|IF_SM},
    {-1}
};
...
static struct itemplate instrux_CMOVcc[] = {
    ...
    {I_CMOVcc, 2, {REG32,MEMORY,0}, "\320\301\1\x0F\330\x40\110", IF_P6|IF_SM},
    {I_CMOVcc, 2, {REG32,REG32,0}, "\320\301\1\x0F\330\x40\110", IF_P6},
    {-1}
};

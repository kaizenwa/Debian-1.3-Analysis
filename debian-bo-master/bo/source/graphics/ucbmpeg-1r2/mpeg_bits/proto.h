...
/* util.c */
void VideoSleep P((unsigned int microsec ));
...
/* rgbl.c */
void InitRGBLColor P((void ));
void InitRGBLDither P((void ));
void RGBLDitherImage P((unsigned char *lum , unsigned char *cr , unsigned char *cb , unsigned char *out , int h , int w ));

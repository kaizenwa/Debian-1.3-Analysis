...
static void png_pov_err PARAMS((png_struct *png_ptr, char *msg));
static void png_pov_warn PARAMS((png_struct *png_ptr, char *msg));

/* This is an internal function for libpng */
extern void png_write_finish_row PARAMS((png_struct *png_ptr));

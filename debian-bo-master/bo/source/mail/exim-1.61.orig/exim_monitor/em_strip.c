...
static char  **stripchart_name;              /* vector of name strings */
...
{
stripchart_delay =      (int *)malloc(stripchart_number * sizeof(int));
stripchart_label =   (Widget *)malloc(stripchart_number * sizeof(Widget));
stripchart_last_total = (int *)malloc(stripchart_number * sizeof(int));
stripchart_max =        (int *)malloc(stripchart_number * sizeof(int));
stripchart_middelay =   (int *)malloc(stripchart_number * sizeof(int));
stripchart_midmax =     (int *)malloc(stripchart_number * sizeof(int));
stripchart_name =     (char **)malloc(stripchart_number * sizeof(char *));
stripchart_total =      (int *)malloc(stripchart_number * sizeof(int));
}
...
and struct name statfs is used; that is handled by a macro. */
  ...
  if (statvfs(size_stripchart, &statbuf) == 0)
    {
...
while (thresholds[i] > 0)
  ...
  if (newvalue < (double)thresh)
    ...
    if (stripchart_max[num] < thresh ||
      ...
      if (newmax == 10) sprintf(buffer, "%s", stripchart_name[num]);
        else sprintf(buffer, "%s x%d", stripchart_name[num], newmax/10);
...
void create_stripchart(Widget parent, char *title)
{
Widget chart;

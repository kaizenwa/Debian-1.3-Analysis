...
## [ -z "$GNATS_ROOT" ] && 
## GNATS_ROOT=/gnu/lib/gnats/gnats-db

# The default mail address for PR submissions. 
GNATS_ADDR=smail-bugs@planix.com
...
# host-dependent.
if [ -f X_SMAIL_NAME_X ]; then
  MAIL_AGENT="X_SMAIL_NAME_X -oi -t"
...
CATEGORIES="query-smail smail smail-bugs smail-contrib smail-docs smail-enhance smail-ports smail-security smail-unknown"

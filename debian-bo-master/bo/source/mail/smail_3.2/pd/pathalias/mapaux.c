/* Smail SCCS ID: @(#) mapaux.c,v 1.8 1994/10/18 13:28:12 nm4 Exp */
/* pathalias -- by steve bellovin, as told to peter honeyman */
#ifndef lint
static char	*sccsid = "@(#) mapaux.c,v 1.8 1994/10/18 13:28:12 nm4 Exp";
#endif /* lint */
...
#if 0
		/*
		 * this was added from an unofficial pathalias patch,
		 * but it apparently causes some problems with some
		 * existing map entries
		 *   - problem reported by chip@tct.com
		 */
		 || (l->l_flag & LTERMINAL) != 0
#endif

/* Smail SCCS ID: @(#) makedb.c,v 1.7 1996/02/16 22:53:12 woods Exp */
/* pathalias -- by steve bellovin, as told to peter honeyman */
#ifndef lint
static char	*sccsid = "@(#) makedb.c,v 1.7 1996/02/16 22:53:12 woods Exp";
#endif /* lint */
...
{	char *ofptr;
	...
	if ((ofptr = rindex(Ofile, '/')) != 0)
		...
		ofptr = Ofile;
#if defined(SMAIL_3) && defined(ANSI_C) && !defined(NO_SIZE_T_STRLEN)

/* Smail SCCS ID: @(#) arpatxt.c,v 1.5 1994/12/19 16:29:36 nm4 Exp */
#ifndef lint
static char *sccsid = "@(#) arpatxt.c,v 1.5 1994/12/19 16:29:36 nm4 Exp";
#endif
...
{	static first;
	...
	while (fgets(buf0, sizeof(buf0), stdin)) != 0) {
		if (re_exec(buf0) == 0)
			continue;

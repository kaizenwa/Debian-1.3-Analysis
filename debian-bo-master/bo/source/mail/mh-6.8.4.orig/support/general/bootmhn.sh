...
echo "mhn-show-application/pgp: %ppgpshow -show '%F' %a" >> $TMP
echo "mhn-store-application/pgp: | pgpshow -store %m%P.pgp %a" >> $TMP
echo "mhn-show-text/pgp: %ppgpshow -show '%F' %a" >> $TMP
echo "mhn-store-text/pgp: | pgpshow -store %m%P.txt %a" >> $TMP

...
wired { color.text=yellow }
wired { color.background=red }
"))
       ((string= "license" node)
...
<html>
  ...
  <body>
	...
	href=\"ftp://cs.uiuc.edu/pub/xemacs/\">
	ftp://cs.uiuc.edu/pub/xemacs/</a>, or check out the <a
	href=\"http://xemacs.cs.uiuc.edu/\">XEmacs web page</a>.
      <dt> Emacs 19
	...
	disappear.
      <dt> XEmacs for Windows
      <dd> A port of XEmacs 19.6 to Windows 3.1.  Shareware/Nagware
	application, but is well worth the money.  Distribution is at
	<a href=\"ftp://ftp.netcom.com/pub/pe/pearl/\">
	  ftp://ftp.netcom.com/pub/pe/pearl/</a>.
      <dt> AmigaDOS
...
<html>
 ...
 <body>
  ...
  <dl>
   ...
   <dd>
    <dl>
     <dt> Chuck Thompson &lt;cthomp@cs.uiuc.edu&gt;

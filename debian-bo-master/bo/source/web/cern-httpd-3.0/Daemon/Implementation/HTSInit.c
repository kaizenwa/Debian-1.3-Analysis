...
PUBLIC void HTFileInit NOARGS
{
    ...
    */
...
#endif
    HTAddType(".zip",	 "multipart/x-zip",		"binary", 1.0);	/* PKZIP		*/
    HTAddType(".tar",    "multipart/x-tar",		"binary", 1.0);	/* 4.3BSD tar		*/
    HTAddType(".ustar",  "multipart/x-ustar",		"binary", 1.0);	/* POSIX tar		*/
    ...
    HTAddEncoding(".Z",		"x-compress",	1.0);	/* Compressed data	*/

...
#define	EGRATUITOUS     _HURD_ERRNO (105)/* Gratuitous error */
	ERESTART        = _HURD_ERRNO (0),
#define	ERESTART        _HURD_ERRNO (0) /* Interrupted system call should be restarted */
	ENOMSG          = _HURD_ERRNO (0),
#define	ENOMSG          _HURD_ERRNO (0) /* No message of desired type */
	EIDRM           = _HURD_ERRNO (0),
#define	EIDRM           _HURD_ERRNO (0) /* Identifier removed */
	ECHRNG          = _HURD_ERRNO (0),
#define	ECHRNG          _HURD_ERRNO (0) /* Channel number out of range */
	EL2NSYNC        = _HURD_ERRNO (0),
#define	EL2NSYNC        _HURD_ERRNO (0) /* Level 2 not synchronized */
	EL3HLT          = _HURD_ERRNO (0),
#define	EL3HLT          _HURD_ERRNO (0) /* Level 3 halted */
	EL3RST          = _HURD_ERRNO (0),
#define	EL3RST          _HURD_ERRNO (0) /* Level 3 reset */
	ELNRNG          = _HURD_ERRNO (0),
#define	ELNRNG          _HURD_ERRNO (0) /* Link number out of range */
	EUNATCH         = _HURD_ERRNO (0),
#define	EUNATCH         _HURD_ERRNO (0) /* Protocol driver not attached */
	ENOCSI          = _HURD_ERRNO (0),
#define	ENOCSI          _HURD_ERRNO (0) /* No CSI structure available */
	EL2HLT          = _HURD_ERRNO (0),
#define	EL2HLT          _HURD_ERRNO (0) /* Level 2 halted */
	EBADE           = _HURD_ERRNO (0),
#define	EBADE           _HURD_ERRNO (0) /* Invalid exchange */
	EBADR           = _HURD_ERRNO (0),
#define	EBADR           _HURD_ERRNO (0) /* Invalid request descriptor */
	EXFULL          = _HURD_ERRNO (0),
#define	EXFULL          _HURD_ERRNO (0) /* Exchange full */
	ENOANO          = _HURD_ERRNO (0),
#define	ENOANO          _HURD_ERRNO (0) /* No anode */
	EBADRQC         = _HURD_ERRNO (0),
#define	EBADRQC         _HURD_ERRNO (0) /* Invalid request code */
	EBADSLT         = _HURD_ERRNO (0),
#define	EBADSLT         _HURD_ERRNO (0) /* Invalid slot */
	EDEADLOCK       = _HURD_ERRNO (0),
#define	EDEADLOCK       _HURD_ERRNO (0) /* File locking deadlock error */
	EBFONT          = _HURD_ERRNO (0),
#define	EBFONT          _HURD_ERRNO (0) /* Bad font file format */
	ENOSTR          = _HURD_ERRNO (0),
#define	ENOSTR          _HURD_ERRNO (0) /* Device not a stream */
	ENODATA         = _HURD_ERRNO (0),
#define	ENODATA         _HURD_ERRNO (0) /* No data available */
	ETIME           = _HURD_ERRNO (0),
#define	ETIME           _HURD_ERRNO (0) /* Timer expired */
	ENOSR           = _HURD_ERRNO (0),
#define	ENOSR           _HURD_ERRNO (0) /* Out of streams resources */
	ENONET          = _HURD_ERRNO (0),
#define	ENONET          _HURD_ERRNO (0) /* Machine is not on the network */
	ENOPKG          = _HURD_ERRNO (0),
#define	ENOPKG          _HURD_ERRNO (0) /* Package not installed */
	ENOLINK         = _HURD_ERRNO (0),
#define	ENOLINK         _HURD_ERRNO (0) /* Link has been severed */
	EADV            = _HURD_ERRNO (0),
#define	EADV            _HURD_ERRNO (0) /* Advertise error */
	ESRMNT          = _HURD_ERRNO (0),
#define	ESRMNT          _HURD_ERRNO (0) /* Srmount error */
	ECOMM           = _HURD_ERRNO (0),
#define	ECOMM           _HURD_ERRNO (0) /* Communication error on send */
	EPROTO          = _HURD_ERRNO (0),
#define	EPROTO          _HURD_ERRNO (0) /* Protocol error */
	EMULTIHOP       = _HURD_ERRNO (0),
#define	EMULTIHOP       _HURD_ERRNO (0) /* Multihop attempted */
	EDOTDOT         = _HURD_ERRNO (0),
#define	EDOTDOT         _HURD_ERRNO (0) /* RFS specific error */
	EBADMSG         = _HURD_ERRNO (0),
#define	EBADMSG         _HURD_ERRNO (0) /* Not a data message */
	EOVERFLOW       = _HURD_ERRNO (0),
#define	EOVERFLOW       _HURD_ERRNO (0) /* Value too large for defined data type */
	ENOTUNIQ        = _HURD_ERRNO (0),
#define	ENOTUNIQ        _HURD_ERRNO (0) /* Name not unique on network */
	EBADFD          = _HURD_ERRNO (0),
#define	EBADFD          _HURD_ERRNO (0) /* File descriptor in bad state */
	EREMCHG         = _HURD_ERRNO (0),
#define	EREMCHG         _HURD_ERRNO (0) /* Remote address changed */
	ELIBACC         = _HURD_ERRNO (0),
#define	ELIBACC         _HURD_ERRNO (0) /* Can not access a needed shared library */
	ELIBBAD         = _HURD_ERRNO (0),
#define	ELIBBAD         _HURD_ERRNO (0) /* Accessing a corrupted shared library */
	ELIBSCN         = _HURD_ERRNO (0),
#define	ELIBSCN         _HURD_ERRNO (0) /* .lib section in a.out corrupted */
	ELIBMAX         = _HURD_ERRNO (0),
#define	ELIBMAX         _HURD_ERRNO (0) /* Attempting to link in too many shared libraries */
	ELIBEXEC        = _HURD_ERRNO (0),
#define	ELIBEXEC        _HURD_ERRNO (0) /* Cannot exec a shared library directly */
	ESTRPIPE        = _HURD_ERRNO (0),
#define	ESTRPIPE        _HURD_ERRNO (0) /* Streams pipe error */
	EUCLEAN         = _HURD_ERRNO (0),
#define	EUCLEAN         _HURD_ERRNO (0) /* Structure needs cleaning */
	ENOTNAM         = _HURD_ERRNO (0),
#define	ENOTNAM         _HURD_ERRNO (0) /* Not a XENIX named type file */
	ENAVAIL         = _HURD_ERRNO (0),
#define	ENAVAIL         _HURD_ERRNO (0) /* No XENIX semaphores available */
	EISNAM          = _HURD_ERRNO (0),
#define	EISNAM          _HURD_ERRNO (0) /* Is a named type file */
	EREMOTEIO       = _HURD_ERRNO (0),
#define	EREMOTEIO       _HURD_ERRNO (0) /* Remote I/O error */

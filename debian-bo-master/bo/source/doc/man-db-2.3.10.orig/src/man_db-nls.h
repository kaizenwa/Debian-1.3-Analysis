...
#define manp_NULL_MANPATH	0x4
#define manp_MANPATH	0x5
#define manp_NO_PATH	0x6
#define manp_MT_PATH	0x7
#define manp_OPEN_CONF	0x8
#define manp_PARSE_DIRS	0x9
#define manp_MISS_DIR	0xa
#define manp_CWD	0xb
#define manp_NO_TREE	0xc
#define manp_PREFIX	0xd
...
#define stray_NO_WHATIS	0x3
#define stray_CHECK	0x4
#define stray_UPDATE_DB	0x5

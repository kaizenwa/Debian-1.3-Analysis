 ...
 *
 *  RCS: $Id: move.h,v 143.1 1996/09/16 09:08:47 nau Exp $
 */
...
#define	MOVE_TYPES	\
	...
	POLYGON_TYPE | POLYGONPOINT_TYPE | LINEPOINT_TYPE)
#define	MOVETOLAYER_TYPES	\
	(LINE_TYPE | TEXT_TYPE | POLYGON_TYPE)
...
void	*MoveObjectToLayer(int, void *, void *, void *, LayerTypePtr);

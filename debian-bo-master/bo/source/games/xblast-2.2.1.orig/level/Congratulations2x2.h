/* XBlast 2.1.8 level */
static BMLevelData Congratulations2x2 =
{
  /* BMLevel */
  {
    "CONGRATULATIONS",
    ...
    GM_4_Player | GM_NoGrid | GM_Team,
    (void *) &Congratulations2x2,
    NULL,
  },
  /* BMShrinkData */
  {
  ...
  /* BMPlayerData */
  {
    0, 0,
    {
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*6 },
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*8 },

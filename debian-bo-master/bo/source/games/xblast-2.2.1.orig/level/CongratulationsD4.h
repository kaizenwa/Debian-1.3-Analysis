/* XBlast 2.1.8 level */
static BMLevelData CongratulationsD4 =
{
  /* BMLevel */
  {
    "CONGRATULATIONS",
    ...
    GM_4_Player | GM_NoGrid | GM_Double,
    (void *) &CongratulationsD4,
    NULL,
  },
  /* BMShrinkData */
  {
  ...
  /* BMPlayerData */
  {
    0, 0,
    {
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*2 },
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*7 },
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*12 },

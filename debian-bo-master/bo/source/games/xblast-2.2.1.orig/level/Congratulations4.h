/* XBlast 2.1.8 level */
static BMLevelData Congratulations4 =
{
  /* BMLevel */
  {
    "CONGRATULATIONS",
    ...
    GM_4_Player | GM_NoGrid | GM_Single,
    (void *) &Congratulations4,
    NULL,
  },
  /* BMShrinkData */
  {
  ...
  /* BMPlayerData */
  {
    0, 0,
    {
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*3 },
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*7 },
      { BLOCK_HEIGHT*19/2, BLOCK_WIDTH*11 },

(game-module "cherbourg"
  ...
  (instructions (
   "As the Allies (actually just the US), you have just cut off the Cotentin peninsula. "
   "Your goal is now to capture Cherbourg as soon as possible; in 7 days the Germans "
   "will have rendered the port unusable."
   ""
   "As the Germans, your goal is to hold back the Americans during that time; "
...
(inf-mot 53 10 1)
(inf-mot 54 10 1)
(cav-mech 55 11 1 (n "24"))
(cav-mech 41 10 1 (n "4"))
(cav-mech-trp 25 18 1)
(cav-mech-trp 38 13 1)
(cav-mech-trp 44 10 1)
(arty-hq 49 9 1)
(arty-hq 51 9 1)
(arty-hq 48 8 1)
(arty-hq 52 8 1)
(arty-towed 51 8 1 (n "20"))
(arty-towed 51 8 1 (n "29"))
(arty-towed 51 8 1 (n "42"))
(arty-towed 51 8 1 (n "44"))
(arty-towed 28 15 1)
(arty-towed 28 15 1)
(arty-towed 28 15 1)
(arty-towed 28 15 1)
...
(arty-towed 42 9 1)
(arty-towed 42 9 1)
(arty-at 37 14 1 (n "801"))
(arty-at 44 9 1 (n "812"))
(arty-mortar4.2 52 9 1)
(arty-sp-at 45 9 1 (n "899"))
(tank 29 16 1 (n "70"))
(tank 41 11 1 (n "746"))
(tank 50 9 1 (n "749"))
(hq-mot-div 29 15 1)
...
(inf 51 11 2)
(inf-bicycle 46 11 2)
(inf-ost 53 11 2 (n "561"))
(inf-ost 52 11 2 (n "649"))
(inf-ost 50 11 2 (n "795"))
(inf-ost 49 11 2 (n "797") (in 46))
...
(arty-rr 33 23 2)
(arty-horse 35 16 2 (n "458th"))
(arty-horse 45 17 2 (n "467th"))
...
(hq-inf-div 32 16 2)
(hq-inf-div 36 16 2)
(hq-inf-div 44 16 2 (in 74))
(hq-inf-corps 35 31 2 (n "LXXXIV") (in 26))

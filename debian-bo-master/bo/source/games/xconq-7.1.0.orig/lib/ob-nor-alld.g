...
(hq-para-div (nb 108200000))
(inf-para (nb 108203251))
(inf-para (nb 108203252))
(inf-para (nb 108203253))
(inf-para (nb 108205041))
(inf-para (nb 108205042))
(inf-para (nb 108205043))
(inf-para (nb 108205051))
(inf-para (nb 108205052))
(inf-para (nb 108205053))
;; 507th and 508th were attached for the D-Day drop.
(inf-para (nb 108205071))
(inf-para (nb 108205072))
(inf-para (nb 108205073))
(inf-para (nb 108205081))
(inf-para (nb 108205082))
(inf-para (nb 108205083))
...
(hq-para-div (nb 110100000))
(inf-para (nb 110103271))
(inf-para (nb 110103272))
(inf-para (nb 110103273))
(inf-para (nb 110104011))
(inf-para (nb 110104012))
(inf-para (nb 110104013))
(inf-para (nb 110105011))
(inf-para (nb 110105012))
(inf-para (nb 110105013))
(inf-para (nb 110105021))
(inf-para (nb 110105022))
(inf-para (nb 110105023))
(inf-para (nb 110105061))
(inf-para (nb 110105062))
(inf-para (nb 110105063))

...
$ score = "SCOREFILE=" + QUOTE + "[]mlink.scores" + QUOTE
$ data = "DATAFILE=" + QUOTE + "[]mlink.data" + QUOTE
$ defscore==''score'
$ defdata==''data'
$!
...
$ endif
$!
$ write sys$output "Compiling XMlink with ''defs'"
$ call make Mlink.obj   "cc Mlink.c"   Mlink.c MlinkP.h Mlink.h
$ call make MlinkU.obj  "cc MlinkU.c"  MlinkU.c MlinkP.h Mlink.h
$ call make rngs.obj    "cc rngs.c"    rngs.c
$ call make xmlink.obj  "cc xmlink.c"  xmlink.c Mlink.h
$!
$! Get libraries
$ if sys_maj .lt. 7
$ then
...
$!
$! LINK
$ write sys$output "Linking XMlink"
$ link/map xmlink/opt
$!
$! Create .opt file
$ open/write optf xmmlink.opt
$ write sys$output "Compiling XmMlink with ''defs'"
$ call make Mlink.obj   "cc Mlink.c"   Mlink.c MlinkP.h Mlink.h
$ call make MlinkU.obj  "cc MlinkU.c"  MlinkU.c MlinkP.h Mlink.h
$ call make rngs.obj    "cc rngs.c"    rngs.c
$ call make xmmlink.obj "cc xmmlink.c" xmmlink.c Mlink.h
$! Get libraries
$! if .not. axp then write optf "sys$library:vaxcrtl/lib"
$ write optf "sys$library:vaxcrtl/lib"
$ if axp then write optf "sys$library:ucx$ipc_shr/share"
...
$!
$! LINK
$ write sys$output "Linking XmMlink"
$ link/map xmmlink/opt
$!
$ set noverify
$ exit
$!
...
$!                and listings
$ delete/noconfirm/log xmlink.exe;*
$ delete/noconfirm/log xmmlink.exe;*
$!

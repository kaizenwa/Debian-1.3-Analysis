...
$ score = "SCOREFILE=" + QUOTE + "[]skewb.scores" + QUOTE
$ data = "DATAFILE=" + QUOTE + "[]skewb.data" + QUOTE
$ defscore==''score'
$ defdata==''data'
$!
...
$ call make Skewb2d.obj "cc Skewb2d.c" Skewb2d.c SkewbP.h Skewb.h SkewbP2d.h Skewb2d.h
$ call make Skewb3d.obj "cc Skewb3d.c" Skewb3d.c SkewbP.h Skewb.h SkewbP3d.h Skewb3d.h
...
$!
$! Create .opt file
$ open/write optf xmskewb.opt
$ write sys$output "Compiling XmSkewb with ''defs'"
$ call make Skewb.obj   "cc Skewb.c"   Skewb.c SkewbP.h Skewb.h
$ call make Skewb2d.obj "cc Skewb2d.c" Skewb2d.c SkewbP.h Skewb.h SkewbP2d.h Skewb2d.h
$ call make Skewb3d.obj "cc Skewb3d.c" Skewb3d.c SkewbP.h Skewb.h SkewbP3d.h Skewb3d.h
$ call make SkewbU.obj  "cc SkewbU.c"  SkewbU.c SkewbP.h Skewb.h
$ call make rngs.obj    "cc rngs.c"    rngs.c
$ call make xmskewb.obj "cc xmskewb.c" xmskewb.c Skewb.h
$! Get libraries
$! if .not. axp then write optf "sys$library:vaxcrtl/lib"
$ write optf "sys$library:vaxcrtl/lib"
$ if axp then write optf "sys$library:ucx$ipc_shr/share"
...
$!
$! LINK
$ write sys$output "Linking XmSkewb"
$ link/map xmskewb/opt
$!
$ set noverify
$ exit
$!
...
$ delete/noconfirm/log xmskewb.exe;*
$!

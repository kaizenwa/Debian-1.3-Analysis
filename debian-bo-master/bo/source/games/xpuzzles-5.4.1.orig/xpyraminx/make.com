...
$! set ver 
$!
$!      Compile and link for xpyraminx
$!
$! USAGE:
...
$ score = "SCOREFILE=" + QUOTE + "[]pyraminx.scores" + QUOTE
$ data = "DATAFILE=" + QUOTE + "[]pyraminx.data" + QUOTE
$ defscore==''score'
$ defdata==''data'
$!
...
$ endif
$!
$ write sys$output "Compiling XPyraminx with ''defs'"
$ call make Pyraminx.obj   "cc Pyraminx.c"   Pyraminx.c PyraminxP.h Pyraminx.h
$ call make PyraminxU.obj  "cc PyraminxU.c"  PyraminxU.c PyraminxP.h Pyraminx.h
$ call make rngs.obj    "cc rngs.c"    rngs.c
$ call make xpyraminx.obj  "cc xpyraminx.c"  xpyraminx.c Pyraminx.h
$!
$! Get libraries
$ if sys_maj .lt. 7
$ then
...
$!
$! LINK
$ write sys$output "Linking XPyraminx"
$ link/map xpyraminx/opt
$!
$! Create .opt file
$ open/write optf xmpyraminx.opt
$ write sys$output "Compiling XmPyraminx with ''defs'"
$ call make Pyraminx.obj   "cc Pyraminx.c"   Pyraminx.c PyraminxP.h Pyraminx.h
$ call make PyraminxU.obj  "cc PyraminxU.c"  PyraminxU.c PyraminxP.h Pyraminx.h
$ call make rngs.obj    "cc rngs.c"    rngs.c
$ call make xmpyraminx.obj "cc xmpyraminx.c" xmpyraminx.c Pyraminx.h
$! Get libraries
$! if .not. axp then write optf "sys$library:vaxcrtl/lib"
$ write optf "sys$library:vaxcrtl/lib"
$ if axp then write optf "sys$library:ucx$ipc_shr/share"
...
$!
$! LINK
$ write sys$output "Linking XmPyraminx"
$ link/map xmpyraminx/opt
$!
$ set noverify
$ exit
$!
...
$!                and listings
$ delete/noconfirm/log xpyraminx.exe;*
$ delete/noconfirm/log xmpyraminx.exe;*
$!

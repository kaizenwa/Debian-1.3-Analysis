...
void
ScanMoves(FILE * fp, RubikWidget w, int moves)
{
...
void
ScanStartPosition(FILE * fp, RubikWidget w)
{
...
void
PrintStartPosition(FILE * fp, RubikWidget w)
{
	int         face, position;
...
void
SetStartPosition(RubikWidget w)
{
	int         face, position;

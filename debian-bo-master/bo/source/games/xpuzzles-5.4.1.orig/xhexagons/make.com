...
$! set ver 
$!
$!      Compile and link for xhexagons
$!
$! USAGE:
...
$ score = "SCOREFILE=" + QUOTE + "[]hexagons.scores" + QUOTE
$ data = "DATAFILE=" + QUOTE + "[]hexagons.data" + QUOTE
$ defscore==''score'
$ defdata==''data'
$!
...
$ endif
$!
$ write sys$output "Compiling XHexagons with ''defs'"
$ call make Hexagons.obj   "cc Hexagons.c"   Hexagons.c HexagonsP.h Hexagons.h
$ call make HexagonsU.obj  "cc HexagonsU.c"  HexagonsU.c HexagonsP.h Hexagons.h
$ call make rngs.obj       "cc rngs.c"       rngs.c
$ call make xhexagons.obj  "cc xhexagons.c"  xhexagons.c Hexagons.h
$!
$! Get libraries
$ if sys_maj .lt. 7
$ then
...
$!
$! LINK
$ write sys$output "Linking XHexagons"
$ link/map xhexagons/opt
$!
$! Create .opt file
$ open/write optf xmhexagons.opt
$ write sys$output "Compiling XmHexagons with ''defs'"
$ call make Hexagons.obj   "cc Hexagons.c"   Hexagons.c HexagonsP.h Hexagons.h
$ call make HexagonsU.obj  "cc HexagonsU.c"  HexagonsU.c HexagonsP.h Hexagons.h
$ call make rngs.obj       "cc rngs.c"       rngs.c
$ call make xmhexagons.obj "cc xmhexagons.c" xmhexagons.c Hexagons.h
$! Get libraries
$! if .not. axp then write optf "sys$library:vaxcrtl/lib"
$ write optf "sys$library:vaxcrtl/lib"
$ if axp then write optf "sys$library:ucx$ipc_shr/share"
...
$!
$! LINK
$ write sys$output "Linking XmHexagons"
$ link/map xmhexagons/opt
$!
$ set noverify
$ exit
$!
...
$!                and listings
$ delete/noconfirm/log xhexagons.exe;*
$ delete/noconfirm/log xmhexagons.exe;*
$!

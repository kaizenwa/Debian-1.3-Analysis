...
$ score = "SCOREFILE=" + QUOTE + "[]panex.scores" + QUOTE
$ data = "DATAFILE=" + QUOTE + "[]panex.data" + QUOTE
$ defscore==''score'
$ defdata==''data'
$!
...
$ endif
$!
$ write sys$output "Compiling XPanex with ''defs'"
$ call make Panex.obj   "cc Panex.c"   Panex.c PanexP.h Panex.h
$ call make PanexS.obj  "cc PanexS.c"  PanexS.c PanexP.h Panex.h
$ call make PanexU.obj  "cc PanexU.c"  PanexU.c PanexP.h Panex.h
$ call make xpanex.obj  "cc xpanex.c"  xpanex.c Panex.h
$!
$! Get libraries
$ if sys_maj .lt. 7
$ then
...
$!
$! LINK
$ write sys$output "Linking XPanex"
$ link/map xpanex/opt
$!
$! Create .opt file
$ open/write optf xmpanex.opt
$ write sys$output "Compiling XmPanex with ''defs'"
$ call make Panex.obj   "cc Panex.c"   Panex.c PanexP.h Panex.h
$ call make PanexS.obj  "cc PanexS.c"  PanexS.c PanexP.h Panex.h
$ call make PanexU.obj  "cc PanexU.c"  PanexU.c PanexP.h Panex.h
$ call make xmpanex.obj "cc xmpanex.c" xmpanex.c Panex.h
$! Get libraries
$! if .not. axp then write optf "sys$library:vaxcrtl/lib"
$ write optf "sys$library:vaxcrtl/lib"
$ if axp then write optf "sys$library:ucx$ipc_shr/share"
...
$!
$! LINK
$ write sys$output "Linking XmPanex"
$ link/map xmpanex/opt
$!
$ set noverify
$ exit
$!
...
$!                and listings
$ delete/noconfirm/log xpanex.exe;*
$ delete/noconfirm/log xmpanex.exe;*
$!

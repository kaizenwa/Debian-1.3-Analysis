 ...
 *
 * Version:	@(#)init.c  2.71  05-May-1997  MvS
 *
...
/* Version information */
char *Version = "@(#) init 2.71 05-May-1997 MvS";
char *bootmsg = "version 2.71 booting";
#define E_VERSION "INIT_VERSION=sysvinit-2.71"
...
#ifdef __alpha__
	/* Some (old) Linux/Alpha version have a buggy library */
	if (pid == -ECHILD) break;
#endif
...
int ask_runlevel()
{
  ...
  set_term(0);
  /*
   *	FIXME: should we open the tty O_NONBLOCK and CLOCAL mode?
   */
...
#if 0
     /*
      *	Sync'ing in the main loop is a bad idea they say,
...
int main(int argc, char *argv[])
{
  ...
  /* See if I want to become "parental guide of all processes" */
#ifndef TEST

...
# %s: Sie können den DNS Domainnamen nicht mit diesem Befehl ändern\n

$ #_nodns2 Original Message:(\nUnless you are using bind or NIS for host lookups you can change the DNS\n)
# \nWenn Sie nicht bind oder NIS benutzen, können Sie den DNS Domainnamen,\n
...
$ #_usage1 Original Message:(Usage: hostname [-v] {hostname|-F file} set host name (from file)\n)
# Benutzung: hostname [-v] {hostname|-F datei}  setzt Rechnernamen (aus Datei)\n

$ #_usage2 Original Message:(       domainname [-v] {nisdomain|-F file} set NIS domain name (from file)\n)
#        domainname [-v] {nisdomain|-F datei}   setzt NIS Domainnamen (aus Datei)\n

$ #_usage3 Original Message:(       hostname [-v] [-d|-f|-s|-a|-i|-y] display formated name\n)
#        hostname [-v] [-d|-f|-s|-a|-i|-y]      zeigt formatierte Namen an\n

$ #_usage4 Original Message:(       hostname [-v] display host name\n\n)
#        hostname [-v]                          zeigt Rechnernamen an\n\n
...
$ #_usage9 Original Message:(    -i, --ip-address      addresses for the host name\n)
...
$ #_usage12 Original Message:(    -y, --yp, --nis       NIS/YP domain name\n)
#     -y, --yp, --nis       NIS/YP Domainname\n

$ #_usage13 Original Message:(    -F, --file            read host name or NIS domain name from given File\n\n)
#     -F, --file            lese Rechnernamen oder NIS Domainnamen aus Datei\n\n

$ #_usage14 Original Message:(   This comand can get or set the host name or the NIS domain name. You can\n)
...
$ #_verb_set Original Message:(  Setting host name to `%s'\n)
...
$ #_verb_dset Original Message:(Setting domain name to `%s'\n)

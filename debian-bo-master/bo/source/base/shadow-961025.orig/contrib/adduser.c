...
#define USERADD_PATH	"/usr/local/sbin/useradd"
#define CHAGE_PATH	"/usr/local/bin/chage"
#define PASSWD_PATH	"/usr/bin/passwd"
#define EDQUOTA_PATH	"/usr/local/sbin/edquota"
#define QUOTA_DEFAULT	"defuser"
#define DEFAULT_GROUP	100

#define DEFAULT_MIN_PASS 1	/* Hey, I'm paranoid AND enjoy annoying 
				 * my users, ok? :) --chris */

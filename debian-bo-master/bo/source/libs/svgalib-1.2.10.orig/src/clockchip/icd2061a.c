...
static void I2061A_saveState(unsigned char *regs)
{
    ...
    if (I2061A_clockchip_methods.DAC_saveState)
	I2061A_clockchip_methods.DAC_saveState(regs);

    dvwp = (long *) (regs + I2061A_clockchip_methods.DAC_stateSize);
    *dvwp = I2061A_SelectClock(I2061A_clockchip_methods.TextFrequency);
}
...
static void I2061A_restoreState(const unsigned char *regs)
{
    ...
    if (I2061A_clockchip_methods.DAC_restoreState)
	I2061A_clockchip_methods.DAC_restoreState(regs);
    dvwp = (long *) (regs + I2061A_clockchip_methods.DAC_stateSize);
    if (*dvwp) {
	/*
...
static void I2061A_initializeState(unsigned char *regs, int bpp, int colormode, int pixelclock)
{
    ...
    if (I2061A_clockchip_methods.DAC_initializeState)
	I2061A_clockchip_methods.DAC_initializeState(regs, bpp, colormode, pixelclock);
...
{
    if (DAC && !I2061A_clockchip_methods.DAC_initializeState) {
	if (__svgalib_driver_report)
	    printf("svgalib: Using ICD2061A or compatible clockchip.\n");
	I2061A_clockchip_methods.DAC_initializeState = DAC->initializeState;
	I2061A_clockchip_methods.DAC_saveState = DAC->saveState;
	I2061A_clockchip_methods.DAC_restoreState = DAC->restoreState;
	I2061A_clockchip_methods.DAC_stateSize = DAC->stateSize;
...
ClockChipMethods I2061A_clockchip_methods =
{
    I2061A_init,
    I2061A_saveState,
    I2061A_restoreState,

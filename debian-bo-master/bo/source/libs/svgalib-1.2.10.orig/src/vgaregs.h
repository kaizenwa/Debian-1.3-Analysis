...
void outGR(int index, unsigned char value);
void outSR(int index, unsigned char value);
void outCR(int index, unsigned char value);

/* Write to indexed VGA register using outb. */
void outbGR(int index, unsigned char value);
void outbSR(int index, unsigned char value);
void outbCR(int index, unsigned char value);

...
void arkaccel_SetBGColor(int fg)
{
    SETBACKGROUNDCOLOR(fg);
}

void arkaccel_PutBitmap(int x, int y, int w, int h, void *bitmap)
{
    int destaddr, count;
#ifndef COORDINATES
    destaddr = BLTPIXADDRESS(x, y);
					     ...
					     int width_in_pixels)
{
    ...
    accelspecs->SetBGColor = arkaccel_SetBGColor;
    accelspecs->PutBitmap = arkaccel_PutBitmap;
}

...
void driver8_setpixel(int x, int y, int c)
{
#ifdef __alpha__
    vga_setcolor(c);
    vga_drawpixel(x, y);
...
void driver8p_setpixel(int x, int y, int c)
{
    int vp;
...
void driver8_hline(int x1, int y, int x2, int c)
{
    char *vp;
    ASSIGNVP8(x1, y, vp);
...
void driver8p_hline(int x1, int y, int x2, int c)
{
    int vp;
    char *rvp;
    int l;
...
void driver8_fillbox(int x, int y, int w, int h, int c)
{
    char *vp;
    int i;
    ASSIGNVP8(x, y, vp);
...
void driver8a_fillbox(int x, int y, int w, int h, int c)
{
    if (w * h < 128)
	if (MODETYPE == CONTEXT_LINEAR)
	    driver8_fillbox(x, y, w, h, c);
	else
...
void driver8p_fillbox(int x, int y, int w, int h, int c)
{
    int vp;
    int page;
    int i;
...
void driver8_putbox(int x, int y, int w, int h, void *b, int bw)
{
...
void driver8p_putbox(int x, int y, int w, int h, void *b, int bw)
{
...
void driver8_getbox(int x, int y, int w, int h, void *b, int bw)
{
    char *vp;			/* screen pointer */
    char *bp;			/* bitmap pointer */
    int i;
...
void driver8p_getbox(int x, int y, int w, int h, void *b, int bw)
{
    int vp;
    int page;
    char *bp = b;
...
void driver8_putboxmask(int x, int y, int w, int h, void *b)
{
    uchar *bp = b;
    uchar *vp;
    int i;
...
void driver8_putboxpart(int x, int y, int w, int h, int ow, int oh,
			void *b, int xo, int yo)
{
    driver8_putbox(x, y, w, h, b + yo * ow + xo, ow);	/* inlined */
}

void driver8p_putboxpart(int x, int y, int w, int h, int ow, int oh,
			 void *b, int xo, int yo)
{
    driver8p_putbox(x, y, w, h, b + yo * ow + xo, ow);	/* inlined */
}

void driver8_getboxpart(int x, int y, int w, int h, int ow, int oh,
			void *b, int xo, int yo)
{
    driver8_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

void driver8p_getboxpart(int x, int y, int w, int h, int ow, int oh,
			 void *b, int xo, int yo)
{
    driver8p_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

void driver8_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    char *svp, *dvp;
...
void driver8a_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
...
void driver16_setpixel(int x, int y, int c)
{
    char *vp;
    ASSIGNVP16(x, y, vp);
    *(unsigned short *) vp = c;
...
void driver16p_setpixel(int x, int y, int c)
{
    int vp;
...
void driver16_hline(int x1, int y, int x2, int c)
{
    char *vp;
    ASSIGNVP16(x1, y, vp);
...
void driver16p_hline(int x1, int y, int x2, int c)
{
    int vp;
    char *rvp;
    int l;
...
void driver16_fillbox(int x, int y, int w, int h, int c)
{
    char *vp;
    int i;
    ASSIGNVP16(x, y, vp);
...
void driver16p_fillbox(int x, int y, int w, int h, int c)
{
    int vp;
    int page;
    int i;
...
void driver16_putbox(int x, int y, int w, int h, void *b, int bw)
{
    char *vp;			/* screen pointer */
    char *bp;			/* bitmap pointer */
    int i;
...
void driver16p_putbox(int x, int y, int w, int h, void *b, int bw)
{
    driver8p_putbox(x * 2, y, w * 2, h, b, bw * 2);
}

void driver16_getbox(int x, int y, int w, int h, void *b, int bw)
{
    char *vp;			/* screen pointer */
    char *bp;			/* bitmap pointer */
    int i;
...
INLINE void driver16p_getbox(int x, int y, int w, int h, void *b, int bw)
{
    driver8p_getbox(x * 2, y, w * 2, h, b, bw * 2);
}

void driver16_putboxmask(int x, int y, int w, int h, void *b)
{
    uchar *bp = b;
    uchar *vp;
    int i;
...
INLINE void driver16_putboxpart(int x, int y, int w, int h, int ow, int oh,
				void *b, int xo, int yo)
{
...
INLINE void driver16p_putboxpart(int x, int y, int w, int h, int ow, int oh,
				 void *b, int xo, int yo)
{
    driver8p_putbox(x * 2, y, w * 2, h, b + yo * ow * 2 + xo * 2, ow * 2);
}

INLINE void driver16_getboxpart(int x, int y, int w, int h, int ow, int oh,
				void *b, int xo, int yo)
{
    driver16_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

INLINE void driver16p_getboxpart(int x, int y, int w, int h, int ow, int oh,
				 void *b, int xo, int yo)
{
    driver16p_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

INLINE void driver16_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    driver8_copybox(x1 * 2, y1, w * 2, h, x2 * 2, y2);
}

void driver16a_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    int svp, dvp;
...
void driver24_setpixel(int x, int y, int c)
{
    char *vp;
    c = RGB2BGR(c);
    ASSIGNVP24(x, y, vp);
...
void driver24p_setpixel(int x, int y, int c)
{
    int vp, vpo;
    char *vbuf;
    int page;
...
void driver24_hline(int x1, int y, int x2, int c)
{
    char *vp;
    c = RGB2BGR(c);
    ASSIGNVP24(x1, y, vp);
...
void driver24p_hline(int x1, int y, int x2, int c)
{
    int vp;
    char *rvp;
    int l;
...
void driver24_fillbox(int x, int y, int w, int h, int c)
{
    char *vp;
    int i, j;
    c = RGB2BGR(c);
...
void driver24p_fillbox(int x, int y, int w, int h, int c)
{
    int vp;
    int page;
    int i;
...
void driver24_putbox(int x, int y, int w, int h, void *b, int bw)
{
    char *vp;			/* screen pointer */
    char *bp;			/* bitmap pointer */
    int i;
...
INLINE void driver24p_putbox(int x, int y, int w, int h, void *b, int bw)
{
    if (MODEFLAGS & MODEFLAG_24BPP_REVERSED) {
...
void driver24_putbox32(int x, int y, int w, int h, void *b, int bw)
{
    char *vp;			/* screen pointer */
    char *bp;			/* bitmap pointer */
    int i;
...
void driver24_getbox(int x, int y, int w, int h, void *b, int bw)
{
    char *vp;			/* screen pointer */
    char *bp;			/* bitmap pointer */
    int i;
...
INLINE void driver24p_getbox(int x, int y, int w, int h, void *b, int bw)
{
    if (MODEFLAGS & MODEFLAG_24BPP_REVERSED) {
...
void driver24_putboxmask(int x, int y, int w, int h, void *b)
{
    uchar *bp = b;
    uchar *vp;
    int i;
...
INLINE void driver24_putboxpart(int x, int y, int w, int h, int ow, int oh,
				void *b, int xo, int yo)
{
    /*
     * Actually I think all this could be done by just calling driver24_putbox
     * with correct args. But I'm too fearful. - Michael.
     */
    if (MODEFLAGS & MODEFLAG_24BPP_REVERSED) {
	driver24_putbox(x, y, w, h, b + yo * ow + xo, ow);
    } else {
	driver8_putbox(x * 3, y, w * 3, h, b + yo * ow * 3 + xo * 3, ow * 3);
    }
}

INLINE void driver24p_putboxpart(int x, int y, int w, int h, int ow, int oh,
				 void *b, int xo, int yo)
{
    if (MODEFLAGS & MODEFLAG_24BPP_REVERSED) {
...
INLINE void driver24_getboxpart(int x, int y, int w, int h, int ow, int oh,
				void *b, int xo, int yo)
{
    driver24_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

INLINE void driver24p_getboxpart(int x, int y, int w, int h, int ow, int oh,
				 void *b, int xo, int yo)
{
    driver24p_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

void driver24_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    driver8_copybox(x1 * 3, y1, w * 3, h, x2 * 3, y2);
}

void driver24a_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    int svp, dvp;
...
void driver32_setpixel(int x, int y, int c)
{
    char *vp;
    ASSIGNVP32(x, y, vp);
    *(unsigned *) vp = c;
...
void driver32p_setpixel(int x, int y, int c)
{
    int vp;
...
int driver32_getpixel(int x, int y)
{
    char *vp;
    ASSIGNVP32(x, y, vp);
    return *(unsigned *) vp;
...
int driver32p_getpixel(int x, int y)
{
    int vp;
    ASSIGNVPOFFSET32(x, y, vp);
    vga_setpage(vp >> 16);
...
void driver32_hline(int x1, int y, int x2, int c)
{
    char *vp;
    ASSIGNVP32(x1, y, vp);
...
void driver32p_hline(int x1, int y, int x2, int c)
{
    int vp;
    char *rvp;
    int l;
...
void driver32_fillbox(int x, int y, int w, int h, int c)
{
    char *vp;
    int i;
    ASSIGNVP32(x, y, vp);
...
void driver32p_fillbox(int x, int y, int w, int h, int c)
{
    int vp;
    int page;
    int i;
...
INLINE void driver32_putbox(int x, int y, int w, int h, void *b, int bw)
{
    driver8_putbox(x * 4, y, w * 4, h, b, bw * 4);
}

INLINE void driver32p_putbox(int x, int y, int w, int h, void *b, int bw)
{
    driver8p_putbox(x * 4, y, w * 4, h, b, bw * 4);
}

INLINE void driver32_getbox(int x, int y, int w, int h, void *b, int bw)
{
    driver8_getbox(x * 4, y, w * 4, h, b, bw * 4);
}

INLINE void driver32p_getbox(int x, int y, int w, int h, void *b, int bw)
{
    driver8p_getbox(x * 4, y, w * 4, h, b, bw * 4);
}

void driver32_putboxmask(int x, int y, int w, int h, void *b)
{
    uchar *bp = b;
    uchar *vp;
    int i;
...
INLINE void driver32_putboxpart(int x, int y, int w, int h, int ow, int oh,
				void *b, int xo, int yo)
{
    driver32_putbox(x, y, w, h, b + yo * ow + xo, ow);
    /* inlined */
}

INLINE void driver32p_putboxpart(int x, int y, int w, int h, int ow, int oh,
				 void *b, int xo, int yo)
{
    driver32p_putbox(x, y, w, h, b + yo * ow + xo, ow);
    /* inlined */
}

INLINE void driver32_getboxpart(int x, int y, int w, int h, int ow, int oh,
				void *b, int xo, int yo)
{
    driver32_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

INLINE void driver32p_getboxpart(int x, int y, int w, int h, int ow, int oh,
				 void *b, int xo, int yo)
{
    driver32p_getbox(x, y, w, h, b + yo * ow + xo, ow);
}

INLINE void driver32_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    driver8_copybox(x1 * 4, y1, w * 4, h, x2 * 4, y2);
}
...
void driverplanar256_putbox(int x, int y, int w, int h, void *b, int bw)
{
    if ((w & 3) != 0 || (x & 3) != 0)
...
void driver8p_putboxmask(int x, int y, int w, int h, void *b)
{
    NOTIMPL("8-bit paged putboxmask");
}

void driver8p_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    NOTIMPL("8-bit paged copybox (bitblt)");
}

void driver16p_putboxmask(int x, int y, int w, int h, void *b)
{
    NOTIMPL("16-bit paged putboxmask");
}

void driver16p_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    NOTIMPL("16-bit paged copybox");
}

void driver24p_putboxmask(int x, int y, int w, int h, void *b)
{
    NOTIMPL("24-bit paged putboxmask");
}

void driver24p_copybox(int x1, int y1, int w, int h, int x2, int y2)
{
    NOTIMPL("24-bit paged copybox");
}

void driver32p_putboxmask(int x, int y, int w, int h, void *b)
{
    NOTIMPL("32-bit paged putboxmask");
}

void driver32p_copybox(int x1, int y1, int w, int h, int x2, int y2)
{

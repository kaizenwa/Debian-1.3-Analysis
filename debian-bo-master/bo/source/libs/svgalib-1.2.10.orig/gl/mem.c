#include <stdio.h>
  ...
  */
void memcpy4to3(void *dest, void *src, int n)
{
    printf("libgl: memcpy4to3 not done yet\n");
}
 ...
 */
void memcpy32shift8(void *dest, void *src, int n)
{
    printf("libgl: memcpy32shift8 not done yet\n");
}

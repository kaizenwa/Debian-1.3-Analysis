...
/**************************************************
 * NIS GROUP INTERFACE FUNCTIONS
 **************************************************/
static int _pwdb_nis_glocate(const char *name,
                             const int id,
                             const struct pwdb **p)
{
...
static int _pwdb_nis_grequest(const char *entry_name,
                              const struct pwdb **p)
{
        return PWDB_UNSUPPORTED;
}

static int _pwdb_nis_greplace(const char *name,
                              const int id,
                              const struct pwdb **p)
{
    return PWDB_UNSUPPORTED;
...
static int _pwdb_nis_gdelete(const char *name,
                             const int id,
                             const struct pwdb **p)
{
    return PWDB_UNSUPPORTED;
...
static int _pwdb_nis_gsupport(const char *entry_name)
{
        return PWDB_UNSUPPORTED;
}

static int _pwdb_nis_gflags(pwdb_flag *flags)
{
        return PWDB_UNSUPPORTED;
}

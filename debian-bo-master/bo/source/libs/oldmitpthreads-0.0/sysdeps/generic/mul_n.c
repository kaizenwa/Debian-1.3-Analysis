...
#if __STDC__
void        ____mpn_mul_n_basecase   (mp_ptr, mp_srcptr, mp_srcptr, mp_size_t);
void        ____mpn_mul_n            (mp_ptr, mp_srcptr, mp_srcptr,
                                      mp_size_t, mp_ptr);
void        ____mpn_sqr_n_basecase   (mp_ptr, mp_srcptr, mp_size_t);
inline void __mpn_mul_n              (mp_ptr, mp_srcptr, mp_srcptr, mp_size_t);
void        ____mpn_sqr_n            (mp_ptr, mp_srcptr, mp_size_t, mp_ptr);
#else
void        ____mpn_mul_n_basecase   ();
void        ____mpn_mul_n            ();
void        ____mpn_sqr_n_basecase   ();
inline void __mpn_mul_n              ();
void        ____mpn_sqr_n            ();
#endif
...
#if __STDC__
void
____mpn_mul_n_basecase (mp_ptr prodp, mp_srcptr up, mp_srcptr vp,
    mp_size_t size)
#else
void
  ...
  if ((size & 1) != 0)
      ...
      else
	{
	 ...
	 as new TSPACE.  */
      ...
      cy = __mpn_add_n (prodp + size, prodp + size,

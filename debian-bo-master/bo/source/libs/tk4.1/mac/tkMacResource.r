 ...
 *
 * SCCS: @(#) tkMacResource.r 1.17 96/08/01 16:10:15
 */
...
resource 'vers' (1) {
	...
	RELEASE_CODE, 0,
	"4.1.1",
	"4.1.1" ", by Ray Johnson © 1993-1996" "\n" "Sun Microsystems Labratories"
};
...
data 'DITL' (129, "About Box") {
	$"0002 0000 0000 0080 0080 0094 00BA 0402"
	$"4F4B 0000 0000 000E 006C 0075 012A 886B"
	...
	$"656E 672E 7375 6E2E 636F 6D00 0000 0000"
	$"000B 0018 006F 005C 4002 0080"
};

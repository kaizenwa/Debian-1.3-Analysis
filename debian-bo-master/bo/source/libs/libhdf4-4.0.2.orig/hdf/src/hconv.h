...
/* hconv.h,v 1.19 1996/03/28 21:57:18 koziol Exp */
...
#if !defined(VMS) && !defined(INTEL86) && !defined(MIPSEL) && !defined(DEC_ALPHA) && !defined(I860) && !defined(SUN386)
#   if !defined(UNICOS)
...
#   endif   /* !UNICOS */
#else  /* must be VMS || INTEL86 || MIPSEL || DEC_ALPHA || I860 || SUN386 (Generally, little-endian machines */
#   define UI8_IN     DFKnb1b   /* Big-Endian IEEE support */
...
#endif /* !VMS && !INTEL86 && !MIPS && !DEC_ALPHA */

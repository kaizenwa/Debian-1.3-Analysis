...
#define ChangeMeID 444
    ...
    CommandObject DefaultCmds[] =
      {
        ...
        {C_Label, 111, 0, "Frame", NoList, CA_None, isSens, 10, 0, 0},
        {C_CheckBox, 112, 0, "Test A", NoList, CA_None, isSens, 10, 0, 111},
        {C_CheckBox, 113, 0, "Test B", NoList, CA_None, isSens, 10, 112, 111},
        {C_CheckBox, 114, 1, "Test C", NoList, CA_None, isSens, 10, 0, 112},

        {C_Frame,115, 0, "", NoList,CA_NoBorder,isSens, 10, 113, 0},
        {C_Label, 116, 0 , "Column A",NoList,CA_None,isSens,115,0,0},
        {C_Button, 117, 0, "Uneven",NoList, CA_None, isSens, 115, 0,116},
        {C_Button, 118, 0, "Vertical",NoList, CA_None, isSens, 115, 0,117},
        {C_Button, 119, 0, "Buttons",NoList, CA_None, isSens, 115, 0,118},

        {C_Frame,120, 0, "", NoList,CA_NoBorder,isSens, 10, 115, 0},
        {C_Label, 121, 0 , "Column B",NoList,CA_None,isSens,120,0,0},
        {C_Button, 122, 0, "Another",NoList, CA_None, isSens, 120, 0,121},
        {C_Button, 123, 0, "Vertical",NoList, CA_None, isSens, 120, 0,122},
        {C_Button, 124, 0, "Set",NoList, CA_None, isSens, 120, 0,123},

        {C_Frame, 11, 0, "", NoList,CA_None,isSens,NoFrame, 10, 0},
        {C_Label, 20, 0, "VFrame", NoList,CA_None, isSens,11, 0, 0},
        {C_RadioButton, 21, 1, "KOB",  NoList,CA_None,isSens, 11, 0, 20},
        {C_RadioButton, 22, 0, "KOAT", NoList, CA_None, isSens, 11, 0, 21},
        {C_RadioButton, 23, 0, "KRQE", NoList, CA_None, isSens, 11, 0, 22},

        {C_Frame, 12, 0, "", NoList,CA_NoSpace,isSens,NoFrame, 11, 0},
        {C_Label, 40, 0 , "NoSpace",NoList,CA_None,isSens,12,0,0},
        {C_Button, 41, 41, "Button 1", NoList, CA_None, isSens, 12, 0, 40},
        ...
        {C_ProgressBar, 76, 50, "", (void*)&prange[0],
            CA_Vertical | CA_NoLabel | CA_Small, isSens,0, 4, 10},
        ...
        {C_Text, 89, 50, "", " 50",CA_None,isSens,86, 88, 87},

        {C_Slider, 85, 50, "", NoList,CA_Vertical ,isSens,0, 86, 10},
   
        {C_Frame, 70, 0, "",   NoList,CA_None,isSens,NoFrame, 76,86},
    ...
    static vLabelCmd* newLbl;
    static CommandObject DynLabel =

        {C_Label, 301, 301, "Dynamic", NoList, CA_None, isSens, NoFrame, 18, 60};
    static char let = ' ';

//=========================>>> testDialog::testDialog <<<====================
  testDialog::testDialog(vBaseWindow* bw) :
    vDialog(bw,0,"V Test Dialog")
  {

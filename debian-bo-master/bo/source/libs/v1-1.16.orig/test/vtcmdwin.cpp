...
//      {"x", M_x, isSens, notChk, noKeyLbl, noKey, noSub},
    ...
    vMenu EditMenu[] =
      {
        {"Cut", M_Cut, notSens, notChk, "Ctrl-X", noKey, noSub},
        {"Copy", M_Copy, notSens, notChk, "Ctrl-C", noKey, noSub},
        {"Paste", M_Paste, notSens, notChk, "Ctrl-X", noKey, noSub},
        {NULL}
      };
...
#define vC_Size 8
	...
	{C_ToggleIconButton,M_Toggle , 1, "tog", &copyIcon,CA_None,isSens,NoFrame, 0, 0},
	{C_ToggleButton,m_togbtn , 1, "+/-", NoList,CA_None,isSens,NoFrame, 0, 0},
    ...
    CommandObject CommandBar2[] =
      {
        ...
        {C_IconButton, M_DrawIcon, M_DrawIcon, "", &colorIcon,CA_None,isSens,NoFrame, 0, 0},
       //       {C_Blank,887,0," ",CA_None,isSens,NoFrame, 0, 0},
        {C_Button, M_ColorTest, 0, "Color Test", NoList,CA_None,isSens,NoFrame, 0, 0},
        {C_Slider, 888, 4, "",NoList,CA_Horizontal ,isSens,NoFrame, 0, 0},
...
//====================>>> testCmdWindow::testCmdWindow <<<====================
  testCmdWindow::testCmdWindow(char* name, int width, int height) :
...
//====================>>> testCmdWindow::WindowCommand <<<====================
  void testCmdWindow::WindowCommand(ItemVal id, ItemVal val, CmdType cType)
  {
        ...
        case M_New:
	  {
	    ...
	    // be sure the menus and tool bars change.
            ...
            testCmdWindow2* tmp2 = new testCmdWindow2("Simple Window",
                100, 200);
	    theApp->NewAppWin(tmp2, "Simple Window", 200, 100);
            break;
          }
	...
	case m_setBG:
  	  {
	    myCanvas->SetBackground(_pen.GetColor());
	    break;
	  }

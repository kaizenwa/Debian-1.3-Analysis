...
//=======================>>> vDebugDialog::SetDebug <<<=======================
  void vDebugDialog::SetDebug()
  {
    ...
    switch (val)			// convert to our system
      {
	case M_OK:
	    DebugState.System = GetCommandObject(dSystem, DebugDialog);
	    DebugState.User = GetCommandObject(dUser, DebugDialog);
	    DebugState.CmdEvents = GetCommandObject(dCmdEvents, DebugDialog);
	    DebugState.MouseEvents = GetCommandObject(dMouseEvents, DebugDialog);
	    DebugState.WindowEvents = GetCommandObject(dWindowEvents, DebugDialog);
	    DebugState.UserApp1 = GetCommandObject(dUserApp1, DebugDialog);
	    DebugState.UserApp2  = GetCommandObject(dUserApp2, DebugDialog);
	    DebugState.UserApp3  = GetCommandObject(dUserApp3, DebugDialog);
	    DebugState.Build = GetCommandObject(dBuild, DebugDialog);
	    DebugState.Misc = GetCommandObject(dMisc, DebugDialog);
	    DebugState.Text = GetCommandObject(dText, DebugDialog);
	    DebugState.BadVals = GetCommandObject(dBadVals, DebugDialog);
	    DebugState.Constructor = GetCommandObject(dConstructor, DebugDialog);
	    DebugState.Destructor = GetCommandObject(dDestructor, DebugDialog);
	    break;

...
//==================>>> myCanvasPane::Read <<<====================
  int myCanvasPane::Read(char* name)
  {
    ...
    int height, width, colors, x, y, r, g, b, pix;
    int return_val;
...
//==================>>> myCanvasPane::IconRdRect <<<====================
  ...
  {  // This function will draw a rectangle like above but with rounded corners
    ...
    int offset;                   // offset from the corner - used asradius
    int centerx, centery;         // center location for radius for corners
    float centrectx, centrecty;   // center of the rectangle
    float offwidth, offheight;    // off set to center of radius from centrect

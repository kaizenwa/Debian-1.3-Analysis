      SUBROUTINE DCHKGT( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, A, AF,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'DGTTRS', INFO, 0, TRANS, N, N, -1,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'DGTRFS', INFO, 0, TRANS, N, N, -1,
     $                         -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
*
               CALL DGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
     $                      RESULT( 4 ) )
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'DGTCON', INFO, 0, NORM, N, N,

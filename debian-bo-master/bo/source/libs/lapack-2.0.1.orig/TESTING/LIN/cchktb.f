      SUBROUTINE CCHKTB( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
     $                   AB, AINV, B, X, XACT, WORK, RWORK, NOUT )
*
...
*  =======
*
*  CCHKTB tests CTBTRI, -TRS, -RFS, and -CON, and CLATBS.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
     ...
     $                   CLACPY, CLARHS, CLATBS, CLATTB, CLASET, CTBCON,
...
*
                     IF( RESULT( 7 ).GE.THRESH ) THEN
                        IF( NFAIL.EQ.0 .AND. NERRS.EQ.0 )
     $                     CALL ALAHD( NOUT, PATH )
                        WRITE( NOUT, FMT = 9998 )'CLATBS', UPLO, TRANS,

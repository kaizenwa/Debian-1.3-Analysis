      SUBROUTINE DCHKTP( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*
                  CALL DTPT02( UPLO, TRANS, DIAG, N, NRHS, AP, X, LDA,
     $                         B, LDA, WORK, RESULT( 2 ) )
*
*+    TEST 3
...
*
                  SRNAMT = 'DTPRFS'
                  CALL DTPRFS( UPLO, TRANS, DIAG, N, NRHS, AP, B, LDA,
...
*
                  CALL DGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
     $                         RESULT( 4 ) )
                  CALL DTPT05( UPLO, TRANS, DIAG, N, NRHS, AP, B, LDA,
...
*
                  IF( RESULT( 8 ).GE.THRESH ) THEN
                     IF( NFAIL.EQ.0 .AND. NERRS.EQ.0 )
     $                  CALL ALAHD( NOUT, PATH )
                     WRITE( NOUT, FMT = 9998 )'DLATPS', UPLO, TRANS,

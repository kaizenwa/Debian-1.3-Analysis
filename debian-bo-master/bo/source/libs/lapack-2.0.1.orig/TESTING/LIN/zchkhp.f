      SUBROUTINE ZCHKHP( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'ZHPTRI', INFO, 0, UPLO, N, N, -1,
     $                         -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'ZHPTRS', INFO, 0, UPLO, N, N, -1,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'ZHPRFS', INFO, 0, UPLO, N, N, -1,
     $                         -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
*
               CALL ZGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
     $                      RESULT( 5 ) )

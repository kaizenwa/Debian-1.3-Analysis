      SUBROUTINE CCHKSP( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'CSPTRI', INFO, 0, UPLO, N, N, -1,
     $                         -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'CSPTRS', INFO, 0, UPLO, N, N, -1,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'CSPRFS', INFO, 0, UPLO, N, N, -1,
     $                         -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
*
               CALL CGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
     $                      RESULT( 5 ) )

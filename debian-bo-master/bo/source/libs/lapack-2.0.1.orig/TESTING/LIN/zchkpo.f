      SUBROUTINE ZCHKPO( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ZPOTRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'ZPORFS'
                  CALL ZPORFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, B, LDA,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ZPORFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL ZGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

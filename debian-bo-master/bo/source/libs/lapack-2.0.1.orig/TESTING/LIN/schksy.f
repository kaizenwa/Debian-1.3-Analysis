      SUBROUTINE SCHKSY( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*
                  ...
                  SRNAMT = 'SSYTRI'
                  CALL SSYTRI( UPLO, N, AINV, LDA, IWORK, WORK, INFO )
*
*                 Check error code from SSYTRI.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'SSYTRI', INFO, -1, UPLO, N, N,
...
*
                  SRNAMT = 'SSYTRS'
                  CALL SSYTRS( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA,
     $                         INFO )
*
*                 Check error code from SSYTRS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'SSYTRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'SSYRFS'
                  CALL SSYRFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, IWORK,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'SSYRFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL SGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

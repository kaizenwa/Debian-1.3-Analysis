      SUBROUTINE CCHKPB( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*     .. External Subroutines ..
     ...
     $                   CLACPY, CLAIPD, CLARHS, CLATB4, CLATMS, CLASET,
...
*
                     SRNAMT = 'CPBTRS'
                     CALL CPBTRS( UPLO, N, KD, NRHS, AFAC, LDAB, X, LDA,
     $                            INFO )
*
*                    Check error code from CPBTRS.
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'CPBTRS', INFO, 0, UPLO, N,
...
*
                     IF( INFO.NE.0 )
     $                  CALL ALAERH( PATH, 'CPBRFS', INFO, 0, UPLO, N,
     $                               N, KD, KD, NRHS, IMAT, NFAIL,
     $                               NERRS, NOUT )
*
                     CALL CGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
     $                            RESULT( 4 ) )
                     CALL CPBT05( UPLO, N, KD, NRHS, A, LDAB, B, LDA, X,
     $                            LDA, XACT, LDA, RWORK,

      SUBROUTINE CCHKSY( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*
                  ...
                  SRNAMT = 'CSYTRI'
                  CALL CSYTRI( UPLO, N, AINV, LDA, IWORK, WORK, INFO )
*
*                 Check error code from CSYTRI.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'CSYTRI', INFO, 0, UPLO, N, N,
     $                            -1, -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
...
*
                  SRNAMT = 'CSYTRS'
                  CALL CSYTRS( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA,
     $                         INFO )
*
*                 Check error code from CSYTRS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'CSYTRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'CSYRFS'
                  CALL CSYRFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, IWORK,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'CSYRFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL CGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

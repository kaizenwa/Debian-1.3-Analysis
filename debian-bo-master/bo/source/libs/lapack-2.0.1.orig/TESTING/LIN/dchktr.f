      SUBROUTINE DCHKTR( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
     $                   TSTERR, NMAX, A, AINV, B, X, XACT, WORK, RWORK,
     $                   IWORK, NOUT )
*
...
*     .. Local Scalars ..
      ...
      CHARACTER*3        PATH
      INTEGER            I, IDIAG, IMAT, IN, INB, INFO, ITRAN, IUPLO, K,
     $                   K1, LDA, N, NB, NERRS, NFAIL, NRUN, NT
...
*
     ...
     $                                  -1, -1, IMAT, NFAIL, NERRS,
     $                                  NOUT )
*
                        CALL DTRT06( RCOND, RCONDC, UPLO, DIAG, N, A,
     $                               LDA, RWORK, RESULT( 7 ) )
                        NT = 7
                     END IF
*
...
*
     ...
     $                        CALL ALAHD( NOUT, PATH )
                           WRITE( NOUT, FMT = 9999 )UPLO, TRANS, N, NB,
     $                        IMAT, K, RESULT( K )
                           NFAIL = NFAIL + 1
                        END IF
   20                CONTINUE
...
*
                  IF( RESULT( 8 ).GE.THRESH ) THEN
                     IF( NFAIL.EQ.0 .AND. NERRS.EQ.0 )
     $                  CALL ALAHD( NOUT, PATH )
                     WRITE( NOUT, FMT = 9998 )'DLATRS', UPLO, TRANS,
...
*
 9999 FORMAT( ' UPLO=''', A1, ''', TRANS=''', A1, ''', N=', I5, ', NB=',

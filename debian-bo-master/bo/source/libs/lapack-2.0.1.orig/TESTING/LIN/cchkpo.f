      SUBROUTINE CCHKPO( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*     .. Local Scalars ..
      ...
      CHARACTER*3        PATH
      INTEGER            I, IMAT, IN, INB, INFO, IOFF, IUPLO, IZERO, K,
     $                   KL, KU, LDA, MODE, N, NB, NERRS, NFAIL, NIMAT,
     $                   NRUN, NT
...
*
                  SRNAMT = 'CPOTRS'
                  CALL CPOTRS( UPLO, N, NRHS, AFAC, LDA, X, LDA, INFO )
*
*                 Check error code from CPOTRS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'CPOTRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'CPORFS'
                  CALL CPORFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, B, LDA,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'CPORFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL CGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

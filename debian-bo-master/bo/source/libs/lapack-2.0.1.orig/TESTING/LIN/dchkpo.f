      SUBROUTINE DCHKPO( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'DPOTRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'DPORFS'
                  CALL DPORFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, B, LDA,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'DPORFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL DGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

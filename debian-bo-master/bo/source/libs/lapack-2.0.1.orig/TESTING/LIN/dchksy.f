      SUBROUTINE DCHKSY( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*
                  ...
                  SRNAMT = 'DSYTRI'
                  CALL DSYTRI( UPLO, N, AINV, LDA, IWORK, WORK, INFO )
*
*                 Check error code from DSYTRI.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'DSYTRI', INFO, -1, UPLO, N, N,
...
*
                  SRNAMT = 'DSYTRS'
                  CALL DSYTRS( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA,
     $                         INFO )
*
*                 Check error code from DSYTRS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'DSYTRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'DSYRFS'
                  CALL DSYRFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, IWORK,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'DSYRFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL DGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

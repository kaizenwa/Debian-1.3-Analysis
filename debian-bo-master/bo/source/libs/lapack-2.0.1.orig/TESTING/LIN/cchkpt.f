      SUBROUTINE CCHKPT( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, A, D,
...
*
               CALL CLAPTM( UPLO, N, NRHS, ONE, D, E, XACT, LDA, ZERO,
     $                      B, LDA )
*
*+    TEST 2
...
*
               ...
               CALL CPTTRS( UPLO, N, NRHS, D( N+1 ), E( N+1 ), X, LDA,
     $                      INFO )
*
...
*
               SRNAMT = 'CPTRFS'
               CALL CPTRFS( UPLO, N, NRHS, D, E, D( N+1 ), E( N+1 ), B,

      SUBROUTINE SCHKSP( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'SSPTRI', INFO, 0, UPLO, N, N, -1,
     $                         -1, -1, IMAT, NFAIL, NERRS, NOUT )
*
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'SSPTRS', INFO, 0, UPLO, N, N, -1,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'SSPRFS', INFO, 0, UPLO, N, N, -1,
     $                         -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
*
               CALL SGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
     $                      RESULT( 5 ) )

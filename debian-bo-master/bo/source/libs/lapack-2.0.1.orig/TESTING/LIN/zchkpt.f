      SUBROUTINE ZCHKPT( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, A, D,
...
*     .. Local Scalars ..
      ...
      CHARACTER*3        PATH
      INTEGER            I, IA, IMAT, IN, INFO, IUPLO, IX, IZERO, J, K,
     $                   KL, KU, LDA, MODE, N, NERRS, NFAIL, NIMAT, NRUN
...
*
               CALL ZLAPTM( UPLO, N, NRHS, ONE, D, E, XACT, LDA, ZERO,
     $                      B, LDA )
*
*+    TEST 2
...
*
               ...
               CALL ZPTTRS( UPLO, N, NRHS, D( N+1 ), E( N+1 ), X, LDA,
     $                      INFO )
*
...
*
               SRNAMT = 'ZPTRFS'
               CALL ZPTRFS( UPLO, N, NRHS, D, E, D( N+1 ), E( N+1 ), B,
...
*
               DO 70 K = 2, 6
                  IF( RESULT( K ).GE.THRESH ) THEN
                     IF( NFAIL.EQ.0 .AND. NERRS.EQ.0 )
     $                  CALL ALAHD( NOUT, PATH )
                     WRITE( NOUT, FMT = 9998 )UPLO, N, IMAT, K,
     $                  RESULT( K )
                     NFAIL = NFAIL + 1
                  END IF
   70          CONTINUE
...
*
 9999 FORMAT( ' N =', I5, ', type ', I2, ', test ', I2, ', ratio = ',
     $      G12.5 )
 9998 FORMAT( ' UPLO = ''', A1, ''', N =', I5, ', type ', I2, ', test ',
     $      I2, ', ratio = ', G12.5 )
      RETURN
*
*     End of ZCHKPT

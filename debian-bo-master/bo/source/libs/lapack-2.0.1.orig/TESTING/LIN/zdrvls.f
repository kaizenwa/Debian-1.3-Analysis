...
*  =======
*
*  ZDRVLS tests the least squares driver routines ZGELS, CGELSX, and
*  ZGELSS.
*
*  Arguments
*  =========
...
*
*  B       (workspace) COMPLEX*16 array, dimension (MMAX*NMAX)
*          where MMAX is the maximum value of M in MVAL and NMAX is the
*          maximum value of N in NVAL.
*
*  COPYB   (workspace) COMPLEX*16 array, dimension (MMAX*NMAX)
*
...
*     ..
*     .. External Functions ..
      DOUBLE PRECISION   DASUM, DLAMCH, DZNRM2, ZQRT12, ZQRT14, ZQRT17
      EXTERNAL           DASUM, DLAMCH, DZNRM2, ZQRT12, ZQRT14, ZQRT17
*     ..
*     .. External Subroutines ..
      EXTERNAL           ALAERH, ALAHD, ALASVM, DAXPY, XLAENV, ZDSCAL,
     $                   ZERRLS, ZGELS, ZGELSS, ZGELSX, ZGEMM, ZLACPY,
     $                   ZLARNV, ZQRT13, ZQRT15, ZQRT16
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                               LDB )
*
*                       ZGELSX:  Compute the minimum-norm solution X to
*                          min( norm( A * X - B ) )
...
*
                        IF( INFO.NE.0 )
     $                     CALL ALAERH( PATH, 'ZGELSX', INFO, 0, ' ', M,

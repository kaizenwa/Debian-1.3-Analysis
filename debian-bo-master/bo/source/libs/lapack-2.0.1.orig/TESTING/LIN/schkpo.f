      SUBROUTINE SCHKPO( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*
                  SRNAMT = 'SPOTRS'
                  CALL SPOTRS( UPLO, N, NRHS, AFAC, LDA, X, LDA, INFO )
*
*                 Check error code from SPOTRS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'SPOTRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'SPORFS'
                  CALL SPORFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, B, LDA,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'SPORFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL SGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

      SUBROUTINE ZCHKHE( DOTYPE, NN, NVAL, NNB, NBVAL, NRHS, THRESH,
...
*
                  ...
                  SRNAMT = 'ZHETRI'
                  CALL ZHETRI( UPLO, N, AINV, LDA, IWORK, WORK, INFO )
*
*                 Check error code from ZHETRI.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ZHETRI', INFO, -1, UPLO, N, N,
...
*
                  SRNAMT = 'ZHETRS'
                  CALL ZHETRS( UPLO, N, NRHS, AFAC, LDA, IWORK, X, LDA,
     $                         INFO )
*
*                 Check error code from ZHETRS.
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ZHETRS', INFO, 0, UPLO, N, N,
...
*
                  SRNAMT = 'ZHERFS'
                  CALL ZHERFS( UPLO, N, NRHS, A, LDA, AFAC, LDA, IWORK,
...
*
                  IF( INFO.NE.0 )
     $               CALL ALAERH( PATH, 'ZHERFS', INFO, 0, UPLO, N, N,
     $                            -1, -1, NRHS, IMAT, NFAIL, NERRS,
     $                            NOUT )
*
                  CALL ZGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,

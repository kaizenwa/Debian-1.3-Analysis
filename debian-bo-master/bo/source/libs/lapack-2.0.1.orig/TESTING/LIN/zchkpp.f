      SUBROUTINE ZCHKPP( DOTYPE, NN, NVAL, NRHS, THRESH, TSTERR, NMAX,
...
*     .. Local Scalars ..
      ...
      CHARACTER*3        PATH
      INTEGER            I, IMAT, IN, INFO, IOFF, IUPLO, IZERO, K, KL,
     $                   KU, LDA, MODE, N, NERRS, NFAIL, NIMAT, NPP,
     $                   NRUN, NT
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'ZPPTRS', INFO, 0, UPLO, N, N, -1,
...
*
               IF( INFO.NE.0 )
     $            CALL ALAERH( PATH, 'ZPPRFS', INFO, 0, UPLO, N, N, -1,
     $                         -1, NRHS, IMAT, NFAIL, NERRS, NOUT )
*
               CALL ZGET04( N, NRHS, X, LDA, XACT, LDA, RCONDC,
     $                      RESULT( 5 ) )

...
*  =======
*
*  SDRVBD checks the singular value decomposition (SVD) driver SGESVD.
*  SGESVD factors A = U diag(S) VT, where U and VT are orthogonal
...
*     .. Local Scalars ..
      ...
      CHARACTER*3        PATH
      INTEGER            I, IINFO, IJU, IJVT, IWS, IWTMP, J, JSIZE,
...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, SBDT01, SGESVD, SORT03, SLABAD, SLACPY,
     $                   SLATMS, SLASET, SORT01, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                      VTSAV, LDVT, WORK, RESULT( 1 ) )
               CALL SORT01( 'Columns', MNMIN, M, USAV, LDU, WORK, LWORK,
     $                      RESULT( 2 ) )
               CALL SORT01( 'Rows', MNMIN, N, VTSAV, LDVT, WORK, LWORK,
     $                      RESULT( 3 ) )
               RESULT( 4 ) = ZERO
               DO 50 I = 1, MNMIN - 1

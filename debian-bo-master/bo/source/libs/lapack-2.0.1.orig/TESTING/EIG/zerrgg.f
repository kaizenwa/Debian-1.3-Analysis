...
*  =======
*
*  ZERRGG tests the error exits for ZGGGLM, CGGHRD, CGGLSE, CGGQRF,
*  ZGGRQF, CGGSVD, CGGSVP, ZHGEQZ, ZTGEVC, and CTGSJA.
*
*  Arguments
*  =========
*
...
*     .. Local Arrays ..
      LOGICAL            SEL( NMAX )
      INTEGER            IW( LW )
      DOUBLE PRECISION   R1( NMAX ), R2( NMAX ), RW( LW )
...
*     .. External Subroutines ..
      EXTERNAL           CHKXER, ZGGGLM, ZGGHRD, ZGGLSE, ZGGQRF, ZGGRQF,
     $                   ZGGSVD, ZGGSVP, ZHGEQZ, ZTGEVC, ZTGSJA
*     ..
*     .. Scalars in Common ..
      LOGICAL            LERR, OK
      CHARACTER*6        SRNAMT

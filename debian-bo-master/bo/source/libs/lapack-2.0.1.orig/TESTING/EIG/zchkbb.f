...
*     .. Local Scalars ..
      ...
      INTEGER            I, IINFO, IMODE, ITYPE, IWORK, J, JCOL, JR,
     $                   JSIZE, JTYPE, JWIDTH, K, KL, KMAX, KU, M, MMAX,
     $                   MNMAX, MNMIN, MTYPES, N, NERRS, NMATS, NMAX,
     $                   NTEST, NTESTT
...
*
     ...
     $                      WORK( 2*M+1 ), 1, ONE, 'N', IWORK, M, NRHS,
     $                      ZERO, ONE, 'NO', C, LDC, IWORK, IINFO )
*
               IF( IINFO.NE.0 ) THEN
...
*     Summary
*
      CALL DLASUM( 'CBB', NOUNIT, NERRS, NTESTT )
      RETURN
*

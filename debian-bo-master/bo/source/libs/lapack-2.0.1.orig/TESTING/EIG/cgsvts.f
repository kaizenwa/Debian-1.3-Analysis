      SUBROUTINE CGSVTS( M, P, N, A, AF, LDA, B, BF, LDB, U, LDU,
     $                   V, LDV, Q, LDQ, ALPHA, BETA, R, LDR,
...
*     .. Array Arguments ..
      INTEGER            IWORK( * )
      REAL               ALPHA( * ), BETA( * ), RESULT( 5 ), RWORK( * )
...
*     .. External Subroutines ..
      EXTERNAL           CGEMM, CGGSVD, CLACPY, CLASET, CHERK
*     ..
*     .. Intrinsic Functions ..
...
*
      CALL CGEMM( 'No transpose', 'No transpose', M, N, N, CONE,
     $            A, LDA, Q, LDQ, CZERO, WORK, LDA )
*

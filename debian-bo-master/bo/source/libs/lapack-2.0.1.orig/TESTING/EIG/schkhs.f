...
*     .. External Subroutines ..
     ...
     $                   SHSEQR, SHST01, SLABAD, SLACPY, SLAFTS, SLASUM,
     $                   SLATME, SLATMR, SLATMS, SLASET, SORGHR, SORMHR,
     $                   STREVC, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
  ...
  140       CONTINUE
     ...
     $                   EVECTR, LDU, N, IN, WORK, IINFO )
            IF( IINFO.NE.0 ) THEN
               WRITE( NOUNIT, FMT = 9999 )'STREVC(R)', IINFO, N, JTYPE,
     $            IOLDSD
               INFO = ABS( IINFO )
               GO TO 180
            END IF
...
*
  ...
  150       CONTINUE
     ...
     $                   DUMMA, LDU, N, IN, WORK, IINFO )
            IF( IINFO.NE.0 ) THEN
               WRITE( NOUNIT, FMT = 9999 )'STREVC(L)', IINFO, N, JTYPE,
     $            IOLDSD
               INFO = ABS( IINFO )
               GO TO 180
            END IF

     ...
     $                   LDU, V, TAU, Z, WORK, NWORK, RWORK, IWORK,
     $                   RESULT, INFO )
*
...
*          Modified.
*
*  WORK  - COMPLEX*16 array of dimension ( NWORK )
*           Workspace.
*           Modified.
*
*  NWORK - INTEGER
...
*          Modified.
*
*  RESULT  DOUBLE PRECISION array, dimension (42)
...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, DLABAD, DLAFTS, XERBLA, ZHBEVD, ZHBEVX,
     $                   ZHEEVD, ZHEEVX, ZHET21, ZHET22, ZHPEVD, ZHPEVX,
     $                   ZLACPY, ZLASET, ZLATMR, ZLATMS
*     ..
*     .. Intrinsic Functions ..
...
*
     ...
     $                      ABSTOL, M, WA1, Z, LDU, WORK, NWORK, RWORK,
...
*
     ...
     $                      ABSTOL, M2, WA2, Z, LDU, WORK, NWORK, RWORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN
...
*
     ...
     $                      ABSTOL, M3, WA3, Z, LDU, WORK, NWORK, RWORK,
     $                      IWORK, IWORK( 5*N+1 ), IINFO )
               IF( IINFO.NE.0 ) THEN

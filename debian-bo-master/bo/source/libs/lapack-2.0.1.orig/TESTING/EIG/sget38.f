...
*          NINFO(1) = 1 if SGEHRD returned INFO nonzero
*          NINFO(2) = 1 if SHSEQR returned INFO nonzero
*          NINFO(3) = 1 if STRSEN returned INFO nonzero
*
*  KNT     (output) INTEGER
...
*     .. External Subroutines ..
      EXTERNAL           SCOPY, SGEHRD, SHST01, SHSEQR, SLACPY, SORGHR,
     $                   SSCAL, STRSEN
*     ..
*     .. Intrinsic Functions ..

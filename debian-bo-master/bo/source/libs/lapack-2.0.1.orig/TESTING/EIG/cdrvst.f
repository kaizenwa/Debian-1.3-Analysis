...
*          Modified.
*
*  WORK  - COMPLEX array of dimension ( NWORK )
*           Workspace.
*           Modified.
*
*  NWORK - INTEGER
...
*          Modified.
*
*  RESULT  REAL array, dimension (42)
...
*     .. External Subroutines ..
      EXTERNAL           ALASVM, CHBEVD, CHBEVX, CHEEVD, CHEEVX, CHET21,
     $                   CHET22, CHPEVD, CHPEVX, CLACPY, CLASET, CLATMR,
     $                   CLATMS, SLABAD, SLAFTS, XERBLA
*     ..
*     .. Intrinsic Functions ..

...
*     .. Array Arguments ..
      ...
      REAL               D( * ), RESULT( 14 ), RWORK( * )
      COMPLEX            A( LDA, * ), B( LDB, * ), BB( LDB, * ), U( * ),
     $                   UZ( * ), V( LDU, * ), WORK( * ), Z( LDU, * )
*     ..
*
*  Purpose
...
*          Not modified.
*
*  BB      COMPLEX array, dimension (LDU, max(NN))
*          Workspace.
*          Modified.
*
...
*          -21: NWORK too small.
*          If  CLATMR, CLATMS, CHEGV, CHPGV or CHBGV
...
*     .. External Subroutines ..
      EXTERNAL           CHBGV, CHEGV, CHPGV, CLACPY, CLASET, CLATMR,
...
*
   80       CONTINUE
*
*           3) Call CHEGV, CHPGV and CHBGV to compute S and U, do tests.
*
...
*
                  NTEST = NTEST + 1
*
                  CALL CLACPY( ' ', N, N, A, LDA, Z, LDU )
                  CALL CLACPY( UPLO, N, N, B, LDB, BB, LDB )
*
                  CALL CHEGV( IBTYPE, 'V', UPLO, N, Z, LDU, BB, LDB, D,
...
*                 Do Test
*
                  CALL CSGT01( IBTYPE, UPLO, N, A, LDA, B, LDB, Z, LDU,
...
*
  ...
  130                CONTINUE
                  END IF
*
                  CALL CHPGV( IBTYPE, 'V', UPLO, N, UZ, U, D, Z, LDU,
     $                        WORK, RWORK, IINFO )
                  IF( IINFO.NE.0 ) THEN
...
*
  ...
  200                   CONTINUE
                     END IF
*
                     CALL CHBGV( 'V', UPLO, N, KA, KB, V, LDU, BB, LDB,
...
*                    Do Test
*
                     CALL CSGT01( IBTYPE, UPLO, N, A, LDA, B, LDB, Z,

...
*
*  (1)     | A - V S V' | / ( |A| n ulp )  computed by SSYTRD with
*                                          UPLO='U'
*
*  (2)     | I - UV' | / ( n ulp )         test of SORGTR w/ UPLO='U'
*
*  (3)     | A - V S V' | / ( |A| n ulp )  computed by SSYTRD with
*                                          UPLO='L'
*
*  (4)     | I - UV' | / ( n ulp )         test of SORGTR w/ UPLO='L'
*
*  (5-8)   Same, but for SSPTRD and SOPGTR.
*
*  (9)     | S - Z D Z' | / ( |S| n ulp )
*
*  (10)    | I - ZZ' | / ( n ulp )
...
*  (21)    | I - Y Y' | / ( n ulp )
*
*  (22)    | S - Z D Z' | / ( |S| n ulp ) for SSTEDC('I')
*
*  (23)    | I - ZZ' | / ( n ulp ) for SSTEDC('I')
*
*  (24)    | S - Z D Z' | / ( |S| n ulp ) for SSTEDC('V')
*
*  (25)    | I - ZZ' | / ( n ulp ) for SSTEDC('V')
*
*  (26)    | D1 - D2 | / ( |D1| ulp ) for SSTEDC('V') and SSTEDC('N')
*
...
*          The number of elements in DOTYPE.   If it is zero, SCHK22
...
*     .. External Subroutines ..
     ...
     $                   SSTEBZ, SSTECH, SSTEDC, SSTEIN, SSTEQR, SSTERF,
     $                   SSTT21, SSYT21, SSYTRD, XERBLA
*     ..
*     .. Intrinsic Functions ..

     ...
     $                   NOUNIT, A, LDA, D1, D2, D3, D4, WA1, WA2, WA3,
     $                   U, LDU, V, TAU, Z, WORK, NWORK, IWORK, RESULT,
     $                   INFO )
*
...
*     .. External Subroutines ..
     ...
     $                   SSPEVX, SSTEV, SSTEVD, SSTEVX, SSTT21, SSTT22,
     $                   SSYEV, SSYEVD, SSYEVX, SSYT21, SSYT22, XERBLA
*     ..
*     .. Intrinsic Functions ..
...
*
               IF( IUPLO.EQ.1 ) THEN
                  DO 910 J = 1, N
                     DO 900 I = MAX( 1, J-KD ), J
                        V( KD+1+I-J, J ) = A( I, J )
  900                CONTINUE
  910             CONTINUE
               ELSE
                  DO 930 J = 1, N
                     DO 920 I = J, MIN( N, J+KD )
                        V( 1+I-J, J ) = A( I, J )
  920                CONTINUE
  930             CONTINUE
               END IF
...
*
               IF( IUPLO.EQ.1 ) THEN
                  DO 950 J = 1, N
                     DO 940 I = MAX( 1, J-KD ), J
                        V( KD+1+I-J, J ) = A( I, J )
  940                CONTINUE
  950             CONTINUE
               ELSE
                  DO 970 J = 1, N
                     DO 960 I = J, MIN( N, J+KD )
                        V( 1+I-J, J ) = A( I, J )
  960                CONTINUE
  970             CONTINUE
               END IF
...
*
  990          CONTINUE
               IF( IUPLO.EQ.1 ) THEN
                  DO 1010 J = 1, N
                     DO 1000 I = MAX( 1, J-KD ), J
                        V( KD+1+I-J, J ) = A( I, J )
 1000                CONTINUE
 1010             CONTINUE
               ELSE
                  DO 1030 J = 1, N
                     DO 1020 I = J, MIN( N, J+KD )
                        V( 1+I-J, J ) = A( I, J )
 1020                CONTINUE
 1030             CONTINUE
               END IF
...
*
               IF( IUPLO.EQ.1 ) THEN
                  DO 1050 J = 1, N
                     DO 1040 I = MAX( 1, J-KD ), J
                        V( KD+1+I-J, J ) = A( I, J )
 1040                CONTINUE
 1050             CONTINUE
               ELSE
                  DO 1070 J = 1, N
                     DO 1060 I = J, MIN( N, J+KD )
                        V( 1+I-J, J ) = A( I, J )
 1060                CONTINUE
 1070             CONTINUE
               END IF
...
*
               IF( IUPLO.EQ.1 ) THEN
                  DO 1150 J = 1, N
                     DO 1140 I = MAX( 1, J-KD ), J
                        V( KD+1+I-J, J ) = A( I, J )
 1140                CONTINUE
 1150             CONTINUE
               ELSE
                  DO 1170 J = 1, N
                     DO 1160 I = J, MIN( N, J+KD )
                        V( 1+I-J, J ) = A( I, J )
 1160                CONTINUE
 1170             CONTINUE
               END IF
...
*
               IF( IUPLO.EQ.1 ) THEN
                  DO 1410 J = 1, N
                     DO 1400 I = MAX( 1, J-KD ), J
                        V( KD+1+I-J, J ) = A( I, J )
 1400                CONTINUE
 1410             CONTINUE
               ELSE
                  DO 1430 J = 1, N
                     DO 1420 I = J, MIN( N, J+KD )
                        V( 1+I-J, J ) = A( I, J )
 1420                CONTINUE
 1430             CONTINUE
               END IF
...
*
               IF( IUPLO.EQ.1 ) THEN
                  DO 1450 J = 1, N
                     DO 1440 I = MAX( 1, J-KD ), J
                        V( KD+1+I-J, J ) = A( I, J )
 1440                CONTINUE
 1450             CONTINUE
               ELSE
                  DO 1470 J = 1, N
                     DO 1460 I = J, MIN( N, J+KD )
                        V( 1+I-J, J ) = A( I, J )
 1460                CONTINUE
 1470             CONTINUE
               END IF

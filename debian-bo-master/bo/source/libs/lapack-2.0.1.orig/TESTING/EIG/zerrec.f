...
*
      SRNAMT = 'ZTREXC'
      INFOT = 1
      CALL ZTREXC( 'X', 1, A, 1, B, 1, 1, 1, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      INFOT = 7
      CALL ZTREXC( 'N', 0, A, 1, B, 1, 1, 1, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      INFOT = 4
      CALL ZTREXC( 'N', 2, A, 1, B, 1, 1, 2, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      INFOT = 6
      CALL ZTREXC( 'V', 2, A, 2, B, 1, 1, 2, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      INFOT = 7
      CALL ZTREXC( 'V', 1, A, 1, B, 1, 0, 1, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      INFOT = 7
      CALL ZTREXC( 'V', 1, A, 1, B, 1, 2, 1, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      INFOT = 8
      CALL ZTREXC( 'V', 1, A, 1, B, 1, 1, 0, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      INFOT = 8
      CALL ZTREXC( 'V', 1, A, 1, B, 1, 1, 2, INFO )
      CALL CHKXER( 'ZTREXC', INFOT, NOUT, LERR, OK )
      NT = NT + 8
*
*     Test ZTRSNA

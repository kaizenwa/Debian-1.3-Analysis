...
*  =======
*
*  ZERRBD tests the error exits for ZGEBRD, ZUNGBR, CUNMBR, and ZBDSQR.
*
*  Arguments
*  =========
*
...
*
      ...
      END IF
*
 9999 FORMAT( 1X, A3, ' passed the tests of the error exits' )
 9998 FORMAT( ' *** ', A3, ' failed the tests of the error exits ***' )
*
      RETURN
*
*     End of ZERRBD

...
*           Tests performed
*
            WRITE( IOUNIT, FMT = 9980 )'orthogonal', '''=transpose',
     $         ( '''', J = 1, 6 )
*
         ELSE
*
...
*           Tests performed
*
            WRITE( IOUNIT, FMT = 9980 )'unitary', '*=conj.transp.',
     $         ( '*', J = 1, 6 )
         END IF
*
...
*
            ...
            WRITE( IOUNIT, FMT = 9977 )'Symmetric'
*
*           Tests performed
*
...
*
            WRITE( IOUNIT, FMT = 9979 )
            WRITE( IOUNIT, FMT = 9978 )
            WRITE( IOUNIT, FMT = 9977 )'Hermitian'
*
*           Tests performed
*
...
*           Tests performed
*
            WRITE( IOUNIT, FMT = 9971 )'orthogonal'
...
*           Tests performed
*
            WRITE( IOUNIT, FMT = 9968 )'orthogonal'
         ELSE
*
...
*
 9980 FORMAT( / ' Tests performed:   ', '(S is Tridiag, D is diagonal,',
     $      ' U and Z are ', A, ',', / 20X, A, ', W is a diagonal matr',
...
*
 9979 FORMAT( ' Matrix types (see xDRVSG for details): ' )
*
 9978 FORMAT( / ' Special Matrices:', / '  1=Zero matrix.             ',
     $      '           ', '  5=Diagonal: clustered entries.', / '  2=',
     $      'Identity matrix.                    ', '  6=Diagonal: lar',
     $      'ge, evenly spaced.', / '  3=Diagonal: evenly spaced entri',
     $      'es.    ', '  7=Diagonal: small, evenly spaced.', / '  4=D',
     $      'iagonal: geometr. spaced entries.' )
 9977 FORMAT( ' Dense or Banded ', A, ' Matrices: ',
 ...
 9976 FORMAT( / ' Tests performed:   ',
     ...
     $      '  | A Z - B Z D | / ( |A| |Z| n ulp )     ' )
 9975 FORMAT( ' 7 = DSYGV, with ITYPE=2 and UPLO=''U'':',
     $      '  | A B Z - Z D | / ( |A| |Z| n ulp )     ',
 ...
 9974 FORMAT( / ' Tests performed:   ',
     ...
     $      '  | A Z - B Z D | / ( |A| |Z| n ulp )     ' )
 9973 FORMAT( ' 7 = ZHEGV, with ITYPE=2 and UPLO=''U'':',
     $      '  | A B Z - Z D | / ( |A| |Z| n ulp )     ',
...
*
 9972 FORMAT( ' Matrix types (see xCHKBD for details):',
...
*
 ...
 9970 FORMAT( '   8: Test ordering of S  (0 if nondecreasing, 1/ulp ',
     $      ' otherwise)', /
...
*
 9969 FORMAT( ' Matrix types (see xCHKBB for details):',
     $      / ' Diagonal matrices:', / '   1: Zero', 28X,
     $      ' 5: Clustered entries', / '   2: Identity', 24X,
     $      ' 6: Large, evenly spaced entries',
     $      / '   3: Evenly spaced entries', 11X,
     ...
     $      '15: Random, scaled near underflow' )
*
 9968 FORMAT( / ' Test ratios:  ', '(B: upper bidiagonal, Q and P: ',

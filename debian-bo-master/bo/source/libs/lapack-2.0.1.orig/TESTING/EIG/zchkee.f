...
*      Test ZHEGST, ZHEGV, ZHPGST, ZHPGV, ZHBGST, and ZHBGV
*
...
*
*  line 1:  'ZBL' in columns 1-3 to test ZGEBAL, or 'ZBK' in
*           columns 1-3 to test ZGEBAK.
*
...
*     .. Local Scalars ..
     ...
     $                   TSTCHK, TSTDIF, TSTDRV, TSTERR, ZBB, ZBK, ZBL,
     $                   ZES, ZEV, ZGG, ZGK, ZGL, ZHB, ZSX, ZVX
      CHARACTER          C1
      CHARACTER*3        C3, PATH
      CHARACTER*6        VNAME
      CHARACTER*10       INTSTR
...
*     .. External Subroutines ..
     ...
     $                   ZCHKST, ZCKGLM, ZCKGQR, ZCKGSV, ZCKLSE, ZDRVBD,
     $                   ZDRVES, ZDRVEV, ZDRVGG, ZDRVSG, ZDRVST, ZDRVSX,
     $                   ZDRVVX, ZERRBD, ZERRED, ZERRGG, ZERRHS, ZERRST
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          LEN, MIN
*     ..
...
*
      IF( SVD .OR. ZBB .OR. GLM .OR. GQR .OR. GSV .OR. LSE ) THEN
...
*        or ZBB).
*
         IF( NEP .OR. SVD .OR. ZBB .OR. ZGG ) THEN

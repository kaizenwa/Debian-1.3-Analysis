...
*
     ...
     $                  ILAENV( 1, 'CUNMBR', 'QLT', M, NRHS, M, -1 ) )
     ...
     $                  CZERO, WORK, LDB )
         ...
         ELSE IF( NRHS.GT.1 ) THEN
            ...
            DO 20 I = 1, NRHS, CHUNK
               ...
               CALL CGEMM( 'C', 'N', N, BL, N, CONE, A, LDA, B, LDB,
     $                     CZERO, WORK, N )
               CALL CLACPY( 'G', N, BL, WORK, N, B, LDB )
   20       CONTINUE
         ELSE
...
*
     ...
     $                     B( 1, I ), LDB, CZERO, WORK( IWORK ), N )
               CALL CLACPY( 'G', M, BL, WORK( IWORK ), N, B, LDB )
   40       CONTINUE
         ELSE

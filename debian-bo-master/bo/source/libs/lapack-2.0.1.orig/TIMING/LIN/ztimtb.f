      SUBROUTINE ZTIMTB( LINE, NN, NVAL, NK, KVAL, NNS, NSVAL, NLDA,
...
*     .. External Subroutines ..
      EXTERNAL           ATIMCK, ATIMIN, DPRTBL, ZTBTRS, ZTIMMG
*     ..
*     .. Intrinsic Functions ..
...
*
                  IF( TIMSUB( 1 ) ) THEN
                     ...
                     DO 30 I = 1, NNS
                        ...
                        S1 = DSECND( )
   10                   CONTINUE
                        CALL ZTBTRS( UPLO, 'No transpose', 'Non-unit',
...
*
            IF( IN.EQ.1 .OR. CNAME.EQ.'ZTB   ' ) THEN

      SUBROUTINE CTIMTB( LINE, NN, NVAL, NK, KVAL, NNS, NSVAL, NLDA,
...
*     .. External Subroutines ..
      EXTERNAL           ATIMCK, ATIMIN, CTBTRS, CTIMMG, SPRTBL
*     ..
*     .. Intrinsic Functions ..
...
*
                  IF( TIMSUB( 1 ) ) THEN
                     ...
                     DO 30 I = 1, NNS
                        ...
                        S1 = SECOND( )
   10                   CONTINUE
                        CALL CTBTRS( UPLO, 'No transpose', 'Non-unit',
...
*
            IF( IN.EQ.1 .OR. CNAME.EQ.'CTB   ' ) THEN

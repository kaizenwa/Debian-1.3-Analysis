      SUBROUTINE ZTIMLQ( LINE, NM, MVAL, NVAL, NK, KVAL, NNB, NBVAL,
...
*     .. External Subroutines ..
     ...
     $                   ZGELQF, ZLACPY, ZLATMS, ZTIMMG, ZUNGLQ, ZUNMLQ
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          DBLE, MAX, MIN
*     ..
*     .. Data statements ..
      DATA               SUBNAM / 'ZGELQF', 'ZUNGLQ', 'ZUNMLQ' /
...
*
                  ...
                  S1 = DSECND( )
   10             CONTINUE
                  CALL ZGELQF( M, N, A, LDA, TAU, WORK, LW, INFO )
                  S2 = DSECND( )
                  TIME = S2 - S1
                  IC = IC + 1
...
*
                  ...
                  S1 = DSECND( )
   30             CONTINUE
                  CALL ZUNGLQ( MINMN, N, MINMN, B, LDA, TAU, WORK, LW,
     $                         INFO )
                  S2 = DSECND( )
                  TIME = S2 - S1
                  IC = IC + 1
...
*
                  TIME = ( TIME-UNTIME ) / DBLE( IC )
                  OPS = DOPLA( 'ZUNGLQ', MINMN, N, MINMN, 0, NB )
...
*
                        ...
                        DO 130 ITRAN = 1, 2
                           ...
                           S1 = DSECND( )
  110                      CONTINUE
                           CALL ZUNMLQ( SIDE, TRANS, M1, N1, K1, A, LDA,
...
*
                           TIME = ( TIME-UNTIME ) / DBLE( IC )
                           OPS = DOPLA( 'ZUNMLQ', M1, N1, K1, ISIDE-1,
     $                           NB )
                           RESLTS( INB, IM, ILDA,

...
*     .. Local Arrays ..
     ...
     $                   NXVAL( MAXVAL )
      DOUBLE PRECISION   A( LA, 3 ), D( 2*NMAX, 2 ),
...
*     .. External Subroutines ..
     ...
     $                   DTIMHR, DTIMLQ, DTIMMM, DTIMMV, DTIMPB, DTIMPO,
     $                   DTIMPP, DTIMPT, DTIMQL, DTIMQP, DTIMQR, DTIMRQ,
     $                   DTIMSP, DTIMSY, DTIMTB, DTIMTD, DTIMTP, DTIMTR
*     ..
*     .. Scalars in Common ..

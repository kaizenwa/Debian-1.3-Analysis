      SUBROUTINE CTIMRQ( LINE, NM, MVAL, NVAL, NK, KVAL, NNB, NBVAL,
...
*     .. External Subroutines ..
      EXTERNAL           ATIMCK, ATIMIN, CGERQF, CLACPY, CLATMS, CTIMMG,
     $                   CUNGRQ, CUNMRQ, ICOPY, SPRTB4, SPRTB5, XLAENV
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX, MIN, REAL
*     ..
*     .. Data statements ..
      DATA               SUBNAM / 'CGERQF', 'CUNGRQ', 'CUNMRQ' /
...
*
                  ...
                  S1 = SECOND( )
   10             CONTINUE
                  CALL CGERQF( M, N, A, LDA, TAU, WORK, LW, INFO )
                  S2 = SECOND( )
                  TIME = S2 - S1
                  IC = IC + 1
...
*
                  ...
                  S1 = SECOND( )
   30             CONTINUE
                  CALL CUNGRQ( MINMN, N, MINMN, B, LDA, TAU, WORK, LW,
     $                         INFO )
                  S2 = SECOND( )
                  TIME = S2 - S1
                  IC = IC + 1
...
*
                  TIME = ( TIME-UNTIME ) / REAL( IC )
                  OPS = SOPLA( 'CUNGRQ', MINMN, N, MINMN, 0, NB )
...
*
                        ...
                        DO 130 ITRAN = 1, 2
                           ...
                           S1 = SECOND( )
  110                      CONTINUE
                           CALL CUNMRQ( SIDE, TRANS, M1, N1, K1, A, LDA,
...
*
                           TIME = ( TIME-UNTIME ) / REAL( IC )
                           OPS = SOPLA( 'CUNMRQ', M1, N1, K1, ISIDE-1,
     $                           NB )
                           RESLTS( INB, IM, ILDA,

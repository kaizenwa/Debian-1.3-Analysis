      SUBROUTINE CTIMPO( LINE, NN, NVAL, NNS, NSVAL, NNB, NBVAL, NLDA,
...
*  =======
*
*  CTIMPO times CPOTRF, -TRS, and -TRI.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           ATIMCK, ATIMIN, CLACPY, CPOTRF, CPOTRI, CPOTRS,
...
*     .. Data statements ..
      DATA               UPLOS / 'U', 'L' /
      DATA               SUBNAM / 'CPOTRF', 'CPOTRS', 'CPOTRI' /
*     ..
...
*
                  ...
                  END IF
*
*                 Generate another matrix and factor it using CPOTRF so

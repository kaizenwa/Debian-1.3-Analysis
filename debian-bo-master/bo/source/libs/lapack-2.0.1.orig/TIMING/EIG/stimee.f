...
*      Includes SSYTRD, SSTEQR, and SSTERF
*
*  SVD (Singular Value Decomposition):
*      Includes SGEBRD, SORGBR, and SBDSQR
*
...
*
     ...
     $                LOGWRK, RESULT, MAXPRM, MAXT, MAXIN, OPCNTS,
     $                MAXPRM, MAXT, MAXIN, INFO )
         IF( INFO.NE.0 )
...
*
 ...
 9985 FORMAT( / ' LAPACK VERSION 2.0, released September 30, 1994 ' )
*
*     End of STIMEE
*
      END

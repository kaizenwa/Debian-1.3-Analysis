...
*          EISPACK:
*             9: HTRIDI (compare with CHETRD)
*            10: IMTQL1 (compare w/ CSTEQR -- VECT='N')
*            11: IMTQL2+HTRIBK (compare w/ CUNGTR+CSTEQR(VECT='V') )
...
*     .. Local Scalars ..
     ...
     $                   LDU, LGN, LIWEDC, LRWEDC, LWEDC, M, MTYPES, N,
     $                   NB, NSPLIT
...
*     .. External Subroutines ..
     ...
     $                   CSTEIN, CSTEQR, CUNGTR, CUNMTR, HTRIBK, HTRIDI,
     $                   IMTQL1, IMTQL2, SCOPY, SLASET, SPRTBE, SSTEBZ,
     $                   XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*     .. Data statements ..
     ...
     $                   'HTRIDI', 'IMTQL1', 'IMTQL2+HTRIBK' /
      DATA               INPARM / 2, 1, 2, 1, 2, 2, 1, 1, 1, 1, 1 /

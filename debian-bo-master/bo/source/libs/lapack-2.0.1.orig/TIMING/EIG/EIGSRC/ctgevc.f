...
*     .. Local Scalars ..
     ...
     $                   LSA, LSB
      INTEGER            I, IBEG, IEIG, IEND, IHWMNY, IM, IOPST, ISIDE,
     $                   ISRC, J, JE, JR
...
*
*              ------------------- Begin Timing Code -------------------
               OPS = OPS + ( REAL( 36*( N-JE )+8*( N-JE )*( N+1-JE )+3*
     $               ( N+1-IBEG )+1 )+REAL( IOPST ) )
*              -------------------- End Timing Code --------------------
            END IF
  140    CONTINUE
      END IF
...
*
*              ------------------- Begin Timing Code -------------------
               OPS = OPS + ( REAL( 30*( JE-2 )+8*( JE-1 )*( JE-2 )+3*
     $               IEND+22 )+REAL( IOPST ) )
*              -------------------- End Timing Code --------------------
            END IF
  250    CONTINUE

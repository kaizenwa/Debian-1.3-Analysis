...
*          12: DSTEDC(COMPQ='V')
*          EISPACK:
*          13: TRED1  (compare with DSYTRD)
*          14: IMTQL1 (compare w/ DSTEQR -- VECT='N')
*          15: IMTQL2 (compare w/ DSTEQR -- VECT='V')
*          16: TQLRAT (compare with DSTERF)
*          17: TRIDIB (compare with DSTEBZ -- RANGE='I')
*          18: BISECT (compare with DSTEBZ -- RANGE='V')
*          19: TINVIT (compare with DSTEIN)
...
*     .. External Subroutines ..
     ...
     $                   DPRTBE, DPTEQR, DSTEBZ, DSTEDC, DSTEIN, DSTEQR,
     $                   DSTERF, DSYTRD, IMTQL1, IMTQL2, TINVIT, TQLRAT,
     $                   TRED1, TRIDIB, XLAENV
*     ..
*     .. Intrinsic Functions ..
...
*     .. Data statements ..
     ...
     $                   'DSTEBZ(I)', 'DSTEBZ(V)', 'DSTEIN',
     $                   'DSTEDC(N)', 'DSTEDC(I)', 'DSTEDC(V)', 'TRED1',
...
*
  ...
  110          CONTINUE
     ...
     $                  ITYPE, 0, IOLDSD
            ...
            END IF
*
*           Time DSTEQR, SSTERF, DPTEQR, SSTEBZ, SSTEIN, SSTEDC for each
*           distinct LDA=LDAS(j)
*
            IF( TIMSUB( 2 ) .OR. TIMSUB( 3 ) .OR. TIMSUB( 4 ) .OR.
     $          TIMSUB( 5 ) .OR. TIMSUB( 6 ) .OR. TIMSUB( 7 ) .OR.

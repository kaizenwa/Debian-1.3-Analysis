...
extern long double _IO_strtold __P((const char *, char **));
extern char * _IO_ldtoa __P((long double __d, int __mode, int __ndigits,
				int *__decpt, int *__sign, char **__rve));
extern char * _IO_dtoa __P((double __d, int __mode, int __ndigits,
				int *__decpt, int *__sign, char **__rve));
extern int _IO_outfloat __P((long double __value, _IO_FILE *__sb, int __type,

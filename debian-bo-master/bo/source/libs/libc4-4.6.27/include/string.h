...
/* Copy N bytes of SRC to DEST (like memmove, but args reversed).  */
extern void bcopy __P ((__const __ptr_t __src, __ptr_t __dest, int __n));

/* Set N bytes of S to 0.  */
extern void bzero __P ((__ptr_t __s, int __n));

/* Compare N bytes of S1 and S2 (same as memcmp).  */
extern int bcmp __P ((__const __ptr_t __s1, __const __ptr_t __s2, int __n));
...
extern void swab __P ((__const __ptr_t __from, __ptr_t __to,
                        size_t __nbytes));
#endif

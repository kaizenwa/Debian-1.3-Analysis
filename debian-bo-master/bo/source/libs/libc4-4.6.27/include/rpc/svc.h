 ...
 */
extern bool_t svc_register __P ((SVCXPRT *__xpr, u_long __prog,
		u_long __vers, __dispatch_fn_t __dispatch, u_long __protocol));
...
extern bool_t	svc_sendreply __P ((SVCXPRT *__xprt,
...
extern void	svcerr_progvers __P ((SVCXPRT *__xprt,
			u_long __low_vers, u_long __high_vers));
extern void	svcerr_auth __P ((SVCXPRT *__xprt,
...
extern void	svc_run __P((void)); 	 /* never returns */
...
extern SVCXPRT *svcudp_bufcreate __P((int __sock, u_int sendsz,
		u_int __recvsz));

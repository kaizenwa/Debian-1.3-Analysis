...
extern __NORETURN void siglongjmp __P ((__const sigjmp_buf __env,
...
extern __NORETURN void __longjmp __P ((__const __jmp_buf __env,
				       int __val)) __NORETURN2;
extern __NORETURN void longjmp __P ((__const jmp_buf __env,
				     int __val)) __NORETURN2;
...
#ifdef	__USE_BSD
extern void __NORETURN _longjmp __P ((__const jmp_buf __env,
				      int __val)) __NORETURN2;
#endif /* Use BSD.  */

...
#define re_set_registers	__old_re_set_registers

#define re_compile_fastmap __old_re_compile_fastmap
#define re_compile_pattern __old_re_compile_pattern

#define re_match	__old_re_match
#define re_match_2	__old_re_match_2
#define re_search	__old_re_search
#define re_search_2	__old_re_search_2
#define regcomp		__old_regcomp
#define regerror	__old_regerror
#define regexec		__old_regexec
#define regfree		__old_regfree

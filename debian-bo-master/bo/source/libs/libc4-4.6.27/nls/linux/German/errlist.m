...
# Speicher-Adreßbereich oder Swapspace reicht nicht
...
# Nur block-strukturierte Geräte erlaubt

$ #16 Original Message:(Device or resource busy)
# Gerät oder Resource ist beschäftigt

$ #17 Original Message:(File exists)
# Datei existiert

$ #18 Original Message:(Cross-device link)
# Geräte-überschreitende Links sind nicht erlaubt
...
# Argument zu mathematischer Funktion außerhalb des Definitionsbereichs

$ #34 Original Message:(Math result not representable)
# Ergebnis mathematischer Funktion ist nicht darstellbar

$ #35 Original Message:(Resource deadlock would occur)
# Das würde zu einer Verklemmung führen

$ #36 Original Message:(File name too long)
# Dateiname zu lang

$ #37 Original Message:(No record locks available)
# Keine Satz-Sperren verfügbar
...
# Darauf müßte gewartet werden

$ #42 Original Message:(No message of desired type)
# Nachrichten dieses Typs gibt es hier nicht

$ #43 Original Message:(Identifier removed)
# Name (einer Semaphore) wurde gelöscht

$ #44 Original Message:(Channel number out of range)
# Kanal-Nummer außerhalb des erlaubten Wertebereiches
...
# Link-Nummer außerhalb des erlaubten Wertebereiches

$ #49 Original Message:(Protocol driver not attached)
# Protokoll Treiber nicht angeschlossen
...
# Ungültige Anforderungs-Beschreibung
...
# Kommunikations-Fehler beim Senden
...
# Ungültige Byte-Folge

$ #85 Original Message:(Interrupted system call should be restarted)
# Unterbrochener Betriebssystem-Aufruf sollte neu gestartet werden
...
# Netzwerkrechner ist nicht verfügbar

$ #113 Original Message:(No route to host)
# Keine Route zum Netzwerkrechner bekannt

$ #114 Original Message:(Operation already in progress)
# Operation ist bereits in Bearbeitung
...
# Stale NFS Datei-Zugriffs-Nummer

$ #117 Original Message:(Structure needs cleaning)
# Struktur muß gereinigt werden (needs cleaning)
...
# Ist eine named-type Datei

$ #121 Original Message:(Remote I/O error)
# Ein-/Ausgabe-Fehler auf einem entfernten Rechner

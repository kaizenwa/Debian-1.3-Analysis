...
long double _IO_strtold (char *, char **);
char * _IO_ldtoa(long double, int, int, int *, int *, char **);
...
static void esub(short unsigned int *a, short unsigned int *b, short unsigned int *c);
static void emul(short unsigned int *a, short unsigned int *b, short unsigned int *c);
static void ediv(short unsigned int *a, short unsigned int *b, short unsigned int *c);
...
static void einfin(register short unsigned int *x);
...
#if UNUSED
static void eabs(short unsigned int *x);
static void eldexp(short unsigned int *x, long int pwr2, short unsigned int *y);
static void efrexp(short unsigned int *x, long int *exp, short unsigned int *s);
static void eifrac(short unsigned int *x, long int *i, short unsigned int *frac);
static void ltoe(long int *lp, short unsigned int *y);
static void esqrt(short int *x, short int *y);
/* void elog(), eexp(), etanh(), epow(); */
static void asctoe(char *s, short unsigned int *y);
static void asctoe24(char *s, short unsigned int *y);
static void asctoe53(char *s, short unsigned int *y);
static void e24toasc(short unsigned int *x, char *string, int ndigs);
static void e53toasc(short unsigned int *x, char *string, int ndigs);
static void e64toasc(short unsigned int *x, char *string, int ndigs);
static void eremain(short unsigned int *a, short unsigned int *b, short unsigned int *c);
static void einit(void);
static void eadd(short unsigned int *a, short unsigned int *b, short unsigned int *c);
static void asctoe64(char *s, short unsigned int *y);
static void etoe64(short unsigned int *x, short unsigned int *e);
static void etoe53(short unsigned int *x, short unsigned int *e);
static void etoe24(short unsigned int *x, short unsigned int *e);
...
#if UNUSED
/* 5.0E-1 */
static unsigned short ehalf[NE] =
 {0x0000, 0x0000, 0x0000, 0x0000,
  0x0000, 0x0000, 0x0000, 0x0000, 0x8000, 0x3ffe,};

/* 2.0E0 */
static unsigned short etwo[NE] =
 {0x0000, 0x0000, 0x0000, 0x0000,
  0x0000, 0x0000, 0x0000, 0x0000, 0x8000, 0x4000,};

/* 3.2E1 */
static unsigned short e32[NE] =
 {0x0000, 0x0000, 0x0000, 0x0000,
  0x0000, 0x0000, 0x0000, 0x0000, 0x8000, 0x4004,};

/* 6.93147180559945309417232121458176568075500134360255E-1 */
static unsigned short elog2[NE] =
 {0x40f3, 0xf6af, 0x03f2, 0xb398,
  0xc9e3, 0x79ab, 0150717, 0013767, 0130562, 0x3ffe,};

/* 1.41421356237309504880168872420969807856967187537695E0 */
static unsigned short esqrt2[NE] =
 {0x1d6f, 0xbe9f, 0x754a, 0x89b3,
  0x597d, 0x6484, 0174736, 0171463, 0132404, 0x3fff,};

/* 3.14159265358979323846264338327950288419716939937511E0 */
static unsigned short epi[NE] =
 {0x2902, 0x1cd1, 0x80dc, 0x628b,
  0xc4c6, 0xc234, 0020550, 0155242, 0144417, 0040000,};
  
/* 5.7721566490153286060651209008240243104215933593992E-1 */
static unsigned short eeul[NE] = {
...
static unsigned short eoneopi[NE] = {
 ...
 */
static int rndprc = NBITS;
/* extern int rndprc; */

static void eaddm(short unsigned int *x, short unsigned int *y);
static void esubm(short unsigned int *x, short unsigned int *y);
static void emdnorm(short unsigned int *s, int lost, int subflg, long int exp, int rcntrl);
static void asctoeg(char *ss, short unsigned int *y, int oprec);
...
static void eadd1(short unsigned int *a, short unsigned int *b, short unsigned int *c);
...
#if UNUSED
static void etoe113(short unsigned int *x, short unsigned int *e)
{
 ...
 */
#if UNUSED
static void eround(short unsigned int *x, short unsigned int *y)
{
...
*/
#if UNUSED
static void ultoe(long unsigned int *lp, short unsigned int *y)
...
*/
#if UNUSED
static void euifrac(short unsigned int *x, long unsigned int *i, short unsigned int *frac)
{
unsigned short xi[NI];
int j, k;
unsigned long ll;
...
#if UNUSED
static void e113toasc (short unsigned int *x, char *string, int ndigs)
{
unsigned short w[NI];
...
static int outformat = -1;
 ...
 char *
_IO_ldtoa(long double d, int mode, int ndigits, int *decpt, int *sign, char **rve)
{
unsigned short e[NI];
char *s, *p;
int k;

e64toe( (unsigned short *)&d, e );
if( eisneg(e) )
        *sign = 1;
else
        *sign = 0;
...
static void etoasc(short unsigned int *x, char *string, int ndigits)
{
long digit;
...
#if UNUSED
static void asctoe113 (char *s, short unsigned int *y)
{
asctoeg( s, y, 113 );
}
#endif /* UNUSED */
...
/* This string input routine is for unix library.  */
static int lenldstr;

long double _IO_strtold (char *s, char **se)
{
  long double x;

  asctoeg( s, (unsigned short *)&x, 64 );
  if (se)
    *se = s + lenldstr;
  return x;
}
...
#ifdef IBMPC
static unsigned short nan113[8] = {0, 0, 0, 0, 0, 0, 0xc000, 0xffff};
static unsigned short nan64[6] = {0, 0, 0, 0xc000, 0xffff, 0};
static unsigned short nan53[4] = {0, 0, 0, 0xfff8};
static unsigned short nan24[2] = {0, 0xffc0};
#endif

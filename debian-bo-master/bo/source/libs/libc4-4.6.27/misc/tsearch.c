...
*/
PTR
DEFUN(tsearch, (key, vrootp, compar),
	register CONST PTR key AND PTR *vrootp AND
...
PTR
DEFUN(tfind, (key, vrootp, compar),
	register CONST PTR key AND CONST PTR *vrootp AND
	register int EXFUN((*compar), (CONST PTR, CONST PTR)))
{
    register node **rootp = (node **) vrootp;
...
*/
PTR
DEFUN(tdelete, (key, vrootp, compar),
	register CONST PTR key AND PTR *vrootp AND
	register int EXFUN((*compar), (CONST PTR, CONST PTR)))
{
    node *p;
...
*/
static void
DEFUN(trecurse, (vroot, action, level),
	register CONST PTR vroot AND
	register void EXFUN((*action), (CONST PTR, VISIT, int)) AND
	register int level)
{
...
*/
void
DEFUN(twalk, (vroot, action),
	register CONST PTR vroot AND
	register void EXFUN((*action), (CONST PTR, VISIT, int)))
{

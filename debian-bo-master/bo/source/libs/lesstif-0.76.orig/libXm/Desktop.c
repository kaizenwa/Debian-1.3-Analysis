/**
 *
 * $Id: Desktop.c,v 1.8 1997/01/07 02:35:38 miers Exp $
 *
...
static char rcsid[] = "$Id: Desktop.c,v 1.8 1997/01/07 02:35:38 miers Exp $";
...
static void DesktopInsertChild(Widget w);
static void DesktopDeleteChild(Widget w);
...
XmDesktopClassRec xmDesktopClassRec = {
    ...
    {
        /* child_class           */ NULL,
        /* insert_child          */ DesktopInsertChild,
        /* delete_child          */ DesktopDeleteChild,
        /* extension             */ NULL
    }
};
...
class_initialize()
{
    XdbDebug(__FILE__, NULL, "Desktop class initialize\n");
}
...
{
    XdbDebug(__FILE__, NULL, "Desktop class part initialize\n");
	   ...
	   Cardinal *num_args)
{
    ...
    XdbDebug(__FILE__, new_w, "Desktop initialize\n");
...
destroy(Widget w)
{
    ...
    XdbDebug(__FILE__, w, "Desktop destroy\n");
...
set_values(Widget current,
	   ...
	   Cardinal *num_args)
{
    XdbDebug(__FILE__, new_w, "Desktop set_values\n");

/**
 *
 * $Id: DragC.h,v 1.2 1996/08/29 00:05:58 miers Exp $
 *
...
#ifndef XM_DRAGCONTROLLER_H
#define XM_DRAGCONTROLLER_H
...
extern Widget XmDragStart(Widget w,
			  XEvent *event,
			  ArgList args,
			  Cardinal numArgs);
...
extern Boolean XmTargetsAreCompatible(Display *dpy,
				      Atom *exportTargets,

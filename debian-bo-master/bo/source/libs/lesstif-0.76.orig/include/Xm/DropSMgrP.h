/**
 *
 * $Id: DropSMgrP.h,v 1.2 1996/08/29 00:06:09 miers Exp $
 *
...
#ifndef XM_DROPSMGR_P_H
#define XM_DROPSMGR_P_H
...
extern void _XmDSMUpdate(XmDropSiteManagerObject dsm,
			 XtPointer clientData,
			 XtPointer callData);
extern int _XmDSMGetTreeFromDSM(XmDropSiteManagerObject dsm,
				Widget shell,
				XtPointer dataPtr);
extern Boolean _XmDropSiteShell(Widget widget);
extern Boolean _XmDropSiteWrapperCandidate(Widget widget);
extern Widget _XmGetActiveDropSite(Widget widget);
extern void _XmSyncDropSiteTree(Widget shell);

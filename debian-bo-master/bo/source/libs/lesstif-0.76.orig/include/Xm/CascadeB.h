/**
 *
 * $Id: CascadeB.h,v 1.2 1996/08/29 00:05:45 miers Exp $
 *
...
#ifndef XM_CASCADEB_H
#define XM_CASCADEB_H
...
extern Widget XmCreateCascadeButton(Widget parent, char *name, Arg *arglist, Cardinal argcount);

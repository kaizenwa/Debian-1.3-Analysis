/**
 * 
 * $Id: DrawingA.h,v 1.2 1996/08/29 00:06:03 miers Exp $
 * 
...
#ifndef XM_DRAWINGA_H
#define XM_DRAWINGA_H
...
extern Widget XmCreateDrawingArea (Widget parent, char *name, Arg *arglist, Cardinal argcount);

/**
 *
 * $Id: XmP.h,v 1.5 1996/09/03 05:57:04 u27113 Exp $
 *
...
#define XmConstraintPartOffset(part, var) \
    ((part##Index) << XmHALFLONGBITS) + XtOffsetOf(part##ConstraintPart, var)

#define XmGetPartOffset(r, off) \
    ((r)->resource_offset & 0xffff) + \
	(*(off))[(r)->resource_offset >> XmHALFLONGBITS];
...
void _XmManagerHighlightPixmapDefault(Widget widget, int offset,
				      XrmValue *value);
void _XmGetDefaultThresholdsForScreen(Widget widget, int offset,
				      XrmValue *value);

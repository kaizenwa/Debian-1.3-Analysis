/**
 *
 * $Id: BulletinBP.h,v 1.4 1996/08/29 00:05:43 miers Exp $
 *
...
#ifndef XM_BULLETINB_P_H
#define XM_BULLETINB_P_H
...
void _XmBulletinBoardCancel(Widget wid, XEvent *event,
			    String *params, Cardinal *numParams);
void _XmBulletinBoardMap(Widget wid, XEvent *event,
                         String *params, Cardinal *numParams);

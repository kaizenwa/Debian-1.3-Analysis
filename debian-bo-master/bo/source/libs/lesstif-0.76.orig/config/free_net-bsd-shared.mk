#
# Makefile for the GNU Lesstif FreeBSD/NetBSD shared libraries
#
...
${GPROF_LIB}:: creategprof ${GPROF_OBJS}
	ar cr ${GPROF_LIB} ${GPROF_OBJS}
	ranlib ${GPROF_LIB}

clean::
	rm -f ${GPROF_LIB} ${GPROF_OBJS}

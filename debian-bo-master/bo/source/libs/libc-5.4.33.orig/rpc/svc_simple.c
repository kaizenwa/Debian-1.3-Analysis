...
#ifdef __STDC__
int          registerrpc  ( u_long, u_long, u_long, char *(*progname)(char *),
                           xdrproc_t, xdrproc_t );
...
#endif
{
...
#if NLS
		(void) fprintf(stderr,
		       catgets(_libc_cat, RpcMiscSet, RpcMiscCantReassignProc,
...
#if NLS
	    	(void) fprintf(stderr, catgets(_libc_cat, RpcMiscSet,
				       RpcMiscCantRegisterProg,
	...
	if (pl == NULL) {
#if NLS
		(void) fprintf(stderr, "registerrpc: %s\n",
			       catgets(_libc_cat, RpcMiscSet,

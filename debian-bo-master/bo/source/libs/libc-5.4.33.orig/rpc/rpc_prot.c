...
#ifdef __STDC__
bool_t xdr_opaque_auth( register XDR *, register struct opaque_auth * );
bool_t xdr_accepted_reply( register XDR *, register struct accepted_reply * );
bool_t xdr_rejected_reply( register XDR *, register struct rejected_reply * );
bool_t xdr_replymsg( register XDR *, register struct rpc_msg * );
bool_t xdr_callhdr( register XDR *, register struct rpc_msg * );
static void accepted( register enum accept_stat, register struct rpc_err * );
static void rejected( register enum reject_stat, register struct rpc_err * );
void _seterr_reply( register struct rpc_msg *, register struct rpc_err * );
#else
...
#endif
{
	...
	case RPC_MISMATCH:
	case Uli_RPC_VERSMISMATCH:	/* changed from RPC_MISMATCH -- Uli */

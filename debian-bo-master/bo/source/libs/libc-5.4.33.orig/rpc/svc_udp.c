...
#ifdef __STDC__
SVCXPRT *svcudp_bufcreate( register int, u_int, u_int );
SVCXPRT *svcudp_create( int );
static enum xprt_stat svcudp_stat( SVCXPRT * );
static bool_t svcudp_recv( register SVCXPRT *, struct rpc_msg * );
static bool_t svcudp_reply( register SVCXPRT *, struct rpc_msg * );
...
static bool_t svcudp_destroy( SVCXPRT * );
#else
...
#endif
{
	...
	if (su->su_cache != NULL) {
#if NLS
		CACHE_PERROR(catgets(_libc_cat, RpcMiscSet,
				     RpcMiscCacheAlreadyEnabled,

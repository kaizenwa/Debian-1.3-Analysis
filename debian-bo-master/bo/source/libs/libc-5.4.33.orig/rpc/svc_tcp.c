...
#ifdef __STDC__
SVCXPRT               *svctcp_create      ( register int, u_int, u_int );
SVCXPRT               *svcfd_create       ( int, u_int, u_int );
static SVCXPRT        *makefd_xprt        ( int, u_int, u_int );
static enum xprt_stat  rendezvous_stat    ( SVCXPRT * );
static void            svctcp_destroy     ( register SVCXPRT * );
static bool_t          rendezvous_request ( register SVCXPRT *,
                                           struct rpc_msg * );
static int             readtcp            ( register SVCXPRT *, caddr_t,
                                           register int );
static int             writetcp           ( register SVCXPRT *, caddr_t, int );
static enum xprt_stat  svctcp_stat        ( SVCXPRT * );
static bool_t          svctcp_recv        ( SVCXPRT *,
...
static bool_t          svctcp_reply       ( SVCXPRT *,
                                           register struct rpc_msg * );
#else
 ...
 */
static bool_t rendezvous_request( register SVCXPRT *, struct rpc_msg * );
static enum xprt_stat   rendezvous_stat( SVCXPRT * );
...
#endif
{
	...
	xdrrec_create(&(cd->xdrs), sendsize, recvsize,
	    (caddr_t)xprt, (void *)readtcp, (void *)writetcp);
	xprt->xp_p2 = NULL;
...
#ifdef __STDC__
static bool_t
rendezvous_request( register SVCXPRT *xprt, struct rpc_msg *dummy )
#else
static bool_t

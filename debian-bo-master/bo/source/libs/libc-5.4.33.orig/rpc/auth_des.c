...
extern bool_t   xdr_authdes_verf        ( register XDR *,
                                         register struct authdes_verf * );
extern int      key_encryptsession  __P (( char *, des_block * ));
extern int      rtime                   ( struct sockaddr_in *,
                                         struct timeval *,
                                         struct timeval * );
 ...
 */
#ifdef __STDC__
AUTH            *authdes_create    ( char *, u_int, struct sockaddr *,
                                    des_block * );
...
#ifdef __STDC__
AUTH *
authdes_create( char *servername, u_int window,

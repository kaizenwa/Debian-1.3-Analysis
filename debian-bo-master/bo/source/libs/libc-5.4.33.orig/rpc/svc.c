...
bool_t svc_register                  ( SVCXPRT *, u_long, u_long,
                                       void (*dispatch), u_long );
void   svc_unregister                ( u_long, u_long );
static struct svc_callout *svc_find  ( u_long, u_long, struct svc_callout ** );
bool_t svc_sendreply                 ( register SVCXPRT *,
                                       xdrproc_t, caddr_t );
void   svcerr_noproc                 ( register SVCXPRT * );
void   svcerr_decode                 ( register SVCXPRT * );
void   svcerr_systemerr              ( register SVCXPRT * );
void   svcerr_auth                   ( SVCXPRT *, enum auth_stat );
void   svcerr_weakauth               ( SVCXPRT * );
void   svcerr_noprog                 ( register SVCXPRT * );
void   svcerr_progvers               ( register SVCXPRT *, u_long, u_long );
void   svc_getreq                    ( int );
#ifdef FD_SETSIZE
void   svc_getreqset                 ( fd_set * );
#else
void   svc_getreqset                 ( int * );
#endif	/* FD_SETSIZE */
#else	/* __STDC__ */
void   xprt_register();

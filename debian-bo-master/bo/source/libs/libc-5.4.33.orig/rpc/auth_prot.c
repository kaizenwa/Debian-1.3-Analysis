...
#endif
{
	...
	if (xdr_u_long(xdrs, &(p->aup_time))
	    ...
	    && (sizeof (uid_t) == sizeof (short)
		? xdr_short(xdrs, (short *) &(p->aup_uid))
		: xdr_int(xdrs, (int *) &(p->aup_uid)))
	    && (sizeof (gid_t) == sizeof (short)
		? xdr_short(xdrs, (short *) &(p->aup_gid))
		: xdr_int(xdrs, (int *) &(p->aup_gid)))
	    && (sizeof (gid_t) == sizeof (short)
		? xdr_array(xdrs, (caddr_t *)&(p->aup_gids),
		    &(p->aup_len), NGRPS, sizeof (short), (xdrproc_t)xdr_short)
		: xdr_array(xdrs, (caddr_t *)&(p->aup_gids),

...
void _IO_str_init_static( _IO_FILE *, char *, int, char * );
void _IO_str_init_readonly( _IO_FILE *, const char *, int );
int _IO_str_overflow( register _IO_FILE *, int );
int _IO_str_underflow( register _IO_FILE * );
_IO_ssize_t _IO_str_count( register _IO_FILE * );
_IO_pos_t _IO_str_seekoff( register _IO_FILE *, _IO_off_t, int, int );
int _IO_str_pbackfail( register _IO_FILE *, int );

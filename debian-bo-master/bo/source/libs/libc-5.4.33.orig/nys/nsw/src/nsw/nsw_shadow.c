/*
** nsw_shadow.c           Shadow cover routines for the Name Service Switch
**
...
#define RETOBJTYPE struct spwd *
#define NSWENTRY   "shadow"
#define FUNCOBJENT spent

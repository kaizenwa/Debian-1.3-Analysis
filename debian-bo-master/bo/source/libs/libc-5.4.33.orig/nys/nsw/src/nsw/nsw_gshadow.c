/*
** nsw_gshadow.c           GShadow cover routines for the Name Service Switch
**
...
#define RETOBJTYPE struct sgrp *
#define NSWENTRY   "gshadow"
#define FUNCOBJENT sgent

/*
** nsw_rpc.c          RPC Services cover routines for the Name Service Switch
**
...
#define RETOBJTYPE struct rpcent *
#define NSWENTRY   "rpc"
#define FUNCOBJENT rpcent
...
#define FUNCNAME getrpcbynumber

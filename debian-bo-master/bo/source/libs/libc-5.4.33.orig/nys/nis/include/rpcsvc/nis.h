...
#ifndef __RPCSVC_NIS_H__
#define __RPCSVC_NIS_H__
...
bool_t xdr_nis_attr(XDR *, nis_attr*);

typedef char *nis_name;
bool_t xdr_nis_name(XDR *, nis_name*);
...
bool_t xdr_zotypes(XDR *, zotypes*);
...
bool_t xdr_oar_mask(XDR *, oar_mask*);
...
bool_t xdr_endpoint(XDR *, endpoint*);
...
bool_t xdr_directory_obj(XDR *, directory_obj*);
#define EN_BINARY 1
#define EN_CRYPT 2
#define EN_XDR 4
...
bool_t xdr_entry_col(XDR *, entry_col*);
...
bool_t xdr_entry_obj(XDR *, entry_obj*);
...
bool_t xdr_group_obj(XDR *, group_obj*);
...
bool_t xdr_link_obj(XDR *, link_obj*);
#define TA_BINARY 1
#define TA_CRYPT 2
#define TA_XDR 4
...
bool_t xdr_table_col(XDR *, table_col*);
...
bool_t xdr_table_obj(XDR *, table_obj*);
...
bool_t xdr_objdata(XDR *, objdata*);
...
bool_t xdr_nis_oid(XDR *, nis_oid*);
...
bool_t xdr_nis_object(XDR *, nis_object*);
...
bool_t xdr_nis_error(XDR *, nis_error*);
...
bool_t xdr_ns_request(XDR *, ns_request*);
...
bool_t xdr_ib_request(XDR *, ib_request*);
...
bool_t xdr_ping_args(XDR *, ping_args*);
...
bool_t xdr_log_entry_t(XDR *, log_entry_t*);
...
bool_t xdr_log_entry(XDR *, log_entry*);
...
bool_t xdr_log_result(XDR *, log_result*);
...
bool_t xdr_cp_result(XDR *, cp_result*);
...
bool_t xdr_nis_tag(XDR *, nis_tag*);
...
bool_t xdr_nis_taglist(XDR *, nis_taglist*);
...
bool_t xdr_dump_args(XDR *, dump_args*);
...
bool_t xdr_fd_args(XDR *, fd_args*);
...
bool_t xdr_fd_result(XDR *, fd_result*);

...
extern ufc_long *ufc_doit  (ufc_long, ufc_long, ufc_long,
                            ufc_long, ufc_long);
...
#if 0
/* We don't need the warning for this: */

 ...
 *
 * SCCS: @(#) tkMacClipboard.c 1.16 97/01/21 10:30:55
 */
 ...
 *	If the selection is CLIPBOARD.  On the Mac this is just a
 *	stub.
 *
 * Results:
 *	None.
...
TkSuspendClipboard()
{
    ...
    Tk_ClearSelection((Tk_Window) tkMainWindowList->winPtr, 
        Tk_InternAtom((Tk_Window) tkMainWindowList->winPtr, "CLIPBOARD"));

...
proc tixDirTree::InitWidgetRec {w} {
    ...
    tixDirTree::SetDir $w [tixFileIntName $data(-directory)]
}
...
#
#
proc tixDirList::AddAncestors {w dir} {
    upvar #0 $w data
...
proc tixDirTree::CallBrowseCmd {w ent} {
	...
	tixEvalCmdBinding $w $data(-browsecmd) bind [list $data(-directory)]
    }
}
...
proc tixDirTree::SetDir {w intName} {
    ...
    set data(-directory)  [tixNativeName $intName]
}

/*
  $Id: check_user.c,v 1.1 1996/11/10 21:19:30 morgan Exp $
  ...
  # check authorization
  check   auth       required     /lib/security/pam_unix_auth.so
  check   account    required     /lib/security/pam_unix_acct.so

...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("maximize"), maximize_bits, maximize_width, maximize_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("act_fold"), act_fold_bits, act_fold_width, act_fold_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("balarrow"), balarrow_bits, balarrow_width, balarrow_height);
}
{
...
static char cbxarrow_bits[] = {
   ...
   0xfe, 0x03, 0xfe, 0x03};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("cbxarrow"), cbxarrow_bits, cbxarrow_width, cbxarrow_height);
}
{
...
static unsigned char ck_def_bits[] = {
   ...
   0xff, 0x1f};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("ck_def"), ck_def_bits, ck_def_width, ck_def_height);
}
{
...
static unsigned char ck_off_bits[] = {
   ...
   0xff, 0x1f};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("ck_off"), ck_off_bits, ck_off_width, ck_off_height);
}
{
...
static unsigned char ck_on_bits[] = {
   ...
   0xff, 0x1f};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("ck_on"), ck_on_bits, ck_on_width, ck_on_height);
}
{
...
static char cross_bits[] = {
   ...
   0x0e, 0x1c, 0x06, 0x18};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("cross"), cross_bits, cross_width, cross_height);
}
{
#define decr_width 7
...
static char decr_bits[] = {
   0x7f, 0x3e, 0x1c, 0x08};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("decr"), decr_bits, decr_width, decr_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("drop"), drop_bits, drop_width, drop_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("file"), file_bits, file_width, file_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("folder"), folder_bits, folder_width, folder_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("harddisk"), harddisk_bits, harddisk_width, harddisk_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("hourglas"), hourglas_bits, hourglass_width, hourglas_height);
}
{
#define incr_width 7
...
static char incr_bits[] = {
   0x08, 0x1c, 0x3e, 0x7f};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("incr"), incr_bits, incr_width, incr_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("minimize"), minimize_bits, minimize_width, minimize_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("minus"), minus_bits, minus_width, minus_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("minusarm"), minusarm_bits, minusarm_width, minusarm_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("network"), network_bits, network_width, network_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("openfile"), openfile_bits, openfile_width, openfile_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("openfold"), openfold_bits, openfold_width, openfold_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("plus"), plus_bits, plus_width, plus_height);
}
{
/* XPM */
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("plusarm"), plusarm_bits, plusarm_width, plusarm_height);
}
{
/* XPM */
...
static unsigned char resize1_bits[] = {
   ...
   0xc0, 0x1f};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("resize1"), resize1_bits, resize1_width, resize1_height);
}
{
...
static unsigned char resize2_bits[] = {
   ...
   0x7f, 0x00};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("resize2"), resize2_bits, resize2_width, resize2_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("restore"), restore_bits, restore_width, restore_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("srcfile"), srcfile_bits, srcfile_width, srcfile_height);
}
{
/* XPM */
...
static unsigned char system_bits[] = {
   ...
   0x00, 0x00, 0x00, 0x00, 0x00, 0x00};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("system"), system_bits, system_width, system_height);
}
{
...
Tk_DefineBitmap(Et_Interp, Tk_GetUid("textfile"), textfile_bits, textfile_width, textfile_height);
}
{
/* XPM */
...
static char tick_bits[] = {
   ...
   0x1c, 0x00, 0x08, 0x00};
Tk_DefineBitmap(Et_Interp, Tk_GetUid("tick"), tick_bits, tick_width, tick_height);
}
{
/* XPM */

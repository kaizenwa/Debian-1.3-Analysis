/* $Id: cheap.c,v 2.50 1996/08/24 10:47:21 akool Exp akool $
 *
    ...
    if (zone == 5) 	       	       	 	      /* Angrenzende Laender */
      ...
      if (takt == 6) { /* Feiertage */
        if ((tm->tm_hour > 4) && (tm->tm_hour < 21))
          ...
          return(gebuehr[0][zone - 1][3]);
      }
      else
        return(gebuehr[0][zone - 1][takt - 1]);
    } /* else */
  } /* else */
} /* cheap96 */

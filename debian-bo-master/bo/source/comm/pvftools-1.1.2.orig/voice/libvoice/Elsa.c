...
char *libvoice_Elsa_c = "$Id: Elsa.c,v 1.13 1997/02/20 06:51:53 marc Exp $";
...
static int Elsa_answer_phone (void)
     ...
     if (voice_command("ATA", "VCON") != VMA_USER_1)
          {
...
static int Elsa_play_file (int fd)
     ...
     sprintf(buffer, "AT#VGT=%d", cvd.speaker_play_volume.d.i * 127 / 100 +
      128);

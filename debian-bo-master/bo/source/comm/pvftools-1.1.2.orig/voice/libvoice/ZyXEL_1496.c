...
char *libvoice_ZyXEL_1496_c = "$Id: ZyXEL_1496.c,v 1.23 1996/11/25 19:19:38 marc Exp $";
...
static int ZyXEL_1496_init (void)
     ...
     /*
      * AT+VGT=x - Set volume for transmitted voice samples.
      */

     sprintf(buffer, "AT+VGT=%d", cvd.speaker_play_volume .d.i * 255 / 100);

     if (voice_command(buffer, "OK") != VMA_USER_1)
          lprintf(L_WARN, "setting volume didn't work");

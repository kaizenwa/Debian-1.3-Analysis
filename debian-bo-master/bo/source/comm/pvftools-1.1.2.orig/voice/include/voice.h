...
char *voice_h = "$Id: voice.h,v 1.20 1997/01/22 07:35:12 marc Exp $";
#endif
...
#define INTERNAL_SPEAKER    (0x0005)
#define LOCAL_HANDSET       (0x0006)
...
#define VMA_ERROR        (0x2002)
#define VMA_FAX          (0x2003)
#define VMA_FCON         (0x2004)
#define VMA_FCO          (0x2005)
#define VMA_NO_ANSWER    (0x2006)
#define VMA_NO_CARRIER   (0x2007)
#define VMA_NO_DIAL_TONE (0x2008)
#define VMA_OK           (0x2009)
#define VMA_RINGING      (0x200a)
#define VMA_RING_1       (0x200b)
#define VMA_RING_2       (0x200c)
#define VMA_RING_3       (0x200d)
#define VMA_RING_4       (0x200e)
#define VMA_RING_5       (0x200f)
#define VMA_RING         (0x2010)
#define VMA_VCON         (0x2011)

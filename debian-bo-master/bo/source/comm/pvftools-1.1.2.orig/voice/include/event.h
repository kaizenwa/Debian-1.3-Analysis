...
#ifdef MAIN
char *voice_event_h = "$Id: event.h,v 1.6 1997/01/14 06:50:00 marc Exp $";
#endif
...
#define NO_DIAL_TONE             (0x200c)
#define NO_VOICE_ENERGY          (0x200d)
#define RING_DETECTED            (0x200e)
#define RINGBACK_DETECTED        (0x200f)
#define RECEIVED_DTMF            (0x2010)
#define SILENCE_DETECTED         (0x2011)
#define SIT_TONE                 (0x2012)
#define TDD_DETECTED             (0x2013)
#define VOICE_DETECTED           (0x2014)

...
char *libvoice_config_c = "$Id: config.c,v 1.13 1997/01/14 06:50:10 marc Exp $";
...
struct conf_voice_data cvd =
     ...
     {"speaker_answer_volume", {SPEAKER_ANSWER_VOLUME}, CT_INT, C_PRESET},
     ...
     {"speaker_play_volume", {SPEAKER_PLAY_VOLUME}, CT_INT, C_PRESET},

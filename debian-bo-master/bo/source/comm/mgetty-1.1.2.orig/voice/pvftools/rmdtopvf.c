...
char *rmdtopvf_c = "$Id: rmdtopvf.c,v 1.6 1997/02/20 06:52:03 marc Exp $";
char *program_name;
...
static void supported_formats (void)
     ...
     fprintf(stderr, " - Elsa\n   2, 3 and 4 bit Rockwell ADPCM\n\n");
     fprintf(stderr, " - ISDN4Linux\n   2, 3 and 4 bit ZyXEL ADPCM\n\n");
     fprintf(stderr, " - Rockwell\n   2, 3 and 4 bit Rockwell ADPCM\n\n");
     fprintf(stderr, " - ZyXEL 1496\n   2, 3 and 4 bit ZyXEL ADPCM\n\n");
     fprintf(stderr, " - ZyXEL 2864\n   2, 3 and 4 bit ZyXEL ADPCM\n\n");
     exit(ERROR);
     }

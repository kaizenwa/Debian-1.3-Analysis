...
char *libvoice_ZyXEL_2864_c = "$Id: ZyXEL_2864.c,v 1.16 1997/02/20 06:51:55 marc Exp $";
...
static int ZyXEL_2864_init (void)
     ...
     /*
      * ATL - Set volume for transmitted voice samples.
      */

     sprintf(buffer, "AT+VGT=%d", cvd.speaker_play_volume .d.i * 144 / 100 +
      56);

     if (voice_command(buffer, "OK") != VMA_USER_1)
          lprintf(L_WARN, "setting transmit gain didn't work");

     if (voice_command("AT+VGR=128", "OK") != VMA_USER_1)

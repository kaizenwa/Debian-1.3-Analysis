...
/*
 * Define POSIX_SETPGRP if your system's setpgrp call is posix
 * compliant.  Ie takes no arguments.  This makes it use
 * setpgid which you should make sure works ok.
 * Nb most BSD systems do not have posix compliant setpgrp calls
 */
#define POSIX_SETPGRP

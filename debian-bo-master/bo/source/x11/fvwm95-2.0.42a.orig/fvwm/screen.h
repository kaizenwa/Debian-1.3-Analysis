...
typedef struct ScreenInfo
{
  ...
  ColorPair WinColors; 	/* standard fore/back colors: win/menu */
  ColorPair WinRelief;

  ColorPair StdColors;    /* normal window default title bar colors */
  ColorPair HiColors; 	  /* selected window fore/back title bar colors */

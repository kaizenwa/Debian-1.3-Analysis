...
static struct key_geometry sun4sw_geom_row0 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun4sw_geom_row1 [] = {
 {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
...
static struct key_geometry sun4sw_geom_row2 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun4sw_geom_row3 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun4sw_geom_row4 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun4sw_geom_row5 [] = {
 {14, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {63, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {14, 7}, {7, 7}
};

static struct keyboard_row_geometry sun4sw_geom_rows [] = {
...
static struct keyboard_geometry sun4sw_geom = {

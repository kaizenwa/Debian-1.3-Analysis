...
static struct key_geometry NeXT_geom_row0 [] = {
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {10, 7}, {25, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry NeXT_geom_row1 [] = {
 {10, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {25, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry NeXT_geom_row2 [] = {
 {13, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {11, 7}, {25, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry NeXT_geom_row3 [] = {
 {16, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {15, 7}, {9, 0},
 {7, 7}, {9, 0}, {7, 7}, {7, 7}, {7, 7}, {7, 14}
};

static struct key_geometry NeXT_geom_row4 [] = {
 {10, 7}, {10, 7}, {61, 7}, {10, 7}, {10, 7}, {2, 0},
 {7, 7}, {7, 7}, {7, 7}, {2, 0},
 {14, 7}, {7, 7}
};

static struct keyboard_row_geometry NeXT_geom_rows [] = {
...
static struct keyboard_geometry NeXT_geom = {

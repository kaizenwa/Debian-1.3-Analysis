/* xkeycaps, Copyright (c) 1991, 1992, 1993, 1994 Jamie Zawinski <jwz@netscape.com>
 *
 * This file describes the key surfaces of a "Maxi-Switch 2192004"
 * PC-style keyboard under Linux with XFree86.
 * This differs from the keyboard we know as `pc101' in the placement
 * of the "\ and |" key.
 * Generated by Jamie Zawinski <jwz@netscape.com>
 */

static struct default_keycode_map linux101_3_map [] = {

  /* this key has a keycode but no keysym in the default map. */
  { 111, 0,		0 },		/* Print Screen */

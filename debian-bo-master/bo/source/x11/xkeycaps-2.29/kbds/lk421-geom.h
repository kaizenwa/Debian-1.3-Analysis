...
static struct key_geometry lk421_geom_row0 [] = {
 {1, 0}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry lk421_geom_row1 [] = {
 {1, 0}, {10, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {18, 7}
};

static struct key_geometry lk421_geom_row2 [] = {
 {1, 0}, {14, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry lk421_geom_row3 [] = {
 {18, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {17, 7}
};

static struct key_geometry lk421_geom_row4 [] = {
 {21, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {21, 7}
};

static struct key_geometry lk421_geom_row5 [] = {
 {8, 0}, {7, 7}, {14, 7}, {49, 7}, {14, 7}, {14, 7}
};

static struct key_geometry lk421_geom_row7 [] = {
 {1, 0}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry lk421_geom_row8 [] = {
 {46, 0}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry lk421_geom_row9 [] = {
 {50, 0}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry lk421_geom_row10 [] = {
 {53, 0}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {14, 0}, {17, 7}
};

static struct key_geometry lk421_geom_row11 [] = {
 {56, 0}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 0},
 {21, 7}
};

static struct key_geometry lk421_geom_row12 [] = {
 {1, 0}, {7, 7}, {21, 0}, {49, 0}
};

static struct keyboard_row_geometry lk421_geom_rows [] = {
...
static struct keyboard_geometry lk421_geom = {

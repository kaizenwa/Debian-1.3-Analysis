...
static struct key_geometry hclpc_geom_row0 [] = {
 {7, 7}, {6, 0},
 {6, 7}, {6, 7}, {6, 7}, {6, 7}, {3, 0},
 {6, 7}, {6, 7}, {6, 7}, {6, 7}, {3, 0},
 {6, 7}, {6, 7}, {6, 7}, {6, 7}, {3, 0},
...
static struct key_geometry hclpc_geom_row2 [] = {
...
static struct key_geometry hclpc_geom_row3 [] = {
...
static struct key_geometry hclpc_geom_row4 [] = {
...
static struct key_geometry hclpc_geom_row5 [] = {
...
static struct key_geometry hclpc_geom_row6 [] = {
 {9, 7}, {6, 0},
 {8, 7}, {45, 7}, {8, 7}, {6, 0},
 {9, 7}, {3, 0},
 {6, 7}, {6, 7}, {6, 7}, {3, 0},
...
static struct key_geometry hclpc_geom_row8 [] = {
 {115, 0}, {6, 7}, {6, 7}, {6, 7}, {6, 14}
};

static struct key_geometry hclpc_geom_row9 [] = {
 {115, 0}, {6, 7}, {6, 7}, {6, 7}
};

static struct key_geometry hclpc_geom_row10 [] = {
 {115, 0}, {6, 7}, {6, 7}, {6, 7}, {6, 14}
};

static struct key_geometry hclpc_geom_row11 [] = {
 {115, 0}, {12, 7}, {6, 7}
};

static struct keyboard_row_geometry hclpc_geom_rows [] = {
...
static struct keyboard_geometry hclpc_geom = {

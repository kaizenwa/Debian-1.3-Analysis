...
static struct key_geometry mac_geom_row0 [] = {
 {7, 7}, {7, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry mac_geom_row2 [] = {
...
static struct key_geometry mac_geom_row3 [] = {
...
static struct key_geometry mac_geom_row4 [] = {
 {13, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {38, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry mac_geom_row5 [] = {
...
static struct key_geometry mac_geom_row6 [] = {
 {10, 7}, {8, 7}, {11, 7}, {48, 7}, {11, 7}, {8, 7}, {10, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {14, 7}, {7, 7}
};

static struct keyboard_row_geometry mac_geom_rows [] = {
  ROW (mac_geom_row0, 7),
  EMPTYROW (5),
  ROW (mac_geom_row2, 7),
  ROW (mac_geom_row3, 7),
...
static struct keyboard_geometry mac_geom = {

...
static struct key_geometry sun3_geom_row0 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun3_geom_row1 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun3_geom_row2 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun3_geom_row3 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun3_geom_row4 [] = {
 {7, 7}, {7, 7}, {4, 0},
...
static struct key_geometry sun3_geom_row5 [] = {
 {18, 0}, {9, 7}, {10, 7}, {65, 7}, {10, 7}, {11, 7}
};

static struct keyboard_row_geometry sun3_geom_rows [] = {
...
static struct keyboard_geometry sun3_geom = {

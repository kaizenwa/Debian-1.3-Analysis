...
static struct key_geometry tt_geom_row0 [] = {
 {31, 10}, {31, 10}, {31, 10}, {31, 10}, {31, 10}, {31, 10}, {31, 10},
 {31, 10}, {31, 10}, {31, 10}
};

static struct key_geometry tt_geom_row2 [] = {
...
static struct key_geometry tt_geom_row3 [] = {
...
static struct key_geometry tt_geom_row4 [] = {
...
static struct key_geometry tt_geom_row5 [] = {
#if 0
...
static struct key_geometry tt_geom_row6 [] = {
 {23, 0}, {30, 20}, {180, 20}, {30, 20}, {121, 0}, {40, 20}, {20, 20}
};

static struct keyboard_row_geometry tt_geom_rows [] = {
  ROW (tt_geom_row0, 10),
  EMPTYROW (15),
  ROW (tt_geom_row2, 20),
  ROW (tt_geom_row3, 20),
...
static struct keyboard_geometry tt_geom = {

...
static struct key_geometry nws1250_geom_row0 [] = {
 {8, 8}, {6, 0},
 {9, 8}, {9, 8}, {9, 8}, {9, 8}, {9, 8}, {3, 0},
 {9, 8}, {9, 8}, {9, 8}, {9, 8}, {9, 8}
};

static struct key_geometry nws1250_geom_row2 [] = {
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {11, 7}
};

static struct key_geometry nws1250_geom_row3 [] = {
 {10, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {8, 7}
};

static struct key_geometry nws1250_geom_row4 [] = {
 {12, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {13, 7}
};

static struct key_geometry nws1250_geom_row5 [] = {
 {16, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {16, 7}
};

static struct key_geometry nws1250_geom_row6 [] = {
 {9, 7}, {7, 7}, {7, 7}, {9, 7}, {31, 7}, {9, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {9, 7}
};

static struct keyboard_row_geometry nws1250_geom_rows [] = {
...
static struct keyboard_geometry nws1250_geom = {

...
struct keyboard_instance all_kbds [] = 
{
 ...
 "Digital Equipment Corporation LK401 (Swedish DP Layout)",
  ...
  KBD ("MS", "Microsoft `Natural' Keyboard (Linux/XFree86 layout)", 0,
       &ms_geom, ms_caps, ms_codes, linux101_2_map),

  KBD ("MSSGI", "Microsoft `Natural' Keyboard (IRIX 5.2 layout)", 0,
       &ms_geom, ms_caps, ms_sgi5_codes, sgi5_r5_map),

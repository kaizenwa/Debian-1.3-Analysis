...
# include <X11/HPkeysym.h>
  /* Deprecated names, used by older versions of the system. */
# ifndef hpXK_mute_acute
#  define hpXK_mute_acute	XK_mute_acute
#  define hpXK_mute_grave	XK_mute_grave
#  define hpXK_mute_asciicircum	XK_mute_asciicircum
#  define hpXK_mute_diaeresis	XK_mute_diaeresis
#  define hpXK_mute_asciitilde	XK_mute_asciitilde
#  define hpXK_lira		XK_lira
#  define hpXK_guilder		XK_guilder
#  define hpXK_longminus	XK_longminus
#  define hpXK_block		XK_block
#  define hpXK_Reset		XK_Reset
#  define hpXK_System		XK_System
#  define hpXK_User		XK_User
#  define hpXK_ClearLine	XK_ClearLine
#  define hpXK_InsertLine	XK_InsertLine
#  define hpXK_DeleteLine	XK_DeleteLine
#  define hpXK_InsertChar	XK_InsertChar
#  define hpXK_DeleteChar	XK_DeleteChar
#  define hpXK_BackTab		XK_BackTab
#  define hpXK_KP_BackTab	XK_KP_BackTab
# endif

#endif

static struct default_keycode_map hpitf_map [] = {

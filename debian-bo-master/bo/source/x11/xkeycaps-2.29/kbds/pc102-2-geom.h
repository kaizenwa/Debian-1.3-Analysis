...
static struct key_geometry pc102_2_geom_row0 [] = {
 {8, 7}, {0, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {3, 0},
...
static struct key_geometry pc102_2_geom_row2 [] = {
...
static struct key_geometry pc102_2_geom_row3 [] = {
...
static struct key_geometry pc102_2_geom_row4 [] = {
 {14, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {14, 7}, {27, 0},		
 {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry pc102_2_geom_row5 [] = {
...
static struct key_geometry pc102_2_geom_row6 [] = {
 {10, 7}, {7, 7}, {9, 7}, {53, 7}, {9, 7}, {7, 7}, {10, 7}, {3, 0},
 {7,7}, {7,7}, {7, 7}, {3, 0},
 {14, 7}, {7, 7}
};

static struct keyboard_row_geometry pc102_2_geom_rows [] = {
...
static struct keyboard_geometry pc102_2_geom = {

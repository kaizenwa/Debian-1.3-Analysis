...
static struct key_geometry tek102_geom_row0 [] = {
 {7, 7}, {6, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {4, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {3, 0},
...
static struct key_geometry tek102_geom_row2 [] = {
...
static struct key_geometry tek102_geom_row3 [] = {
...
static struct key_geometry tek102_geom_row4 [] = {
 {12, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {36, 0},
 {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry tek102_geom_row5 [] = {
 {10, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
...
static struct key_geometry tek102_geom_row6 [] = {
 {12, 7}, {7, 0},
 {11, 7}, {47, 7}, {11, 7}, {7, 0},
 {10, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {3, 0},
...
static struct keyboard_row_geometry tek102_geom_rows [] = {
...
static struct keyboard_geometry tek102_geom = {

 ...
 *
 * This file describes the keymap of a "JETYO EBK-1024" 102 key PC-style
 * keyboard, german layout, on Linux with Xfree86 1.3 (X11R5), after loading
 * the "Xmodmap.gr" file with xmodmap.
 * Generated by Volker Bosch <volker@ytei.faveve.uni-stuttgart.de>.
 */
 
#ifndef XK_X386Sys_Req
#define XK_X386Sys_Req 0xFFFFFF		/* What is the right value here? */
#endif

static struct default_keycode_map linux102_2de_map [] = {
  {   9, 0,		XK_Escape },
  {  10, 0,		XK_1,	XK_exclam,
			XK_onesuperior },
  {  11, 0,		XK_2,	XK_quotedbl,
			XK_twosuperior },
  {  12, 0,		XK_3,	XK_paragraph,
			XK_threesuperior },
  {  13, 0,		XK_4,	XK_dollar,
			XK_sterling,	XK_yen },

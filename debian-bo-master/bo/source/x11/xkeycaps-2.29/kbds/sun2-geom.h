...
static struct key_geometry sun2_geom_row0 [] = {
 {7, 7}, {14, 7}, {4, 0},
...
static struct key_geometry sun2_geom_row1 [] = {
 {7, 7}, {14, 7}, {4, 0},
...
static struct key_geometry sun2_geom_row2 [] = {
 {7, 7}, {14, 7}, {4, 0},
...
static struct key_geometry sun2_geom_row3 [] = {
 {7, 7}, {14, 7}, {4, 0},
...
static struct key_geometry sun2_geom_row4 [] = {
 {7, 7}, {14, 7}, {4, 0},
...
static struct key_geometry sun2_geom_row5 [] = {
 {35, 0}, {9, 7}, {64, 7}, {9, 7}
};

static struct keyboard_row_geometry sun2_geom_rows [] = {
...
static struct keyboard_geometry sun2_geom = {

...
static struct key_geometry nws3410_geom_row0 [] = {
 {14, 0},
 {9, 8}, {9, 8}, {9, 8}, {9, 8}, {9, 8}, {3, 0},
 {9, 8}, {9, 8}, {9, 8}, {9, 8}, {9, 8}
};

static struct key_geometry nws3410_geom_row2 [] = {
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {11, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry nws3410_geom_row3 [] = {
 {10, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {8, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry nws3410_geom_row4 [] = {
 {12, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}, {13, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 7}
};

static struct key_geometry nws3410_geom_row5 [] = {
 {16, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7}, {7, 7},
 {7, 7}, {7, 7}, {7, 7}, {16, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}, {7, 14}
};

static struct key_geometry nws3410_geom_row6 [] = {
 {12, 7}, {7, 7}, {11, 7}, {42, 7}, {10, 7}, {7, 7}, {7, 7},
 {13, 7}, {3, 0},
 {7, 7}, {7, 7}, {7, 7}
};

static struct keyboard_row_geometry nws3410_geom_rows [] = {
...
static struct keyboard_geometry nws3410_geom = {

...
extern WidgetClass listcWidgetClass;
...
extern void XawListcUnhighlight(
#if NeedFunctionPrototypes
    Widget		/* w */
#endif
);
...
extern XawListReturnStruct * XawListcShowCurrent(
#if NeedFunctionPrototypes
    Widget		/* w */
#endif
);

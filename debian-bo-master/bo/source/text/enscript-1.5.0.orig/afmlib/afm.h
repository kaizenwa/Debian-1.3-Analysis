...
typedef enum
{
  ...
  AFM_ENCODING_LATIN1,		/* ISO-8859/1 */
  AFM_ENCODING_LATIN2,		/* ISO-8859/2 */
  AFM_ENCODING_LATIN3,		/* ISO-8859/3 */
  AFM_ENCODING_LATIN5,		/* ISO-8859/5 */
...
AFMError afm_font_charwidth ___P ((AFMFont font, AFMNumber ptsize,
				   unsigned int ch, AFMNumber *w0x_return,
				   AFMNumber *w0y_return));

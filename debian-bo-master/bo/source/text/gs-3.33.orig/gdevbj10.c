 ...
 *
 * (sjwright@cix.compulink.co.uk) -- I have a BJ10-ex, which behaves
 * very like a BJ200 except that the bottom margin is somewhat larger.
 * I _hope_ this is the same for a BJ10e! the manuals appear identical.
 */
 
#define BJ10E_TOP_MARGIN		0.12
#define BJ10E_BOTTOM_MARGIN		0.50
#define BJ10E_LETTER_SIDE_MARGIN	0.25
#define BJ10E_A4_SIDE_MARGIN		0.13
...
bj10e_open(gx_device *pdev)
{
	...
	static const float a4_margins[4] =
	 {	BJ10E_A4_SIDE_MARGIN, BJ10E_BOTTOM_MARGIN,
		BJ10E_A4_SIDE_MARGIN, BJ10E_TOP_MARGIN
	 };
	static const float letter_margins[4] =
	 {	BJ10E_LETTER_SIDE_MARGIN, BJ10E_BOTTOM_MARGIN,
		BJ10E_LETTER_SIDE_MARGIN, BJ10E_TOP_MARGIN
	 };

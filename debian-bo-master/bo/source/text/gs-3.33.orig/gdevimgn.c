/* Copyright (C) 1992, 1993, 1994 by Aladdin Enterprises.  All rights reserved.
...
/*-------------------------------------------*/ 
gx_device_printer gs_imagen_device = 
...
{ /* imagen_prn_open */
  ...
  /* ----------------------------------------- */
  DebugMsg(1,"Start of imagen_prn_open\n",0);
  DebugMsg(2,"BIGSIZE = %d \n",BIGSIZE);
  ...
  /* ----------------------------------------- */
  DebugMsg(1,"End of imagen_prn_open\n",0);
...
{ /* imagen_prn_close */
  ...
  /* ----------------------------------------- */
  DebugMsg(1,"Start of imagen_prn_close\n",0);
  ...
  DebugMsg(1,"End of imagen_prn_close\n",0);
...
{ 
  ...
  DebugMsg(1,"Start of imagen_print_page\n",0);
  ...
  DebugMsg(1,"End of imagen_print_page\n",0);

...
const MessageType1 ParserMessages::noDtdSubset(
MessageType::error,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else
...
85
#ifndef SP_NO_MESSAGE_TEXT
,"DTD %1 has neither internal nor external subset"
#endif
);
...
143
#ifndef SP_NO_MESSAGE_TEXT
,"minimum data of first minimum literal in SGML declaration must be \"ISO 8879:1986\" not %1"
#endif
);
...
184
#ifndef SP_NO_MESSAGE_TEXT
,"could not find document type declaration"
#endif
);
...
const MessageType0 ParserMessages::minimizedStartTag(
MessageType::error,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else
...
const MessageType0 ParserMessages::minimizedEndTag(
MessageType::error,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else
...
const MessageType0 ParserMessages::sdInvalidEllipsis(
MessageType::error,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else
...
322
#ifndef SP_NO_MESSAGE_TEXT
,"parameter must specify one character for each adjacent ellipsis"
#endif
);
...
const MessageType0 ParserMessages::unclosedStartTag(
MessageType::warning,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else
...
const MessageType0 ParserMessages::unclosedEndTag(
MessageType::warning,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else
...
const MessageType0 ParserMessages::netStartTag(
MessageType::warning,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else
...
const MessageType0 ParserMessages::nullEndTag(
MessageType::warning,
#ifdef BUILD_LIBSP
MessageFragment::libModule,
#else

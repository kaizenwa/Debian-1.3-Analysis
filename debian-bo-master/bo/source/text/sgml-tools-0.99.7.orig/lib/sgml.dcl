...
Subject: re: linuxdoc-sgml changes

And yet another thing... 

I'd forgotten that I also added support to the sgml2* scripts where if a
style is specified by -style and a file named 
	dtd/<style>.dcl
or if
	dtd/sgml.dcl
exists, it is prepended to the document and is expected to contain a
<!SGML ...> declaration.  I need this in order to raise the limits on
some of the capacities (the sgmls defaults are ridiculously low - 8
character identifiers - get real!).

My sgml.dcl is attached in case you want to include it. As noted in the
header comment, I lifted this from the newsgroup with only minor edits
(as indicated by the --SDT{ ... }SDT -- comments.)

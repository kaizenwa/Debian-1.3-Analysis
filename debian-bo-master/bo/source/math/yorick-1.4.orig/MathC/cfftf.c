/*
   CFFTF.C
   Swarztrauber complex FFT routines (forward direction).
...
extern void cfftf (long n,double c[],double wsave[]);

static void passf4 (long ido,long l1,double cc[],double ch[],
		    double wa1[],double wa2[],double wa3[]);
static void passf2 (long ido,long l1,double cc[],double ch[],
		    double wa1[]);
static void passf3 (long ido,long l1,double cc[],double ch[],
		    double wa1[],double wa2[]);
static void passf5 (long ido,long l1,double cc[],double ch[],
		    double wa1[],double wa2[],double wa3[], double wa4[]);
static void passf (long *nac,long ido,long ip,long l1,long idl1,
...
static void passf3 (long ido,long l1,double cc[],double ch[],
		    double wa1[],double wa2[]);
static void passf2 (long ido,long l1,double cc[],double ch[],double wa1[]);
static void passf4 (long ido,long l1,double cc[],double ch[],
		    double wa1[],double wa2[],double wa3[]);
...
void cfftf (long n,double c[],double wsave[])
{
...
#define c_1(a1) c[a1-1]
  ...
  iw1 = n+n+1;
  iw2 = iw1+n+n;
  cfftf1 (n,c,wsave,&wsave_1(iw1),(long *)&wsave_1(iw2));
  return;
}



void cfftf1 (long n,double c[],double ch[],double wa[],long ifac[])
{
  /*      implicit double  (a-h,o-z);*/
#undef wa_1
...
#define ifac_1(a1) ifac[a1-1]
  ...
  for (k1=1 ; k1<=nf ; k1+=1) {
    ...
    ix3 = ix2+idot;
    if (na != 0) goto L_101;
    passf4 (idot,l1,c,ch,&wa_1(iw),&wa_1(ix2),&wa_1(ix3));
    goto L_102;
  L_101:     passf4 (idot,l1,ch,c,&wa_1(iw),&wa_1(ix2),&wa_1(ix3));
  L_102:    na = 1-na;
    goto L_115;
  L_103:    if (ip != 2) goto L_106;
    if (na != 0) goto L_104;
    passf2 (idot,l1,c,ch,&wa_1(iw));
    goto L_105;
  L_104:     passf2 (idot,l1,ch,c,&wa_1(iw));
  L_105:    na = 1-na;
    goto L_115;
  L_106:    if (ip != 3) goto L_109;
    ix2 = iw+idot;
    if (na != 0) goto L_107;
    passf3 (idot,l1,c,ch,&wa_1(iw),&wa_1(ix2));
    goto L_108;
  L_107:     passf3 (idot,l1,ch,c,&wa_1(iw),&wa_1(ix2));
  L_108:    na = 1-na;
    goto L_115;
  L_109:    if (ip != 5) goto L_112;
    ...
    ix4 = ix3+idot;
    if (na != 0) goto L_110;
    passf5 (idot,l1,c,ch,&wa_1(iw),&wa_1(ix2),&wa_1(ix3),&wa_1(ix4));
    goto L_111;
  L_110:     passf5 (idot,l1,ch,c,&wa_1(iw),&wa_1(ix2),&wa_1(ix3),&wa_1(ix4));
  L_111:    na = 1-na;
    goto L_115;
  L_112:    if (na != 0) goto L_113;
    passf (&nac,idot,ip,l1,idl1,c,c,c,ch,ch,&wa_1(iw));
    goto L_114;
  L_113:     passf (&nac,idot,ip,l1,idl1,ch,ch,ch,c,c,&wa_1(iw));
...
#define cc_3(a1,a2,a3) cc[a1-1+ido*(a2-1+5*(a3-1))]
  ...
  */
  ...
  static double ti12=-0.587785252292473129168705954639072769; /*cos(-4*pi/5)*/
  /*-----implicit-declarations-----*/
  double di2;
  double di5;
  double dr2;

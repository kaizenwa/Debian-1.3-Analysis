/*
    ...
    $Id: debug.c,v 1.1 1993/08/27 18:32:09 munro Exp $
 */
...
extern BuiltIn Y_dbinfo, Y_dbdis, Y_dbauto;
...
{
  DebugBlk *dbg= (DebugBlk *)Ymalloc(sizeof(DebugBlk));
  ...
  dbg->pcList= (long *)Ymalloc(sizeof(long)*n);
  dbg->nPClist= n;
...
void Y_dbret(int nArgs)
{
  ...
  if (nArgs<1) PushDataBlock(Ref(&nilDB));

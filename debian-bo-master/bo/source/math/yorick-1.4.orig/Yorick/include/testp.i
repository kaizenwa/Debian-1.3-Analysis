/*
   ...
   $Id: testp.i,v 1.1 1993/08/27 18:50:06 munro Exp munro $
 */
...
f= open("../Yorick/include/testp.i", "r", 1);
if (is_void(f)) f= open(Y_SITE+"include/testp.i", "r", 1);
if (f) {
  ...
  "WARNING-- skipping disassembly check, include/testp.i not present";
}
parser_test= [];

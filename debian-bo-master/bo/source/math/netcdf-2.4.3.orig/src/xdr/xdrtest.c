...
static char rcsid[] = "$Id: xdrtest.c,v 1.35 1996/01/16 23:38:48 steve Exp $" ;
#endif
...
#include <stdio.h>
#include <stdlib.h>
#include <types.h>		/* included just after <stdio.h> to prevent */
				/* VMS warnings */
...
#ifdef vms
#   include <lib$routines.h>	/* for init_timer() */
#endif

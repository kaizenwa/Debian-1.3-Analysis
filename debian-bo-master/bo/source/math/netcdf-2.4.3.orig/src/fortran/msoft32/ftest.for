...
c   $Header: /upc/share/CVS/netcdf/fortran/msoft32/ftest.for,v 1.4 1996/02/27 17:29:38 russ Exp $
c********************************************************************/
...
c
c     program to test the MICROSOFT32 Fortran jacket interface to the netCDF
c
      program ftest
...
c      integer*4 dimsiz(MAXNCDIM)
      integer*4 dimsiz(100)
...
c
c subroutine to test default fill values
c
      subroutine tfills
$include: "netcdf.inc"
      integer ncid

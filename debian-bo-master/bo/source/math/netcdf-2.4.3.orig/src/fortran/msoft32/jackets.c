 ...
 */
/* $Header: /upc/share/CVS/netcdf/fortran/msoft32/jackets.c,v 1.3 1996/02/27 17:29:40 russ Exp $ */
/*
 * OVERVIEW
 *
...
void
ncvinq(ncid, varid, varname, varnamelen, datatype, ndims, dimarray, natts, rcode)
    long		*ncid;	
    long		*varid;	
    char *varname;	
    unsigned int varnamelen;
 ...
 */
void
ncaptc(ncid, varid, attname, attnamelen, datatype, lenstr, string, stringlen, rcode)
    long		*ncid;	
    long		*varid;	
    char *attname;	
    unsigned int attnamelen;
 ...
 */
void
ncainq(ncid, varid, attname, attnamelen, datatype, attlen, rcode)
    long		*ncid;	
    long		*varid;	
    char *attname;	
    unsigned int attnamelen;

...
# Default fill value for byte types, matches FILL_BYTE in netcdf.h.
# However, on platforms where FORTRAN has no byte or integer*1 declaration
# and C char is unsigned (e.g. Cray), this should be overridden to 129
define(`FILBYTEMACRO',`-127')

 ...
 *
 *   $Header: /upc/share/CVS/netcdf/cxx/netcdf.hh,v 1.56 1996/02/21 16:26:57 russ Exp $
 *********************************************************************/
...
class NcFile
{
  public:
    ...
    NcBool add_att( NcToken attname, nclong );
    ...
    NcBool add_att( NcToken attname, int, const nclong* );
...
class NcTypedComponent
{
  public:
    ...
    virtual nclong as_nclong( long n ) const;    // nth value as nclong
...
class NcVar : public NcTypedComponent
{
  public:
    ...
    NcBool put( const nclong* vals, const long* counts );
    ...
    NcBool get( short* vals, long c0=0, long c1=0,
                long c2=0, long c3=0, long c4=0 ) const;
    NcBool get( nclong* vals, long c0=0, long c1=0,
                long c2=0, long c3=0, long c4=0 ) const;
    ...
    NcBool get( nclong* vals, const long* counts ) const;
    ...
    NcBool add_att( NcToken, int, const nclong* );
    ...
    NcBool put_rec( const nclong* vals );
    ...
    NcBool put_rec( const nclong* vals, long rec );
    ...
    long get_index( const nclong* vals );

#ifndef lint
static char *RCSid = "$Id: util3d.c,v 1.12 1996/09/15 13:04:03 drd Exp $";
#endif
...
/* I'D REALLY LIKE TO MOVE THIS INTO hidden3d.c AS A FN - it shouldn't
 * be accessing secret variables like this
 */
/* HBB: I have done this */

#ifndef lint
static char    *RCSid = "$Id: plot2d.c,v 1.46 1997/03/09 23:50:10 drd Exp $";
#endif
 ...
 */
{
	register int    i /* no points ! */, j,col;
	double v[NCOL];
	...
	while ( (j = df_readline(v, col)) != DF_EOF)  {
		...
		case 2: 
			{		/* x, y */
				...
				store2d_point(this_plot, i++, v[0], v[1], v[0], v[0], v[1], v[1], -1.0);
				break;
			}
		case 3:
			{	/* x, y, ydelta OR x, y, xdelta OR x, y, width */
				...
				else switch(this_plot->plot_style)
				{
					case XERRORBARS:

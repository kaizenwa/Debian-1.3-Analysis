#ifdef INCRCSDATA
static char RCSid[]="$Id: print.c,v 1.7 1996/09/15 13:07:46 drd Exp $" ;
#endif
...
static void    ThreadPrintPage( PRINTPARAMS* ) ;
...
*/
    ...
    if( (hdc = OpenPrinterDC( hab, ptp->pqp, 0L, szPrintFile )) != DEV_ERROR ) {
        ...
        if( DevEscape( hdc, 
            ...
            GpiSetPageViewport( hps, &rectPage ) ;
            ...
            GpiPlayMetaFile( hps, hmf, 9L, alOpt, NULL, 255, buff ) ;

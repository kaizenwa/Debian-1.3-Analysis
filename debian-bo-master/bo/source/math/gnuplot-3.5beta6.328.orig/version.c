#ifndef lint
static char *RCSid = "$Id: version.c,v 1.328 1997/03/09 23:50:19 drd Exp $";
#endif
...
char patchlevel[] = "beta 328";
char date[] = "Sun Mar  9 23:48:47 GMT 1997"; 
char gnuplot_copyright[] = "Copyright(C) 1986 - 1993, 1996";

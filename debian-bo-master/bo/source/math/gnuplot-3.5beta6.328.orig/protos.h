/*
 * $Id: protos.h,v 1.50 1996/12/19 19:12:43 drd Exp $
 *
 */
...
struct termentry *set_term __PROTO((int c_token));
...
char * gstrptime __PROTO((char *s, char *fmt, struct tm *tm)); /* string to *tm */
int gstrftime __PROTO((char *buf, int bufsz, char *fmt, double clock)); /* *tm to string */
double gtimegm __PROTO((struct tm *tm)); /* *tm to seconds */
int ggmtime __PROTO((struct tm *tm, double clock)); /* seconds to *tm */
